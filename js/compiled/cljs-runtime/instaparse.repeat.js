...
var vec__54524 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54524,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54524,(1),null);
...
var vec__54527 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54527,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54527,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__54530 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54530,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54530,(1),null);
...
var G__54591 = cljs.core.next(parses__$1);
parses__$1 = G__54591;
continue;
}
...
var G__54538 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__54539 = G__54538;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54539,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54539,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54539,(2),null);
var selection = vec__54539;
...
var vec__54545 = G__54538__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54545,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54545,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54545,(2),null);
var selection__$1 = vec__54545;
...
var G__54593 = cljs.core.long$(end__$1);
var G__54594 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__54595 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__54593;
parses__$1 = G__54594;
G__54538__$1 = G__54595;
continue;
...
var G__54553 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__54554 = G__54553;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54554,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54554,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54554,(2),null);
var selection = vec__54554;
var index__$2 = index__$1;
var parses__$1 = parses;
...
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__54560 = G__54553__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54560,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54560,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54560,(2),null);
var selection__$1 = vec__54560;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__54597 = cljs.core.long$(end__$1);
var G__54598 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__54599 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__54597;
parses__$1 = G__54598;
G__54553__$1 = G__54599;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__54568 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__54569 = G__54568;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54569,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54569,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54569,(2),null);
var selection = vec__54569;
var index__$2 = index__$1;
var parses__$1 = parses;
...
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54575,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54575,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54575,(2),null);
var selection__$1 = vec__54575;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__54601 = cljs.core.long$(end__$1);
var G__54602 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__54603 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__54601;
parses__$1 = G__54602;
G__54568__$1 = G__54603;
continue;
...
if(cljs.core.truth_((function (){var fexpr__54580 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__54580.cljs$core$IFn$_invoke$arity$1 ? fexpr__54580.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__54580.call(null,output_format));
})())){
} else {
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__54589 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__54588 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__54588.cljs$core$IFn$_invoke$arity$1 ? fexpr__54588.cljs$core$IFn$_invoke$arity$1(G__54589) : fexpr__54588.call(null,G__54589));
})();
