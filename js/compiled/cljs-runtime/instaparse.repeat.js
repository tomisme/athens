...
var vec__75370 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75370,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75370,(1),null);
...
var vec__75373 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75373,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75373,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__75377 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75377,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75377,(1),null);
...
var G__75455 = cljs.core.next(parses__$1);
parses__$1 = G__75455;
continue;
}
...
var G__75395 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__75396 = G__75395;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75396,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75396,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75396,(2),null);
var selection = vec__75396;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__75395__$1 = G__75395;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__75402 = G__75395__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75402,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75402,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75402,(2),null);
var selection__$1 = vec__75402;
...
var G__75457 = cljs.core.long$(end__$1);
var G__75458 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__75459 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__75457;
parses__$1 = G__75458;
G__75395__$1 = G__75459;
continue;
...
var G__75410 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__75411 = G__75410;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75411,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75411,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75411,(2),null);
var selection = vec__75411;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__75410__$1 = G__75410;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__75417 = G__75410__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75417,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75417,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75417,(2),null);
var selection__$1 = vec__75417;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__75461 = cljs.core.long$(end__$1);
var G__75462 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__75463 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__75461;
parses__$1 = G__75462;
G__75410__$1 = G__75463;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__75425 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__75426 = G__75425;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75426,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75426,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75426,(2),null);
var selection = vec__75426;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__75425__$1 = G__75425;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__75433 = G__75425__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75433,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75433,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75433,(2),null);
var selection__$1 = vec__75433;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__75465 = cljs.core.long$(end__$1);
var G__75466 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__75467 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__75465;
parses__$1 = G__75466;
G__75425__$1 = G__75467;
continue;
...
if(cljs.core.truth_((function (){var fexpr__75438 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__75438.cljs$core$IFn$_invoke$arity$1 ? fexpr__75438.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__75438.call(null,output_format));
})())){
} else {
...
var G__75439 = output_format;
var G__75439__$1 = (((G__75439 instanceof cljs.core.Keyword))?G__75439.fqn:null);
switch (G__75439__$1) {
case "enlive":
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__75453 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__75452 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__75452.cljs$core$IFn$_invoke$arity$1 ? fexpr__75452.cljs$core$IFn$_invoke$arity$1(G__75453) : fexpr__75452.call(null,G__75453));
})();
