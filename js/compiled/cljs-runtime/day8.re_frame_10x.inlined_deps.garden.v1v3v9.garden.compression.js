 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.compression.token_fn = (function day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$compression$token_fn(p__45647){
var vec__45648 = p__45647;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45648,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45648,(1),null);
return (function (s){
...
var len__4789__auto___45667 = arguments.length;
var i__4790__auto___45668 = (0);
while(true){
if((i__4790__auto___45668 < len__4789__auto___45667)){
args__4795__auto__.push((arguments[i__4790__auto___45668]));

var G__45669 = (i__4790__auto___45668 + (1));
i__4790__auto___45668 = G__45669;
continue;
} else {
}
break;
...
return (function (s){
return cljs.core.some((function (p1__45651_SHARP_){
return (p1__45651_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__45651_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__45651_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq45652){
...
var map__45657 = temp__5733__auto__;
...
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45657__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45657__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45657__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__45681 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__45682 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__45666 = tag;
