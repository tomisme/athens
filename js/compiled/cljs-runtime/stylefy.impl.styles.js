...
stylefy.impl.styles.create_style_BANG_ = (function stylefy$impl$styles$create_style_BANG_(p__43634,style_created_handler){
...
var style = map__43635__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43635__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43635__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var style_css = stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$1(style);
var G__43645_43862 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__43645_43862) : style_created_handler.call(null,G__43645_43862));

var seq__43646 = cljs.core.seq(cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(props)));
var chunk__43647 = null;
var count__43648 = (0);
var i__43649 = (0);
while(true){
if((i__43649 < count__43648)){
var sub_style = chunk__43647.cljs$core$IIndexed$_nth$arity$2(null,i__43649);
var G__43703_43865 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__43704_43866 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__43703_43865,G__43704_43866) : stylefy.impl.styles.create_style_BANG_.call(null,G__43703_43865,G__43704_43866));


var G__43867 = seq__43646;
var G__43868 = chunk__43647;
var G__43869 = count__43648;
var G__43870 = (i__43649 + (1));
seq__43646 = G__43867;
chunk__43647 = G__43868;
count__43648 = G__43869;
i__43649 = G__43870;
continue;
} else {
...
var G__43871 = cljs.core.chunk_rest(seq__43646__$1);
var G__43872 = c__4609__auto__;
var G__43873 = cljs.core.count(c__4609__auto__);
var G__43874 = (0);
seq__43646 = G__43871;
chunk__43647 = G__43872;
count__43648 = G__43873;
i__43649 = G__43874;
continue;
} else {
var sub_style = cljs.core.first(seq__43646__$1);
var G__43713_43877 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__43714_43878 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__43713_43877,G__43714_43878) : stylefy.impl.styles.create_style_BANG_.call(null,G__43713_43877,G__43714_43878));


var G__43879 = cljs.core.next(seq__43646__$1);
var G__43880 = null;
var G__43881 = (0);
var G__43882 = (0);
seq__43646 = G__43879;
chunk__43647 = G__43880;
count__43648 = G__43881;
i__43649 = G__43882;
continue;
}
} else {
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__43732_SHARP_){
return ((typeof p1__43732_SHARP_ === 'string') || ((p1__43732_SHARP_ instanceof cljs.core.Keyword)) || ((p1__43732_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__43732#] (or (string? p1__43732#) (keyword? p1__43732#) (nil? p1__43732#))) class)))"].join('')));
}
});
/**
...
var len__4789__auto___43888 = arguments.length;
var i__4790__auto___43889 = (0);
while(true){
if((i__4790__auto___43889 < len__4789__auto___43888)){
args__4795__auto__.push((arguments[i__4790__auto___43889]));

var G__43890 = (i__4790__auto___43889 + (1));
i__4790__auto___43889 = G__43890;
continue;
} else {
}
break;
...
var resolved_sub_style = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__43840_SHARP_,p2__43841_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__43840_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432),p2__43841_SHARP_], null));
}),style,sub_styles);
if(cljs.core.truth_(resolved_sub_style)){
...
/** @this {Function} */
(stylefy.impl.styles.sub_style.cljs$lang$applyTo = (function (seq43845){
var G__43846 = cljs.core.first(seq43845);
var seq43845__$1 = cljs.core.next(seq43845);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43846,seq43845__$1);
}));
...
(stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2 = (function (styles,p__43853){
...
var options = map__43854__$1;
var request_dom_update_after_done_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43854__$1,new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510));
var styles_43896__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__43856_43897 = cljs.core.seq(styles_43896__$1);
var chunk__43857_43898 = null;
var count__43858_43899 = (0);
var i__43859_43900 = (0);
while(true){
if((i__43859_43900 < count__43858_43899)){
var style_43901 = chunk__43857_43898.cljs$core$IIndexed$_nth$arity$2(null,i__43859_43900);
stylefy.impl.styles.use_style_BANG_(style_43901,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___43902 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_43901));
if(cljs.core.truth_(temp__5735__auto___43902)){
var sub_styles_43903 = temp__5735__auto___43902;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_43903,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__43904 = seq__43856_43897;
var G__43905 = chunk__43857_43898;
var G__43906 = count__43858_43899;
var G__43907 = (i__43859_43900 + (1));
seq__43856_43897 = G__43904;
chunk__43857_43898 = G__43905;
count__43858_43899 = G__43906;
i__43859_43900 = G__43907;
continue;
} else {
var temp__5735__auto___43908 = cljs.core.seq(seq__43856_43897);
if(temp__5735__auto___43908){
var seq__43856_43909__$1 = temp__5735__auto___43908;
if(cljs.core.chunked_seq_QMARK_(seq__43856_43909__$1)){
var c__4609__auto___43910 = cljs.core.chunk_first(seq__43856_43909__$1);
var G__43911 = cljs.core.chunk_rest(seq__43856_43909__$1);
var G__43912 = c__4609__auto___43910;
var G__43913 = cljs.core.count(c__4609__auto___43910);
var G__43914 = (0);
seq__43856_43897 = G__43911;
chunk__43857_43898 = G__43912;
count__43858_43899 = G__43913;
i__43859_43900 = G__43914;
continue;
} else {
var style_43915 = cljs.core.first(seq__43856_43909__$1);
stylefy.impl.styles.use_style_BANG_(style_43915,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___43917__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_43915));
if(cljs.core.truth_(temp__5735__auto___43917__$1)){
var sub_styles_43919 = temp__5735__auto___43917__$1;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_43919,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__43920 = cljs.core.next(seq__43856_43909__$1);
var G__43921 = null;
var G__43922 = (0);
var G__43923 = (0);
seq__43856_43897 = G__43920;
chunk__43857_43898 = G__43921;
count__43858_43899 = G__43922;
i__43859_43900 = G__43923;
continue;
}
} else {
}
