...
stylefy.impl.styles.create_style_BANG_ = (function stylefy$impl$styles$create_style_BANG_(p__31182,style_created_handler){
...
var style = map__31184__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31184__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31184__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var style_css = stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$1(style);
var G__31187_31258 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__31187_31258) : style_created_handler.call(null,G__31187_31258));

var seq__31188 = cljs.core.seq(cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(props)));
var chunk__31189 = null;
var count__31190 = (0);
var i__31191 = (0);
while(true){
if((i__31191 < count__31190)){
var sub_style = chunk__31189.cljs$core$IIndexed$_nth$arity$2(null,i__31191);
var G__31199_31259 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__31200_31260 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__31199_31259,G__31200_31260) : stylefy.impl.styles.create_style_BANG_.call(null,G__31199_31259,G__31200_31260));


var G__31261 = seq__31188;
var G__31262 = chunk__31189;
var G__31263 = count__31190;
var G__31264 = (i__31191 + (1));
seq__31188 = G__31261;
chunk__31189 = G__31262;
count__31190 = G__31263;
i__31191 = G__31264;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__31188);
if(temp__5735__auto__){
var seq__31188__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__31188__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__31188__$1);
var G__31265 = cljs.core.chunk_rest(seq__31188__$1);
var G__31266 = c__4609__auto__;
var G__31267 = cljs.core.count(c__4609__auto__);
var G__31268 = (0);
seq__31188 = G__31265;
chunk__31189 = G__31266;
count__31190 = G__31267;
i__31191 = G__31268;
continue;
} else {
var sub_style = cljs.core.first(seq__31188__$1);
var G__31203_31269 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__31204_31270 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__31203_31269,G__31204_31270) : stylefy.impl.styles.create_style_BANG_.call(null,G__31203_31269,G__31204_31270));


var G__31271 = cljs.core.next(seq__31188__$1);
var G__31272 = null;
var G__31273 = (0);
var G__31274 = (0);
seq__31188 = G__31271;
chunk__31189 = G__31272;
count__31190 = G__31273;
i__31191 = G__31274;
continue;
}
} else {
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__31207_SHARP_){
return ((typeof p1__31207_SHARP_ === 'string') || ((p1__31207_SHARP_ instanceof cljs.core.Keyword)) || ((p1__31207_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__31207#] (or (string? p1__31207#) (keyword? p1__31207#) (nil? p1__31207#))) class)))"].join('')));
}
});
/**
...
var len__4789__auto___31289 = arguments.length;
var i__4790__auto___31290 = (0);
while(true){
if((i__4790__auto___31290 < len__4789__auto___31289)){
args__4795__auto__.push((arguments[i__4790__auto___31290]));

var G__31291 = (i__4790__auto___31290 + (1));
i__4790__auto___31290 = G__31291;
continue;
} else {
}
break;
...
var resolved_sub_style = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__31237_SHARP_,p2__31238_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__31237_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432),p2__31238_SHARP_], null));
}),style,sub_styles);
if(cljs.core.truth_(resolved_sub_style)){
...
/** @this {Function} */
(stylefy.impl.styles.sub_style.cljs$lang$applyTo = (function (seq31240){
...
var styles_31299__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__31248_31300 = cljs.core.seq(styles_31299__$1);
var chunk__31249_31301 = null;
var count__31250_31302 = (0);
var i__31251_31303 = (0);
while(true){
if((i__31251_31303 < count__31250_31302)){
var style_31305 = chunk__31249_31301.cljs$core$IIndexed$_nth$arity$2(null,i__31251_31303);
stylefy.impl.styles.use_style_BANG_(style_31305,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___31306 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_31305));
if(cljs.core.truth_(temp__5735__auto___31306)){
var sub_styles_31308 = temp__5735__auto___31306;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_31308,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__31309 = seq__31248_31300;
var G__31310 = chunk__31249_31301;
var G__31311 = count__31250_31302;
var G__31312 = (i__31251_31303 + (1));
seq__31248_31300 = G__31309;
chunk__31249_31301 = G__31310;
count__31250_31302 = G__31311;
i__31251_31303 = G__31312;
continue;
} else {
var temp__5735__auto___31314 = cljs.core.seq(seq__31248_31300);
if(temp__5735__auto___31314){
var seq__31248_31315__$1 = temp__5735__auto___31314;
if(cljs.core.chunked_seq_QMARK_(seq__31248_31315__$1)){
var c__4609__auto___31317 = cljs.core.chunk_first(seq__31248_31315__$1);
var G__31318 = cljs.core.chunk_rest(seq__31248_31315__$1);
var G__31319 = c__4609__auto___31317;
var G__31320 = cljs.core.count(c__4609__auto___31317);
var G__31321 = (0);
seq__31248_31300 = G__31318;
chunk__31249_31301 = G__31319;
count__31250_31302 = G__31320;
i__31251_31303 = G__31321;
continue;
} else {
var style_31323 = cljs.core.first(seq__31248_31315__$1);
stylefy.impl.styles.use_style_BANG_(style_31323,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___31324__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_31323));
if(cljs.core.truth_(temp__5735__auto___31324__$1)){
var sub_styles_31326 = temp__5735__auto___31324__$1;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_31326,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__31328 = cljs.core.next(seq__31248_31315__$1);
var G__31329 = null;
var G__31330 = (0);
var G__31331 = (0);
seq__31248_31300 = G__31328;
chunk__31249_31301 = G__31329;
count__31250_31302 = G__31330;
i__31251_31303 = G__31331;
continue;
}
} else {
}
