...
stylefy.impl.styles.create_style_BANG_ = (function stylefy$impl$styles$create_style_BANG_(p__31177,style_created_handler){
var map__31178 = p__31177;
var map__31178__$1 = (((((!((map__31178 == null))))?(((((map__31178.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__31178.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__31178):map__31178);
var style = map__31178__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31178__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31178__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var style_css = stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$1(style);
var G__31181_31258 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__31181_31258) : style_created_handler.call(null,G__31181_31258));

var seq__31182 = cljs.core.seq(cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(props)));
var chunk__31183 = null;
var count__31184 = (0);
var i__31185 = (0);
while(true){
if((i__31185 < count__31184)){
var sub_style = chunk__31183.cljs$core$IIndexed$_nth$arity$2(null,i__31185);
var G__31194_31259 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__31195_31260 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__31194_31259,G__31195_31260) : stylefy.impl.styles.create_style_BANG_.call(null,G__31194_31259,G__31195_31260));


var G__31261 = seq__31182;
var G__31262 = chunk__31183;
var G__31263 = count__31184;
var G__31264 = (i__31185 + (1));
seq__31182 = G__31261;
chunk__31183 = G__31262;
count__31184 = G__31263;
i__31185 = G__31264;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__31182);
if(temp__5735__auto__){
var seq__31182__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__31182__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__31182__$1);
var G__31265 = cljs.core.chunk_rest(seq__31182__$1);
var G__31266 = c__4609__auto__;
var G__31267 = cljs.core.count(c__4609__auto__);
var G__31268 = (0);
seq__31182 = G__31265;
chunk__31183 = G__31266;
count__31184 = G__31267;
i__31185 = G__31268;
continue;
} else {
var sub_style = cljs.core.first(seq__31182__$1);
var G__31198_31269 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__31199_31270 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__31198_31269,G__31199_31270) : stylefy.impl.styles.create_style_BANG_.call(null,G__31198_31269,G__31199_31270));


var G__31271 = cljs.core.next(seq__31182__$1);
var G__31272 = null;
var G__31273 = (0);
var G__31274 = (0);
seq__31182 = G__31271;
chunk__31183 = G__31272;
count__31184 = G__31273;
i__31185 = G__31274;
continue;
}
} else {
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__31201_SHARP_){
return ((typeof p1__31201_SHARP_ === 'string') || ((p1__31201_SHARP_ instanceof cljs.core.Keyword)) || ((p1__31201_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__31201#] (or (string? p1__31201#) (keyword? p1__31201#) (nil? p1__31201#))) class)))"].join('')));
}
});
/**
...
var i__4790__auto___31281 = (0);
while(true){
if((i__4790__auto___31281 < len__4789__auto___31279)){
args__4795__auto__.push((arguments[i__4790__auto___31281]));

var G__31283 = (i__4790__auto___31281 + (1));
i__4790__auto___31281 = G__31283;
continue;
} else {
}
break;
...
var resolved_sub_style = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__31232_SHARP_,p2__31233_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__31232_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432),p2__31233_SHARP_], null));
}),style,sub_styles);
if(cljs.core.truth_(resolved_sub_style)){
...
/** @this {Function} */
(stylefy.impl.styles.sub_style.cljs$lang$applyTo = (function (seq31236){
var G__31237 = cljs.core.first(seq31236);
var seq31236__$1 = cljs.core.next(seq31236);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31237,seq31236__$1);
}));
...
(stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2 = (function (styles,p__31245){
...
var options = map__31246__$1;
var request_dom_update_after_done_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31246__$1,new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510));
var styles_31292__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__31248_31294 = cljs.core.seq(styles_31292__$1);
var chunk__31249_31295 = null;
var count__31250_31296 = (0);
var i__31251_31297 = (0);
while(true){
if((i__31251_31297 < count__31250_31296)){
var style_31298 = chunk__31249_31295.cljs$core$IIndexed$_nth$arity$2(null,i__31251_31297);
stylefy.impl.styles.use_style_BANG_(style_31298,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___31299 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_31298));
if(cljs.core.truth_(temp__5735__auto___31299)){
var sub_styles_31300 = temp__5735__auto___31299;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_31300,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__31302 = seq__31248_31294;
var G__31303 = chunk__31249_31295;
var G__31304 = count__31250_31296;
var G__31305 = (i__31251_31297 + (1));
seq__31248_31294 = G__31302;
chunk__31249_31295 = G__31303;
count__31250_31296 = G__31304;
i__31251_31297 = G__31305;
continue;
} else {
var temp__5735__auto___31306 = cljs.core.seq(seq__31248_31294);
if(temp__5735__auto___31306){
var seq__31248_31307__$1 = temp__5735__auto___31306;
if(cljs.core.chunked_seq_QMARK_(seq__31248_31307__$1)){
var c__4609__auto___31309 = cljs.core.chunk_first(seq__31248_31307__$1);
var G__31311 = cljs.core.chunk_rest(seq__31248_31307__$1);
var G__31312 = c__4609__auto___31309;
var G__31313 = cljs.core.count(c__4609__auto___31309);
var G__31314 = (0);
seq__31248_31294 = G__31311;
chunk__31249_31295 = G__31312;
count__31250_31296 = G__31313;
i__31251_31297 = G__31314;
continue;
} else {
var style_31315 = cljs.core.first(seq__31248_31307__$1);
stylefy.impl.styles.use_style_BANG_(style_31315,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___31316__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_31315));
if(cljs.core.truth_(temp__5735__auto___31316__$1)){
var sub_styles_31317 = temp__5735__auto___31316__$1;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_31317,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__31318 = cljs.core.next(seq__31248_31307__$1);
var G__31319 = null;
var G__31320 = (0);
var G__31321 = (0);
seq__31248_31294 = G__31318;
chunk__31249_31295 = G__31319;
count__31250_31296 = G__31320;
i__31251_31297 = G__31321;
continue;
}
} else {
}
