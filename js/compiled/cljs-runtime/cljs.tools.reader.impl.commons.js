...
var G__25351 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__25351;
continue;
} else {
return ch;
...
var vec__25343 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25343,(0),null);
return (match === s);
});
