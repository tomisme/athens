...
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62802__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62802__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__62816 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__62816__$1 = (((G__62816 == null))?null:cljs.core.persistent_BANG_(G__62816));
if((G__62816__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__62816__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__62819){
var vec__62820 = p__62819;
var seq__62821 = cljs.core.seq(vec__62820);
var first__62822 = cljs.core.first(seq__62821);
var seq__62821__$1 = cljs.core.next(seq__62821);
var frame = first__62822;
var frames = seq__62821__$1;
...
var results = (function (){var G__62826 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__62826,kvps);
} else {
return G__62826;
}
})();
...
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62835__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62835__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_62937 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_62937,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__62847){
var vec__62848 = p__62847;
...
var parent = first__62850;
var frames = seq__62849__$1;
...
var found = cljs.core.not_empty((function (){var G__62855 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__62855);
} else {
return G__62855;
}
})());
...
var as_value = (function (){var G__62856 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__62845_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__62845_SHARP_]);
}),G__62856);
} else {
return G__62856;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__62857 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__62857);
} else {
return G__62857;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__62858 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__62858,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__62858;
}
})());
...
var vec__62860 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62860,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62860,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__62866){
var vec__62867 = p__62866;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62867,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62867,(1),null);
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__62870){
var vec__62871 = p__62870;
var seq__62872 = cljs.core.seq(vec__62871);
var first__62873 = cljs.core.first(seq__62872);
var seq__62872__$1 = cljs.core.next(seq__62872);
var frame = first__62873;
var frames = seq__62872__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__62882){
var vec__62884 = p__62882;
...
var frame = first__62886;
var frames = seq__62885__$1;
...
var vec__62887 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62887,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62887,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62895__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62895__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__62897 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__62897,attr,eid);
} else {
return G__62897;
}
})();
...
var map__62898 = frame;
var map__62898__$1 = (((((!((map__62898 == null))))?(((((map__62898.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__62898.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__62898):map__62898);
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62898__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62898__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__62901){
while(true){
var vec__62902 = p__62901;
var seq__62903 = cljs.core.seq(vec__62902);
var first__62904 = cljs.core.first(seq__62903);
var seq__62903__$1 = cljs.core.next(seq__62903);
var frame = first__62904;
var frames = seq__62903__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__62965 = db;
var G__62966 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__62965;
p__62901 = G__62966;
continue;
}
...
while(true){
var G__62910 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__62910__$1 = (((G__62910 instanceof cljs.core.Keyword))?G__62910.fqn:null);
switch (G__62910__$1) {
case "expand":
var G__62969 = db;
var G__62970 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__62969;
frames = G__62970;
continue;
...
case "expand-rev":
var G__62971 = db;
var G__62972 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__62971;
frames = G__62972;
continue;
...
case "pattern":
var G__62973 = db;
var G__62974 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__62973;
frames = G__62974;
continue;
...
case "recursion":
var G__62975 = db;
var G__62976 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__62975;
frames = G__62976;
continue;
...
break;
case "done":
var vec__62911 = frames;
var seq__62912 = cljs.core.seq(vec__62911);
var first__62913 = cljs.core.first(seq__62912);
var seq__62912__$1 = cljs.core.next(seq__62912);
var f = first__62913;
var remaining = seq__62912__$1;
var result = (function (){var G__62914 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__62914);
} else {
return G__62914;
}
})();
...
var G__62981 = db;
var G__62982 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__62915 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__62915,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__62915;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__62910__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__62916_SHARP_){
return datascript.db.entid_strict(db,p1__62916_SHARP_);
})),eids);
