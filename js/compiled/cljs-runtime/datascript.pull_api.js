...
var map__33016 = rec;
var map__33016__$1 = (((((!((map__33016 == null))))?(((((map__33016.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__33016.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__33016):map__33016);
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33016__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33016__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__33018 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__33018__$1 = (((G__33018 == null))?null:cljs.core.persistent_BANG_(G__33018));
if((G__33018__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__33018__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__33019){
...
var frame = first__33022;
var frames = seq__33021__$1;
...
var results = (function (){var G__33023 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__33023,kvps);
} else {
return G__33023;
}
})();
...
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33024__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33024__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_33069 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_33069,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__33027){
...
var parent = first__33030;
var frames = seq__33029__$1;
...
var found = cljs.core.not_empty((function (){var G__33031 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__33031);
} else {
return G__33031;
}
})());
...
var as_value = (function (){var G__33032 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__33026_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__33026_SHARP_]);
}),G__33032);
} else {
return G__33032;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__33033 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__33033);
} else {
return G__33033;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__33034 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__33034,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__33034;
}
})());
...
var vec__33035 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33035,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33035,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__33038){
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__33042){
var vec__33043 = p__33042;
var seq__33044 = cljs.core.seq(vec__33043);
var first__33045 = cljs.core.first(seq__33044);
var seq__33044__$1 = cljs.core.next(seq__33044);
var frame = first__33045;
var frames = seq__33044__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__33046){
...
var frame = first__33049;
var frames = seq__33048__$1;
...
var vec__33050 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33050,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33050,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33053__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33053__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__33055 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__33055,attr,eid);
} else {
return G__33055;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33056__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33056__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__33058){
while(true){
var vec__33059 = p__33058;
var seq__33060 = cljs.core.seq(vec__33059);
var first__33061 = cljs.core.first(seq__33060);
var seq__33060__$1 = cljs.core.next(seq__33060);
var frame = first__33061;
var frames = seq__33060__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__33070 = db;
var G__33071 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__33070;
p__33058 = G__33071;
continue;
}
...
while(true){
var G__33062 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__33062__$1 = (((G__33062 instanceof cljs.core.Keyword))?G__33062.fqn:null);
switch (G__33062__$1) {
case "expand":
var G__33073 = db;
var G__33074 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__33073;
frames = G__33074;
continue;
...
case "expand-rev":
var G__33075 = db;
var G__33076 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__33075;
frames = G__33076;
continue;
...
case "pattern":
var G__33077 = db;
var G__33078 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__33077;
frames = G__33078;
continue;
...
case "recursion":
var G__33079 = db;
var G__33080 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__33079;
frames = G__33080;
continue;
...
break;
case "done":
var vec__33063 = frames;
var seq__33064 = cljs.core.seq(vec__33063);
var first__33065 = cljs.core.first(seq__33064);
var seq__33064__$1 = cljs.core.next(seq__33064);
var f = first__33065;
var remaining = seq__33064__$1;
var result = (function (){var G__33066 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__33066);
} else {
return G__33066;
}
})();
...
var G__33081 = db;
var G__33082 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__33067 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__33067,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__33067;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__33062__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__33068_SHARP_){
return datascript.db.entid_strict(db,p1__33068_SHARP_);
})),eids);
