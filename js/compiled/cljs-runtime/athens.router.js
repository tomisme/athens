...
var G__52072_52140 = new cljs.core.Keyword(null,"current-route","current-route",2067529448);
var G__52073_52141 = (function (db){
return new cljs.core.Keyword(null,"current-route","current-route",2067529448).cljs$core$IFn$_invoke$arity$1(db);
});
(re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2(G__52072_52140,G__52073_52141) : re_frame.core.reg_sub.call(null,G__52072_52140,G__52073_52141));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigate","navigate",657596805),(function (_,p__52075){
...
var ___$1 = first__52078;
var route = seq__52077__$1;
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"navigate!","navigate!",79998348),route], null);
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigated","navigated",540897836),(function (p__52081,p__52082){
var map__52083 = p__52081;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52083__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__52084 = p__52082;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52084,(0),null);
var new_match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52084,(1),null);
...
var node = (function (){var G__52092 = athens.db.dsdb;
var G__52093 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__52094 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"path-params","path-params",-48130597).cljs$core$IFn$_invoke$arity$1(new_match))], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__52092,G__52093,G__52094) : posh.reagent.pull.call(null,G__52092,G__52093,G__52094));
})();
...
var G__52097_52142 = new cljs.core.Keyword(null,"navigate!","navigate!",79998348);
var G__52098_52143 = ((day8.re_frame.tracing.is_trace_enabled_QMARK_())?(function (route){
...
var opts__49981__auto__ = _PLUS_debux_dbg_opts_PLUS_;
var result__49982__auto__ = cljs.core.apply.cljs$core$IFn$_invoke$arity$2((function (){var opts__49981__auto____$1 = _PLUS_debux_dbg_opts_PLUS_;
var result__49982__auto__ = reitit.frontend.easy.push_state;
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__49982__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),new cljs.core.Symbol("rfee","push-state","rfee/push-state",305346137,null),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(1)], null));

return result__49982__auto__;
})(),(function (){var opts__49981__auto____$1 = _PLUS_debux_dbg_opts_PLUS_;
var result__49982__auto__ = route;
...
return result__49982__auto__;
}catch (e52105){var e = e52105;
throw e;
}}):(function (route){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(reitit.frontend.easy.push_state,route);
}));
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__52097_52142,G__52098_52143) : re_frame.core.reg_fx.call(null,G__52097_52142,G__52098_52143));
...
var G__52114 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigated","navigated",540897836),new_match], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__52114) : re_frame.core.dispatch.call(null,G__52114));
} else {
return null;
}
});
athens.router.navigate = (function athens$router$navigate(page){
var G__52115 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),page], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__52115) : re_frame.core.dispatch.call(null,G__52115));
});
...
var G__52138 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),uid], null)], null);
...
var G__52139 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("right-sidebar","open-item","right-sidebar/open-item",-1234515614),uid], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__52139) : re_frame.core.dispatch.call(null,G__52139));
} else {
