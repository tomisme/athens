...
shadow.remote.runtime.cljs.browser.abort_BANG_ = (function shadow$remote$runtime$cljs$browser$abort_BANG_(p__63956,action,ex){
var map__63957 = p__63956;
...
var state = map__63957__$1;
var callback = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63957__$1,new cljs.core.Keyword(null,"callback","callback",-705136228));
var G__63959 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(state,new cljs.core.Keyword(null,"failed","failed",-1397425762),true,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"completed","completed",-486056503),false,new cljs.core.Keyword(null,"ex","ex",-1413771341),ex,new cljs.core.Keyword(null,"ex-action","ex-action",672251553),action], 0));
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__63959) : callback.call(null,G__63959));
});
shadow.remote.runtime.cljs.browser.interpret_action = (function shadow$remote$runtime$cljs$browser$interpret_action(p__63960,p__63961){
var map__63962 = p__63960;
var map__63962__$1 = (((((!((map__63962 == null))))?(((((map__63962.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__63962.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__63962):map__63962);
var state = map__63962__$1;
var runtime = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63962__$1,new cljs.core.Keyword(null,"runtime","runtime",-1331573996));
var map__63963 = p__63961;
...
var action = map__63963__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63963__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__63966 = type;
var G__63966__$1 = (((G__63966 instanceof cljs.core.Keyword))?G__63966.fqn:null);
switch (G__63966__$1) {
case "repl/invoke":
var map__63967 = action;
var map__63967__$1 = (((((!((map__63967 == null))))?(((((map__63967.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__63967.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__63967):map__63967);
var js = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63967__$1,new cljs.core.Keyword(null,"js","js",1768080579));
try{var res = runtime.eval_js(js);
var G__63970 = cljs.core.update.cljs$core$IFn$_invoke$arity$4(state,new cljs.core.Keyword(null,"eval-results","eval-results",553789722),cljs.core.conj,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),res,new cljs.core.Keyword(null,"action","action",-811238024),action], null));
return (shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1 ? shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1(G__63970) : shadow.remote.runtime.cljs.browser.interpret_actions.call(null,G__63970));
}catch (e63969){var ex = e63969;
return shadow.remote.runtime.cljs.browser.abort_BANG_(state,action,ex);
}
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__63966__$1)].join('')));

}
});
shadow.remote.runtime.cljs.browser.interpret_actions = (function shadow$remote$runtime$cljs$browser$interpret_actions(p__63971){
...
var state = map__63972__$1;
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63972__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
if(cljs.core.empty_QMARK_(actions)){
var fexpr__63974 = new cljs.core.Keyword(null,"callback","callback",-705136228).cljs$core$IFn$_invoke$arity$1(state);
return (fexpr__63974.cljs$core$IFn$_invoke$arity$1 ? fexpr__63974.cljs$core$IFn$_invoke$arity$1(state) : fexpr__63974.call(null,state));
} else {
var map__63975 = cljs.core.first(actions);
...
var self__ = this;
var this$ = this;
var G__63982 = [shadow.cljs.devtools.client.env.get_url_base(),"/worker/compile/",shadow.cljs.devtools.client.env.build_id,"/",shadow.cljs.devtools.client.env.proc_id,"/browser"].join('');
var G__63983 = (function (res){
var req = this;
var map__63987 = shadow.remote.runtime.cljs.browser.transit_read(req.getResponseText());
...
var result = map__63987__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63987__$1,new cljs.core.Keyword(null,"type","type",1174270348));
if((!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("repl","actions","repl/actions",-809718877),type)))){
var G__63989 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"failed","failed",-1397425762),true,new cljs.core.Keyword(null,"result","result",1415092211),result], null);
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__63989) : callback.call(null,G__63989));
} else {
...
var G__63984 = "POST";
var G__63985 = shadow.remote.runtime.cljs.browser.transit_str(msg);
var G__63986 = ({"content-type": "application/transit+json; charset=utf-8"});
return goog.net.XhrIo.send(G__63982,G__63983,G__63984,G__63985,G__63986);
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k63978,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k63978,else__4442__auto__);
...
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63992,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63992,(1),null);
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__63977){
var self__ = this;
var G__63977__$1 = this;
return (new cljs.core.RecordIter((0),G__63977__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ws","ws",86841443),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__63995 = (function (coll__4436__auto__){
return (725844968 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__63995(this__4435__auto____$1);
})();
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this63979,other63980){
var self__ = this;
var this63979__$1 = this;
return (((!((other63980 == null)))) && ((this63979__$1.constructor === other63980.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this63979__$1.ws,other63980.ws)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this63979__$1.state_ref,other63980.state_ref)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this63979__$1.__extmap,other63980.__extmap)));
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__63977){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__63996 = cljs.core.keyword_identical_QMARK_;
var expr__63997 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__63999 = new cljs.core.Keyword(null,"ws","ws",86841443);
var G__64000 = expr__63997;
return (pred__63996.cljs$core$IFn$_invoke$arity$2 ? pred__63996.cljs$core$IFn$_invoke$arity$2(G__63999,G__64000) : pred__63996.call(null,G__63999,G__64000));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(G__63977,self__.state_ref,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__64001 = new cljs.core.Keyword(null,"state-ref","state-ref",2127874952);
var G__64002 = expr__63997;
return (pred__63996.cljs$core$IFn$_invoke$arity$2 ? pred__63996.cljs$core$IFn$_invoke$arity$2(G__64001,G__64002) : pred__63996.call(null,G__64001,G__64002));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,G__63977,self__.__meta,self__.__extmap,null));
} else {
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__63977),null));
}
}
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__63977){
var self__ = this;
var this__4438__auto____$1 = this;
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,G__63977,self__.__extmap,self__.__hash));
}));
 ...
 */
shadow.remote.runtime.cljs.browser.map__GT_BrowserRuntime = (function shadow$remote$runtime$cljs$browser$map__GT_BrowserRuntime(G__63981){
var extmap__4478__auto__ = (function (){var G__64003 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__63981,new cljs.core.Keyword(null,"ws","ws",86841443),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], 0));
if(cljs.core.record_QMARK_(G__63981)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__64003);
} else {
return G__64003;
}
})();
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(new cljs.core.Keyword(null,"ws","ws",86841443).cljs$core$IFn$_invoke$arity$1(G__63981),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952).cljs$core$IFn$_invoke$arity$1(G__63981),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var runtime = (function (){var G__64004 = (new shadow.remote.runtime.cljs.browser.BrowserRuntime(socket,state_ref,null,null,null));
shadow.remote.runtime.shared.add_defaults(G__64004);
...
var map__64005 = temp__5737__auto__;
...
var stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64005__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
