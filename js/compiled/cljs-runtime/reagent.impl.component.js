...
if((i < len)){
var k = (ks[i]);
var G__51931 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__51932 = (i + (1));
m = G__51931;
i = G__51932;
continue;
...
var temp__5737__auto__ = p.argv;
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__51884 = p.children;
return module$node_modules$react$index.Children.toArray(G__51884);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__51886 = c;
var G__51886__$1 = (((G__51886 == null))?null:G__51886.prototype);
if((G__51886__$1 == null)){
return null;
} else {
return G__51886__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__51890 = c;
var G__51890__$1 = (((G__51890 == null))?null:G__51890.prototype);
if((G__51890__$1 == null)){
return null;
} else {
return G__51890__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__51970__delegate = function (args){
var G__51892 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__51892) : reagent.impl.component.as_element.call(null,G__51892));
};
...
while (G__51971__i < G__51971__a.length) {G__51971__a[G__51971__i] = arguments[G__51971__i + 0]; ++G__51971__i;}
  args = new cljs.core.IndexedSeq(G__51971__a,0,null);
} 
return G__51970__delegate.call(this,args);};
G__51970.cljs$lang$maxFixedArity = 0;
G__51970.cljs$lang$applyTo = (function (arglist__51972){
var args = cljs.core.seq(arglist__51972);
return G__51970__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__51893 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__51894 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__51894);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__51893);
}});
...
var renders_52007 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_52008 = cljs.core.first(cljs.core.vals(renders_52007));
...
if((cljs.core.count(renders_52007) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_52007))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_52008)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_52008], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__51905 = o;
var G__51906_52012 = G__51905;
var G__51907_52013 = cljs.core.name(k);
var G__51908_52014 = v;
goog.object.set(G__51906_52012,G__51907_52013,G__51908_52014);
...
var G__51909_52023 = cmp.prototype;
var G__51910_52024 = module$node_modules$react$index.Component.prototype;
var G__51911_52025 = methods$;
goog.object.extend(G__51909_52023,G__51910_52024,G__51911_52025);
...
var name = (function (){var G__51912 = fiber;
var G__51912__$1 = (((G__51912 == null))?null:G__51912.type);
if((G__51912__$1 == null)){
return null;
} else {
return G__51912__$1.displayName;
}
})();
var parent = (function (){var G__51913 = fiber;
if((G__51913 == null)){
return null;
} else {
return G__51913.return;
}
})();
var path = (function (){var G__51914 = parent;
var G__51914__$1 = (((G__51914 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__51914) : reagent.impl.component.fiber_component_path.call(null,G__51914)));
if((G__51914__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__51914__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4185__auto__ = (function (){var G__51916 = c;
if((G__51916 == null)){
return null;
} else {
return goog.object.get(G__51916,"_reactInternalFiber");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__51917._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4185__auto__ = (function (){var G__51919 = c;
if((G__51919 == null)){
return null;
} else {
return goog.object.get(G__51919,"_reactInternalInstance");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var or__4185__auto____$1 = (function (){var G__51921 = c;
if((G__51921 == null)){
return null;
} else {
return G__51921._reactInternalInstance;
}
})();
if(cljs.core.truth_(or__4185__auto____$1)){
return or__4185__auto____$1;
...
var elem = (function (){var or__4185__auto__ = (function (){var G__51923 = instance;
if((G__51923 == null)){
return null;
} else {
return goog.object.get(G__51923,"_currentElement");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var G__51924 = instance;
if((G__51924 == null)){
return null;
} else {
return G__51924._currentElement;
}
}
})();
var name = (function (){var G__51925 = elem;
...
var owner = (function (){var or__4185__auto__ = (function (){var G__51927 = elem;
if((G__51927 == null)){
return null;
} else {
return goog.object.get(G__51927,"_owner");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__51928._owner;
}
}
})();
var path = (function (){var G__51929 = owner;
var G__51929__$1 = (((G__51929 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__51929) : reagent.impl.component.component_path.call(null,G__51929)));
...
var G__51930 = c;
var G__51930__$1 = (((G__51930 == null))?null:G__51930.constructor);
if((G__51930__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__51930__$1);
}
}
})();
