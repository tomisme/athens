...
var vec__51489 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__51493 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51493,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51493,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51489,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51489,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__51496){
var vec__51497 = p__51496;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51497,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51497,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51500,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51500,(1),null);
...
var vec__51504 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51504,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51504,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51504,(2),null);
var vec__51507 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51507,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51507,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51507,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__51511){
var vec__51512 = p__51511;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51512,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51512,(1),null);
...
var len__4789__auto___51553 = arguments.length;
var i__4790__auto___51554 = (0);
while(true){
if((i__4790__auto___51554 < len__4789__auto___51553)){
args__4795__auto__.push((arguments[i__4790__auto___51554]));

var G__51555 = (i__4790__auto___51554 + (1));
i__4790__auto___51554 = G__51555;
continue;
} else {
}
break;
...
var i__4790__auto___51566 = (0);
while(true){
if((i__4790__auto___51566 < len__4789__auto___51565)){
args__4795__auto__.push((arguments[i__4790__auto___51566]));

var G__51567 = (i__4790__auto___51566 + (1));
i__4790__auto___51566 = G__51567;
continue;
} else {
}
break;
