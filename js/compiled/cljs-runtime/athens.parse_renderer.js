...
var G__53381 = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"block","block",664686210),(function() { 
var G__53414__delegate = function (contents){
...
var G__53414 = function (var_args){
var contents = null;
if (arguments.length > 0) {
var G__53415__i = 0, G__53415__a = new Array(arguments.length -  0);
while (G__53415__i < G__53415__a.length) {G__53415__a[G__53415__i] = arguments[G__53415__i + 0]; ++G__53415__i;}
  contents = new cljs.core.IndexedSeq(G__53415__a,0,null);
} 
return G__53414__delegate.call(this,contents);};
G__53414.cljs$lang$maxFixedArity = 0;
G__53414.cljs$lang$applyTo = (function (arglist__53416){
var contents = cljs.core.seq(arglist__53416);
return G__53414__delegate(contents);
});
G__53414.cljs$core$IFn$_invoke$arity$variadic = G__53414__delegate;
return G__53414;
})()
,new cljs.core.Keyword(null,"page-link","page-link",-169621200),(function (title){
var node = (function (){var G__53383 = athens.db.dsdb;
var G__53384 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__53385 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),title], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__53383,G__53384,G__53385) : posh.reagent.pull.call(null,G__53383,G__53384,G__53385));
})();
...
var block = (function (){var G__53386 = athens.db.dsdb;
var G__53387 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__53388 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__53386,G__53387,G__53388) : posh.reagent.pull.call(null,G__53386,G__53387,G__53388));
})();
...
})], null),(function (){var G__53389 = new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(block));
return (athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1 ? athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1(G__53389) : athens.parse_renderer.parse_and_render.call(null,G__53389));
})()], null)], null);
}),new cljs.core.Keyword(null,"hashtag","hashtag",-529028899),(function (tag_name){
var node = (function (){var G__53390 = athens.db.dsdb;
var G__53391 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__53392 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),tag_name], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__53390,G__53391,G__53392) : posh.reagent.pull.call(null,G__53390,G__53391,G__53392));
})();
...
}),new cljs.core.Keyword(null,"url-image","url-image",535142411),(function (p__53393){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53394__$1,new cljs.core.Keyword(null,"url","url",276297046));
var alt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53394__$1,new cljs.core.Keyword(null,"alt","alt",-3214426));
...
}),new cljs.core.Keyword(null,"url-link","url-link",1615670141),(function (p__53396,text){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53397__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
var G__53382 = tree;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__53381,G__53382) : instaparse.core.transform.call(null,G__53381,G__53382));
});
/**
