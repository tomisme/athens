...
var G__55076 = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"block","block",664686210),(function() { 
var G__55094__delegate = function (contents){
...
while (G__55095__i < G__55095__a.length) {G__55095__a[G__55095__i] = arguments[G__55095__i + 0]; ++G__55095__i;}
  contents = new cljs.core.IndexedSeq(G__55095__a,0,null);
} 
return G__55094__delegate.call(this,contents);};
G__55094.cljs$lang$maxFixedArity = 0;
G__55094.cljs$lang$applyTo = (function (arglist__55096){
var contents = cljs.core.seq(arglist__55096);
return G__55094__delegate(contents);
});
...
var node = (function (){var G__55078 = athens.db.dsdb;
var G__55079 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__55080 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),title], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__55078,G__55079,G__55080) : posh.reagent.pull.call(null,G__55078,G__55079,G__55080));
})();
...
var block = (function (){var G__55081 = athens.db.dsdb;
var G__55082 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__55083 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__55081,G__55082,G__55083) : posh.reagent.pull.call(null,G__55081,G__55082,G__55083));
})();
...
})], null),(function (){var G__55084 = new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(block));
return (athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1 ? athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1(G__55084) : athens.parse_renderer.parse_and_render.call(null,G__55084));
})()], null)], null);
}),new cljs.core.Keyword(null,"hashtag","hashtag",-529028899),(function (tag_name){
var node = (function (){var G__55085 = athens.db.dsdb;
var G__55086 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__55087 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),tag_name], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__55085,G__55086,G__55087) : posh.reagent.pull.call(null,G__55085,G__55086,G__55087));
})();
...
}),new cljs.core.Keyword(null,"url-image","url-image",535142411),(function (p__55088){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55089__$1,new cljs.core.Keyword(null,"url","url",276297046));
var alt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55089__$1,new cljs.core.Keyword(null,"alt","alt",-3214426));
...
}),new cljs.core.Keyword(null,"url-link","url-link",1615670141),(function (p__55091,text){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55092__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
var G__55077 = tree;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__55076,G__55077) : instaparse.core.transform.call(null,G__55076,G__55077));
});
/**
