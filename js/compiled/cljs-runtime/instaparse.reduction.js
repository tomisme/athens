...
var G__53088 = new cljs.core.Keyword(null,"reduction-type","reduction-type",-488293450).cljs$core$IFn$_invoke$arity$1(f);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$reduction$iter__53091(s__53092){
return (new cljs.core.LazySeq(null,(function (){
var s__53092__$1 = s__53092;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__53092__$1);
if(temp__5735__auto__){
var s__53092__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__53092__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__53092__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__53094 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__53093 = (0);
while(true){
if((i__53093 < size__4581__auto__)){
var vec__53095 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__53093);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53095,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53095,(1),null);
cljs.core.chunk_append(b__53094,(cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)));

var G__53103 = (i__53093 + (1));
i__53093 = G__53103;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__53094),instaparse$reduction$iter__53091(cljs.core.chunk_rest(s__53092__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__53094),null);
}
} else {
var vec__53098 = cljs.core.first(s__53092__$2);
...
return cljs.core.cons((cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)),instaparse$reduction$iter__53091(cljs.core.rest(s__53092__$2)));
}
} else {
return null;
}
