...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__55595,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var _m = map__55596__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55596__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55596__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55596__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55596__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__55633 = cljs.core.next(args__$1);
var G__55634 = cljs.core.next(params__$1);
var G__55635 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__55633;
params__$1 = G__55634;
ret = G__55635;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__55601 = ctx__$1;
var G__55602 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__55601,G__55602) : interpret.call(null,G__55601,G__55602));
...
var vec__55603 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55603,(0),null);
var vec__55606 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55603,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55606,(0),null);
var G__55637 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__55637;
continue;
} else {
var G__55638 = recur_val;
args = G__55638;
continue;
}
} else {
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__55640){
...
var map__55609 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55609__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55609__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__55622){
var map__55623 = p__55622;
...
var f = map__55623__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55623__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55623__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
while (G__55644__i < G__55644__a.length) {G__55644__a[G__55644__i] = arguments[G__55644__i + 0]; ++G__55644__i;}
  args = new cljs.core.IndexedSeq(G__55644__a,0,null);
} 
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55614_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__55614_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__55653__delegate = function (args){
...
var G__55653 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__55654__i = 0, G__55654__a = new Array(arguments.length -  0);
while (G__55654__i < G__55654__a.length) {G__55654__a[G__55654__i] = arguments[G__55654__i + 0]; ++G__55654__i;}
  args = new cljs.core.IndexedSeq(G__55654__a,0,null);
} 
return G__55653__delegate.call(this,args);};
G__55653.cljs$lang$maxFixedArity = 0;
G__55653.cljs$lang$applyTo = (function (arglist__55656){
var args = cljs.core.seq(arglist__55656);
return G__55653__delegate(args);
});
G__55653.cljs$core$IFn$_invoke$arity$variadic = G__55653__delegate;
return G__55653;
})()
;
})());
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__55618_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__55618_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
