...
var vec__70621 = cljs.core.rest(expr);
var seq__70622 = cljs.core.seq(vec__70621);
var first__70623 = cljs.core.first(seq__70622);
var seq__70622__$1 = cljs.core.next(seq__70622);
var vec__70624 = first__70623;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70624,(0),null);
var form = seq__70622__$1;
...
var G__70627 = x;
var G__70627__$1 = (((G__70627 == null))?null:spec_tools.impl.polish(G__70627));
var G__70627__$2 = (((G__70627__$1 == null))?null:cljs.core.name(G__70627__$1));
if((G__70627__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__70627__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__70628 = x;
var G__70628__$1 = (((G__70628 == null))?null:cljs.core.name(G__70628));
if((G__70628__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__70628__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__70629){
var map__70630 = p__70629;
var map__70630__$1 = (((((!((map__70630 == null))))?(((((map__70630.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__70630.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__70630):map__70630);
var data = map__70630__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70630__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70630__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70630__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70630__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__70632){
var map__70633 = p__70632;
var map__70633__$1 = (((((!((map__70633 == null))))?(((((map__70633.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__70633.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__70633):map__70633);
var data = map__70633__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70633__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70633__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__70635 = data;
var G__70635__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__70635,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__70635);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__70635__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__70635__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__70639 = form;
var G__70639__$1 = (((G__70639 == null))?null:cljs.core.rest(G__70639));
if((G__70639__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__70639__$1);
}
})();
var G__70640 = m;
var G__70640__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__70640,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__70636_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__70636_SHARP_)));
})):G__70640);
var G__70640__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__70640__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__70637_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__70637_SHARP_)));
})):G__70640__$1);
var G__70640__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__70640__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__70638_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__70638_SHARP_));
})):G__70640__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__70640__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__70641 = (function (){var G__70642 = form;
var G__70642__$1 = (((G__70642 == null))?null:cljs.core.rest(G__70642));
if((G__70642__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__70642__$1);
}
})();
var map__70641__$1 = (((((!((map__70641 == null))))?(((((map__70641.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__70641.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__70641):map__70641);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70641__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70641__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70641__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70641__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__70644 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__70644) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__70645 = form;
var G__70645__$1 = (((G__70645 == null))?null:cljs.core.seq(G__70645));
var G__70645__$2 = (((G__70645__$1 == null))?null:cljs.core.first(G__70645__$1));
if((G__70645__$2 == null)){
return null;
} else {
var fexpr__70646 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__70646.cljs$core$IFn$_invoke$arity$1 ? fexpr__70646.cljs$core$IFn$_invoke$arity$1(G__70645__$2) : fexpr__70646.call(null,G__70645__$2));
}
})():null));
});
/**
...
var len__4789__auto___70667 = arguments.length;
var i__4790__auto___70668 = (0);
while(true){
if((i__4790__auto___70668 < len__4789__auto___70667)){
args__4795__auto__.push((arguments[i__4790__auto___70668]));

var G__70669 = (i__4790__auto___70668 + (1));
i__4790__auto___70668 = G__70669;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq70647){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq70647));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__70648){
var vec__70649 = p__70648;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70649,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70649,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__70654){
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70655__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70655__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70655__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70655__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__70652_SHARP_){
return cljs.core.map_QMARK_(p1__70652_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__70653_SHARP_){
return cljs.core.contains_QMARK_(p1__70653_SHARP_,x);
});
}),req_keys));
