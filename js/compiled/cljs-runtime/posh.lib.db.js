...
var G__37447 = cljs.core.first(poshdb);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__37447__$1)].join('')));
...
var G__37486 = cljs.core.cons(pdb,path);
var G__37487 = posh.lib.db.get_parent_db(pdb);
path = G__37486;
pdb = G__37487;
continue;
} else {
...
var G__37493 = posh.lib.db.get_parent_db(poshdb);
poshdb = G__37493;
continue;
}
break;
...
var filter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37458__$1,new cljs.core.Keyword(null,"filter","filter",-948537934));
var as_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37458__$1,new cljs.core.Keyword(null,"as-of","as-of",-1841962382));
var since = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37458__$1,new cljs.core.Keyword(null,"since","since",315379842));
var with$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37458__$1,new cljs.core.Keyword(null,"with","with",-1536296876));
var db__$1 = (function (){var or__4185__auto__ = db;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var fexpr__37460 = new cljs.core.Keyword(null,"db","db",993250759).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__37460.cljs$core$IFn$_invoke$arity$1 ? fexpr__37460.cljs$core$IFn$_invoke$arity$1(conn) : fexpr__37460.call(null,conn));
}
})();
var db__$2 = (cljs.core.truth_(since)?(function (){var fexpr__37461 = new cljs.core.Keyword(null,"since","since",315379842).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__37461.cljs$core$IFn$_invoke$arity$2 ? fexpr__37461.cljs$core$IFn$_invoke$arity$2(db__$1,since) : fexpr__37461.call(null,db__$1,since));
})():db__$1);
var db__$3 = (cljs.core.truth_(as_of)?(function (){var fexpr__37466 = new cljs.core.Keyword(null,"as-of","as-of",-1841962382).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__37466.cljs$core$IFn$_invoke$arity$2 ? fexpr__37466.cljs$core$IFn$_invoke$arity$2(db__$2,as_of) : fexpr__37466.call(null,db__$2,as_of));
})():db__$2);
var db__$4 = (cljs.core.truth_(with$)?new cljs.core.Keyword(null,"db-after","db-after",-571884666).cljs$core$IFn$_invoke$arity$1((function (){var fexpr__37467 = new cljs.core.Keyword(null,"with","with",-1536296876).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__37467.cljs$core$IFn$_invoke$arity$2 ? fexpr__37467.cljs$core$IFn$_invoke$arity$2(db__$3,with$) : fexpr__37467.call(null,db__$3,with$));
})()):db__$3);
var db__$5 = (cljs.core.truth_(filter)?(function (){var G__37473 = db__$4;
var G__37474 = (((filter instanceof cljs.core.Symbol))?null:filter);
var fexpr__37472 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__37472.cljs$core$IFn$_invoke$arity$2 ? fexpr__37472.cljs$core$IFn$_invoke$arity$2(G__37473,G__37474) : fexpr__37472.call(null,G__37473,G__37474));
})():db__$4);
return db__$5;
}));
...
posh.lib.db.poshdb__GT_db = (function posh$lib$db$poshdb__GT_db(p__37475,poshdb){
...
var posh_tree = map__37476__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37476__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37476__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(poshdb),new cljs.core.Keyword(null,"db","db",993250759))){
return posh.lib.db.db_id__GT_db(posh_tree,cljs.core.second(poshdb));
} else {
var G__37479 = (function (){var G__37481 = posh_tree;
var G__37482 = posh.lib.db.get_parent_db(poshdb);
return (posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2 ? posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2(G__37481,G__37482) : posh.lib.db.poshdb__GT_db.call(null,G__37481,G__37482));
})();
var G__37480 = posh.lib.db.make_filter_pred(new cljs.core.Keyword(null,"pass-patterns","pass-patterns",1090887263).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cache,poshdb)));
var fexpr__37478 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__37478.cljs$core$IFn$_invoke$arity$2 ? fexpr__37478.cljs$core$IFn$_invoke$arity$2(G__37479,G__37480) : fexpr__37478.call(null,G__37479,G__37480));
}
});
