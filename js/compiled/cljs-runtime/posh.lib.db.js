...
var G__47414 = cljs.core.first(poshdb);
var G__47414__$1 = (((G__47414 instanceof cljs.core.Keyword))?G__47414.fqn:null);
switch (G__47414__$1) {
case "db":
return null;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__47414__$1)].join('')));
...
var G__47472 = cljs.core.cons(pdb,path);
var G__47473 = posh.lib.db.get_parent_db(pdb);
path = G__47472;
pdb = G__47473;
continue;
} else {
...
var G__47477 = posh.lib.db.get_parent_db(poshdb);
poshdb = G__47477;
continue;
}
break;
...
var filter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47436__$1,new cljs.core.Keyword(null,"filter","filter",-948537934));
var as_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47436__$1,new cljs.core.Keyword(null,"as-of","as-of",-1841962382));
var since = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47436__$1,new cljs.core.Keyword(null,"since","since",315379842));
var with$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47436__$1,new cljs.core.Keyword(null,"with","with",-1536296876));
var db__$1 = (function (){var or__4185__auto__ = db;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var fexpr__47444 = new cljs.core.Keyword(null,"db","db",993250759).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__47444.cljs$core$IFn$_invoke$arity$1 ? fexpr__47444.cljs$core$IFn$_invoke$arity$1(conn) : fexpr__47444.call(null,conn));
}
})();
var db__$2 = (cljs.core.truth_(since)?(function (){var fexpr__47445 = new cljs.core.Keyword(null,"since","since",315379842).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__47445.cljs$core$IFn$_invoke$arity$2 ? fexpr__47445.cljs$core$IFn$_invoke$arity$2(db__$1,since) : fexpr__47445.call(null,db__$1,since));
})():db__$1);
var db__$3 = (cljs.core.truth_(as_of)?(function (){var fexpr__47446 = new cljs.core.Keyword(null,"as-of","as-of",-1841962382).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__47446.cljs$core$IFn$_invoke$arity$2 ? fexpr__47446.cljs$core$IFn$_invoke$arity$2(db__$2,as_of) : fexpr__47446.call(null,db__$2,as_of));
})():db__$2);
var db__$4 = (cljs.core.truth_(with$)?new cljs.core.Keyword(null,"db-after","db-after",-571884666).cljs$core$IFn$_invoke$arity$1((function (){var fexpr__47447 = new cljs.core.Keyword(null,"with","with",-1536296876).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__47447.cljs$core$IFn$_invoke$arity$2 ? fexpr__47447.cljs$core$IFn$_invoke$arity$2(db__$3,with$) : fexpr__47447.call(null,db__$3,with$));
})()):db__$3);
var db__$5 = (cljs.core.truth_(filter)?(function (){var G__47449 = db__$4;
var G__47450 = (((filter instanceof cljs.core.Symbol))?null:filter);
var fexpr__47448 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__47448.cljs$core$IFn$_invoke$arity$2 ? fexpr__47448.cljs$core$IFn$_invoke$arity$2(G__47449,G__47450) : fexpr__47448.call(null,G__47449,G__47450));
})():db__$4);
return db__$5;
}));
...
posh.lib.db.poshdb__GT_db = (function posh$lib$db$poshdb__GT_db(p__47455,poshdb){
...
var posh_tree = map__47456__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47456__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47456__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(poshdb),new cljs.core.Keyword(null,"db","db",993250759))){
return posh.lib.db.db_id__GT_db(posh_tree,cljs.core.second(poshdb));
} else {
var G__47459 = (function (){var G__47461 = posh_tree;
var G__47462 = posh.lib.db.get_parent_db(poshdb);
return (posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2 ? posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2(G__47461,G__47462) : posh.lib.db.poshdb__GT_db.call(null,G__47461,G__47462));
})();
var G__47460 = posh.lib.db.make_filter_pred(new cljs.core.Keyword(null,"pass-patterns","pass-patterns",1090887263).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cache,poshdb)));
var fexpr__47458 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__47458.cljs$core$IFn$_invoke$arity$2 ? fexpr__47458.cljs$core$IFn$_invoke$arity$2(G__47459,G__47460) : fexpr__47458.call(null,G__47459,G__47460));
}
});
