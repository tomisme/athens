...
var G__40589 = new cljs.core.Keyword(null,"events","events",1792552201).cljs$core$IFn$_invoke$arity$1(task);
var G__40590 = now_seen_events;
var fexpr__40588 = new cljs.core.Keyword(null,"when","when",-576417306).cljs$core$IFn$_invoke$arity$1(task);
return (fexpr__40588.cljs$core$IFn$_invoke$arity$2 ? fexpr__40588.cljs$core$IFn$_invoke$arity$2(G__40589,G__40590) : fexpr__40588.call(null,G__40589,G__40590));
...
var G__40595 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__40596 = "async-flow: got bad value for :when - ";
var G__40597 = when_kw;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__40595,G__40596,G__40597) : re_frame.core.console.call(null,G__40595,G__40596,G__40597));
}
});
/**
...
return cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (index,p__40598){
...
var rule = map__40599__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40599__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var when = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40599__$1,new cljs.core.Keyword(null,"when","when",-576417306));
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40599__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40599__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40599__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40599__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var halt_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40599__$1,new cljs.core.Keyword(null,"halt?","halt?",-1110658247));
...
var G__40601 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__40602 = "async-flow: rule can only specify one of :dispatch, :dispatch-n and :dispatch-fn. Got more than one: ";
var G__40603 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__40601,G__40602,G__40603) : re_frame.core.console.call(null,G__40601,G__40602,G__40603));
} else {
var G__40604 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__4185__auto__ = id;
...
var G__40604__$1 = (cljs.core.truth_(dispatch_fn)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__40604,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614),dispatch_fn):G__40604);
if(cljs.core.not(dispatch_fn)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__40604__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236),(cljs.core.truth_(dispatch_n)?dispatch_n:(cljs.core.truth_(dispatch)?(new cljs.core.List(null,dispatch,null,(1),null)):cljs.core.List.EMPTY
)));
} else {
return G__40604__$1;
}
...
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40608__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40608__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
...
var G__40610 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__40611 = "async-flow: dispatch-fn must return a seq of events ";
var G__40612 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__40610,G__40611,G__40612) : re_frame.core.console.call(null,G__40610,G__40611,G__40612));
}
} else {
 ...
 */
day8.re_frame.async_flow_fx.make_flow_event_handler = (function day8$re_frame$async_flow_fx$make_flow_event_handler(p__40613){
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40615__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var db_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40615__$1,new cljs.core.Keyword(null,"db-path","db-path",-68094099));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40615__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var first_dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40615__$1,new cljs.core.Keyword(null,"first-dispatch","first-dispatch",128561923));
...
return (function day8$re_frame$async_flow_fx$make_flow_event_handler_$_async_flow_event_handler(p__40622,p__40623){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40624__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__40625 = p__40623;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40625,(0),null);
var event_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40625,(1),null);
var event_v = vec__40625;
var pred__40629 = cljs.core._EQ_;
var expr__40630 = event_type;
if(cljs.core.truth_((function (){var G__40633 = new cljs.core.Keyword(null,"setup","setup",1987730512);
var G__40634 = expr__40630;
return (pred__40629.cljs$core$IFn$_invoke$arity$2 ? pred__40629.cljs$core$IFn$_invoke$arity$2(G__40633,G__40634) : pred__40629.call(null,G__40633,G__40634));
})())){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),(function (){var G__40636 = db;
var G__40637 = cljs.core.PersistentHashSet.EMPTY;
var G__40638 = cljs.core.PersistentHashSet.EMPTY;
return (set_state.cljs$core$IFn$_invoke$arity$3 ? set_state.cljs$core$IFn$_invoke$arity$3(G__40636,G__40637,G__40638) : set_state.call(null,G__40636,G__40637,G__40638));
...
var vec__40640 = event_v;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40640,(0),null);
var forwarded_event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40640,(1),null);
var map__40643 = (get_state.cljs$core$IFn$_invoke$arity$1 ? get_state.cljs$core$IFn$_invoke$arity$1(db) : get_state.call(null,db));
...
var seen_events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40643__$1,new cljs.core.Keyword(null,"seen-events","seen-events",1607648392));
var rules_fired = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40643__$1,new cljs.core.Keyword(null,"rules-fired","rules-fired",-1669838140));
...
var vec__40651 = day8.re_frame.async_flow_fx.ensure_has_id(flow);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40651,(0),null);
var flow_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40651,(1),null);
...
var G__40654 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,new cljs.core.Keyword(null,"setup","setup",1987730512)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__40654) : re_frame.core.dispatch.call(null,G__40654));
});
var G__40655_40669 = new cljs.core.Keyword(null,"async-flow","async-flow",1464712702);
var G__40656_40670 = day8.re_frame.async_flow_fx.flow__GT_handler;
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__40655_40669,G__40656_40670) : re_frame.core.reg_fx.call(null,G__40655_40669,G__40656_40670));
