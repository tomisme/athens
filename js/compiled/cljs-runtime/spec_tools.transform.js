...
if((x instanceof cljs.core.Keyword)){
var G__70687 = spec;
var G__70688 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__70687,G__70688) : f.call(null,G__70687,G__70688));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__70689 = spec;
var G__70690 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__70689,G__70690) : f.call(null,G__70689,G__70690));
} else {
return x;
...
}catch (e70691){if((e70691 instanceof Error)){
var ___$1 = e70691;
return x;
} else {
throw e70691;
...
}catch (e70692){if((e70692 instanceof Error)){
var ___$1 = e70692;
return x;
} else {
throw e70692;
...
}catch (e70693){if((e70693 instanceof Error)){
var ___$1 = e70693;
return x;
} else {
throw e70693;
...
}catch (e70694){if((e70694 instanceof Error)){
var ___$1 = e70694;
return x;
} else {
throw e70694;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__70696,x){
var map__70697 = p__70696;
var map__70697__$1 = (((((!((map__70697 == null))))?(((((map__70697.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__70697.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__70697):map__70697);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70697__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__70699,x){
var map__70700 = p__70699;
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70700__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__70702,x){
var map__70703 = p__70702;
var map__70703__$1 = (((((!((map__70703 == null))))?(((((map__70703.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__70703.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__70703):map__70703);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70703__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
