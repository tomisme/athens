...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__48093 = goog.object.get(JSJodaLocale,"Locale");
if((G__48093 == null)){
return null;
} else {
return goog.object.get(G__48093,"US");
}
}catch (e48092){if((e48092 instanceof Error)){
var e = e48092;
return null;
} else {
throw e48092;
