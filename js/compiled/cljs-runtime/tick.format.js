...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__55374 = goog.object.get(JSJodaLocale,"Locale");
if((G__55374 == null)){
return null;
} else {
return goog.object.get(G__55374,"US");
}
}catch (e55373){if((e55373 instanceof Error)){
var e = e55373;
return null;
} else {
throw e55373;
