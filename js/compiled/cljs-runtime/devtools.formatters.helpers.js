...
var G__43124 = devtools.prefs.pref(v);
v = G__43124;
continue;
} else {
return v;
...
}catch (e43064){var _e__40078__auto__ = e43064;
return false;
}})();
...
}catch (e43070){var _e__40078__auto__ = e43070;
return false;
}})();
...
}catch (e43072){var _e__40078__auto__ = e43072;
return false;
}}
}
});
...
var vec__43099 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43099,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43099,(1),null);
...
return cljs.core.some((function (p1__43110_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__43110_SHARP_);
}),template);
});
