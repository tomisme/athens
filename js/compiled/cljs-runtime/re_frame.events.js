...
var make_chain = (function (p1__39680_SHARP_){
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.flatten(p1__39680_SHARP_));
});
...
var temp__5735__auto___39695 = cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(re_frame.interceptor.interceptor_QMARK_,chain));
if(cljs.core.truth_(temp__5735__auto___39695)){
var not_i_39696 = temp__5735__auto___39695;
if(cljs.core.fn_QMARK_(not_i_39696)){
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["re-frame: when registering",id,", got a function instead of an interceptor. Did you provide old style middleware by mistake? Got:",not_i_39696], 0));
} else {
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["re-frame: when registering",id,", expected interceptors, but got:",not_i_39696], 0));
}
} else {
}
...
var _STAR_handling_STAR__orig_val__39686 = re_frame.events._STAR_handling_STAR_;
var _STAR_handling_STAR__temp_val__39687 = event_v;
(re_frame.events._STAR_handling_STAR_ = _STAR_handling_STAR__temp_val__39687);
...
}finally {(re_frame.events._STAR_handling_STAR_ = _STAR_handling_STAR__orig_val__39686);
}}
} else {
return null;
}
