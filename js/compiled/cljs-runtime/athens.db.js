...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__39063){
var vec__39064 = p__39063;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39064,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39064,(1),null);
...
}),cljs.core.PersistentArrayMap.EMPTY,p1__39062_SHARP_);
}),hms);
}
});
/**
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__39068_SHARP_){
return cljs.core.cons(new cljs.core.Keyword("db","add","db/add",235286841),p1__39068_SHARP_);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__39067_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.edn.read_string,p1__39067_SHARP_);
...
return athens.db.sort_block_children(cljs.core.deref((function (){var G__39069 = athens.db.dsdb;
var G__39070 = new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","id","db/id",-1388397098),new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword("block","string","block/string",-2066596447),new cljs.core.Keyword("block","open","block/open",-1875254829),new cljs.core.Keyword("block","order","block/order",-1429282437),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","children","block/children",-1040716209),new cljs.core.Symbol(null,"...","...",-1926939749,null)], null)], null);
var G__39071 = id;
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__39069,G__39070,G__39071) : posh.reagent.pull.call(null,G__39069,G__39070,G__39071));
})()));
});
athens.db.get_node_document = (function athens$db$get_node_document(id){
return athens.db.sort_block_children(cljs.core.deref((function (){var G__39072 = athens.db.dsdb;
var G__39073 = new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","id","db/id",-1388397098),new cljs.core.Keyword("node","title","node/title",628940777),new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword("block","string","block/string",-2066596447),new cljs.core.Keyword("block","open","block/open",-1875254829),new cljs.core.Keyword("block","order","block/order",-1429282437),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","children","block/children",-1040716209),new cljs.core.Symbol(null,"...","...",-1926939749,null)], null)], null);
var G__39074 = id;
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__39072,G__39073,G__39074) : posh.reagent.pull.call(null,G__39072,G__39073,G__39074));
})()));
});
/**
...
var G__39088 = cljs.core.first(new cljs.core.Keyword("block","_children","block/_children",1128070632).cljs$core$IFn$_invoke$arity$1(b));
var G__39089 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(b,new cljs.core.Keyword("block","_children","block/_children",1128070632)));
b = G__39088;
res = G__39089;
continue;
}
...
return athens.db.shape_parent_query(cljs.core.deref((function (){var G__39075 = athens.db.dsdb;
var G__39076 = new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","id","db/id",-1388397098),new cljs.core.Keyword("node","title","node/title",628940777),new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword("block","string","block/string",-2066596447),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","_children","block/_children",1128070632),new cljs.core.Symbol(null,"...","...",-1926939749,null)], null)], null);
var G__39077 = id;
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__39075,G__39076,G__39077) : posh.reagent.pull.call(null,G__39075,G__39076,G__39077));
})()));
});
athens.db.get_block = (function athens$db$get_block(id){
return cljs.core.deref((function (){var G__39078 = athens.db.dsdb;
var G__39079 = new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","id","db/id",-1388397098),new cljs.core.Keyword("node","title","node/title",628940777),new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword("block","order","block/order",-1429282437),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","children","block/children",-1040716209),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword("block","order","block/order",-1429282437)], null)], null)], null);
var G__39080 = id;
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__39078,G__39079,G__39080) : posh.reagent.pull.call(null,G__39078,G__39079,G__39080));
})());
});
athens.db.get_parent = (function athens$db$get_parent(id){
return athens.db.get_block(new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(cljs.core.first(new cljs.core.Keyword("block","_children","block/_children",1128070632).cljs$core$IFn$_invoke$arity$1((function (){var G__39081 = cljs.core.deref(athens.db.dsdb);
var G__39082 = id;
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__39081,G__39082) : datascript.core.entity.call(null,G__39081,G__39082));
})()))));
});
...
var G__39090 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(acc,x);
var G__39091 = cljs.core.next(xs__$1);
acc = G__39090;
xs__$1 = G__39091;
continue;
...
return cljs.core.last(cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__39083_SHARP_){
return cljs.core.not((pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(p1__39083_SHARP_) : pred.call(null,p1__39083_SHARP_)));
}),xs));
});
athens.db.find_next = (function athens$db$find_next(xs,pred){
return cljs.core.fnext(cljs.core.drop_while.cljs$core$IFn$_invoke$arity$2((function (p1__39084_SHARP_){
return cljs.core.not((pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(p1__39084_SHARP_) : pred.call(null,p1__39084_SHARP_)));
}),xs));
});
...
var db_before = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39086__$1,new cljs.core.Keyword(null,"db-before","db-before",-553691536));
var db_after = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39086__$1,new cljs.core.Keyword(null,"db-after","db-after",-571884666));
...
return athens.db.trim_head(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(athens.db.drop_tail(h,(function (p1__39085_SHARP_){
return (p1__39085_SHARP_ === db_before);
})),db_after),(10));
}));
} else {
return null;
