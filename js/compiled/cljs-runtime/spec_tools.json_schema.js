...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.json-schema","default","spec-tools.json-schema/default",-2093938695)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__71736 = cljs.core.get_global_hierarchy;
return (fexpr__71736.cljs$core$IFn$_invoke$arity$0 ? fexpr__71736.cljs$core$IFn$_invoke$arity$0() : fexpr__71736.call(null));
})());
...
var map__71812 = spec_tools.impl.parse_keys(spec_tools.impl.extract_form(spec));
var map__71812__$1 = (((((!((map__71812 == null))))?(((((map__71812.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__71812.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__71812):map__71812);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71812__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71812__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71812__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71812__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var map__71815 = spec_tools.parse.parse_spec(form);
var map__71815__$1 = (((((!((map__71815 == null))))?(((((map__71815.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__71815.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__71815):map__71815);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71815__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__71817 = type;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__71817__$1)].join('')));
...
var vec__71820 = spec_tools.impl.strip_fn_if_needed(spec);
var ___$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71820,(0),null);
var minimum = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71820,(1),null);
var maximum = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71820,(2),null);
var ___$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71820,(3),null);
...
var vec__71823 = spec_tools.impl.extract_form(spec);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71823,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71823,(1),null);
...
var extra_info = (function (){var G__71826 = cljs.core.select_keys(data,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"description","description",-1428560544)], null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__71826,new cljs.core.Keyword(null,"title","title",636505583),spec_tools.impl.qualified_name(name));
} else {
return G__71826;
}
})();
