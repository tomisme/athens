...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__48208_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__48208_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__48208_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__48209){
var vec__48210 = p__48209;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48210,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48210,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
...
var G__48219 = (function (){var or__4185__auto__ = color;
...
var fexpr__48218 = (function (){var G__48220 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__48220) : style_map.call(null,G__48220));
})();
return (fexpr__48218.cljs$core$IFn$_invoke$arity$1 ? fexpr__48218.cljs$core$IFn$_invoke$arity$1(G__48219) : fexpr__48218.call(null,G__48219));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__48222){
var vec__48223 = p__48222;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48223,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48223,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48223,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__48226){
var vec__48227 = p__48226;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48227,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48227,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48227,(2),null);
...
var G__48297 = cljs.core.next(ssv);
var G__48298 = (this_ssv == null);
var G__48299 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__48300 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__48297;
doing_nil_QMARK_ = G__48298;
last_elide = G__48299;
out = G__48300;
continue;
}
...
var vec__48237 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48237,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48237,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48237,(2),null);
...
var G__48301 = cljs.core.next(remaining_cvec);
var G__48302 = new_idx;
var G__48303 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__48301;
idx = G__48302;
out = G__48303;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__48248,cursor_vec){
var vec__48249 = p__48248;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48249,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48249,(1),null);
var focus_vec = vec__48249;
...
var vec__48252 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48252,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48252,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__48255){
var vec__48256 = p__48255;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48256,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48256,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__48263,existing_count){
var vec__48265 = p__48263;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48265,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48265,(1),null);
...
return cljs.core.filterv((function (p1__48260_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__48260_SHARP_))));
...
var vec__48273 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48273,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48273,(1),null);
var cvec_element = vec__48273;
...
var G__48323 = cljs.core.next(cvec_nl);
var G__48324 = (idx + (1));
var G__48325 = idx;
var G__48326 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__48323;
idx = G__48324;
start = G__48325;
out = G__48326;
...
var G__48328 = cljs.core.next(cvec_nl);
var G__48329 = (idx + (1));
var G__48330 = (idx + (1));
var G__48331 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__48328;
idx = G__48329;
start = G__48330;
out = G__48331;
...
var G__48332 = cljs.core.next(cvec_nl);
var G__48333 = (idx + (1));
var G__48334 = idx;
var G__48335 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__48332;
idx = G__48333;
start = G__48334;
out = G__48335;
...
var G__48336 = cljs.core.next(cvec_nl);
var G__48337 = (idx + (1));
var G__48338 = start;
var G__48339 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__48336;
idx = G__48337;
start = G__48338;
out = G__48339;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__48278_SHARP_,p2__48277_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__48277_SHARP_)){
return cljs.core.reduced(p1__48278_SHARP_);
} else {
return (p1__48278_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__48280,p__48281){
var vec__48282 = p__48280;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48282,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48282,(1),null);
var vec__48285 = p__48281;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48285,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48285,(1),null);
