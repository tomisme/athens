...
var G__74964 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__74964)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__74964)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__74964)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__74964)].join('')));
...
var G__75021 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__75022 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__75021;
v = G__75022;
continue;
} else {
var G__75023 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__75024 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__75023;
v = G__75024;
continue;
}
...
break;
case "\"":
var G__75029 = cljs.core.next(sq);
var G__75030 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__75029;
v = G__75030;
continue;
...
break;
default:
var G__75032 = cljs.core.next(sq);
var G__75033 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__75032;
v = G__75033;
continue;
...
while(true){
var G__74978 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__74978__$1 = (((G__74978 instanceof cljs.core.Keyword))?G__74978.fqn:null);
switch (G__74978__$1) {
case "rule":
var vec__74980 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74980,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74980,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__74983 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__74983) : instaparse.cfg.content.call(null,G__74983));
...
break;
case "paren":
var G__75122 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__75122;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__74984 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__74984) : instaparse.cfg.build_rule.call(null,G__74984));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__74985 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__74985) : instaparse.cfg.build_rule.call(null,G__74985));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__74986 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__74986) : instaparse.cfg.build_rule.call(null,G__74986));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__74987 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__74987) : instaparse.cfg.build_rule.call(null,G__74987));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__74988 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__74988) : instaparse.cfg.build_rule.call(null,G__74988));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__74989 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__74989) : instaparse.cfg.build_rule.call(null,G__74989));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__74978__$1)].join('')));
...
while(true){
var G__74990 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
var G__74990__$1 = (((G__74990 instanceof cljs.core.Keyword))?G__74990.fqn:null);
switch (G__74990__$1) {
case "nt":
...
case "neg":
case "rep":
var G__75144 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__75144;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__74990__$1)].join('')));
...
var valid_nts_75145 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__74991_75146 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__74992_75147 = null;
var count__74993_75148 = (0);
var i__74994_75149 = (0);
while(true){
if((i__74994_75149 < count__74993_75148)){
var nt_75151 = chunk__74992_75147.cljs$core$IIndexed$_nth$arity$2(null,i__74994_75149);
if(cljs.core.truth_((valid_nts_75145.cljs$core$IFn$_invoke$arity$1 ? valid_nts_75145.cljs$core$IFn$_invoke$arity$1(nt_75151) : valid_nts_75145.call(null,nt_75151)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_75151),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__75154 = seq__74991_75146;
var G__75155 = chunk__74992_75147;
var G__75156 = count__74993_75148;
var G__75157 = (i__74994_75149 + (1));
seq__74991_75146 = G__75154;
chunk__74992_75147 = G__75155;
count__74993_75148 = G__75156;
i__74994_75149 = G__75157;
continue;
} else {
var temp__5735__auto___75158 = cljs.core.seq(seq__74991_75146);
if(temp__5735__auto___75158){
var seq__74991_75159__$1 = temp__5735__auto___75158;
if(cljs.core.chunked_seq_QMARK_(seq__74991_75159__$1)){
var c__4609__auto___75160 = cljs.core.chunk_first(seq__74991_75159__$1);
var G__75161 = cljs.core.chunk_rest(seq__74991_75159__$1);
var G__75162 = c__4609__auto___75160;
var G__75163 = cljs.core.count(c__4609__auto___75160);
var G__75164 = (0);
seq__74991_75146 = G__75161;
chunk__74992_75147 = G__75162;
count__74993_75148 = G__75163;
i__74994_75149 = G__75164;
continue;
} else {
var nt_75165 = cljs.core.first(seq__74991_75159__$1);
if(cljs.core.truth_((valid_nts_75145.cljs$core$IFn$_invoke$arity$1 ? valid_nts_75145.cljs$core$IFn$_invoke$arity$1(nt_75165) : valid_nts_75145.call(null,nt_75165)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_75165),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__75167 = cljs.core.next(seq__74991_75159__$1);
var G__75168 = null;
var G__75169 = (0);
var G__75170 = (0);
seq__74991_75146 = G__75167;
chunk__74992_75147 = G__75168;
count__74993_75148 = G__75169;
i__74994_75149 = G__75170;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__74995_75171 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__74996_75172 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__74997_75173 = true;
var _STAR_print_fn_STAR__temp_val__74998_75174 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__74997_75173);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__74998_75174);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__74996_75172);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__74995_75171);
}
...
var len__4789__auto___75178 = arguments.length;
var i__4790__auto___75179 = (0);
while(true){
if((i__4790__auto___75179 < len__4789__auto___75178)){
args__4795__auto__.push((arguments[i__4790__auto___75179]));

var G__75180 = (i__4790__auto___75179 + (1));
i__4790__auto___75179 = G__75180;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__75002){
var map__75003 = p__75002;
var map__75003__$1 = (((((!((map__75003 == null))))?(((((map__75003.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__75003.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__75003):map__75003);
var opts = map__75003__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__75005 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__75006 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__75006);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__75007_75181 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__75008_75182 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__75009_75183 = true;
var _STAR_print_fn_STAR__temp_val__75010_75184 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__75009_75183);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__75010_75184);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__75008_75182);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__75007_75181);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__75005);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq75000){
var G__75001 = cljs.core.first(seq75000);
var seq75000__$1 = cljs.core.next(seq75000);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__75001,seq75000__$1);
}));
