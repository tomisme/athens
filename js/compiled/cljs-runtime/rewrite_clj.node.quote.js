...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k48925,else__4442__auto__){
var self__ = this;
var this__4441__auto____$1 = this;
var G__48932 = k48925;
var G__48932__$1 = (((G__48932 instanceof cljs.core.Keyword))?G__48932.fqn:null);
switch (G__48932__$1) {
case "tag":
return self__.tag;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k48925,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__48933){
var vec__48934 = p__48933;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48934,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48934,(1),null);
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__48924){
var self__ = this;
var G__48924__$1 = this;
return (new cljs.core.RecordIter((0),G__48924__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this48926,other48927){
var self__ = this;
var this48926__$1 = this;
return (((!((other48927 == null)))) && ((this48926__$1.constructor === other48927.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48926__$1.tag,other48927.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48926__$1.prefix,other48927.prefix)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48926__$1.sym,other48927.sym)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48926__$1.children,other48927.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48926__$1.__extmap,other48927.__extmap)));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__48924){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__48960 = cljs.core.keyword_identical_QMARK_;
var expr__48961 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__48963 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
var G__48964 = expr__48961;
return (pred__48960.cljs$core$IFn$_invoke$arity$2 ? pred__48960.cljs$core$IFn$_invoke$arity$2(G__48963,G__48964) : pred__48960.call(null,G__48963,G__48964));
})())){
return (new rewrite_clj.node.quote.QuoteNode(G__48924,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__48965 = new cljs.core.Keyword(null,"prefix","prefix",-265908465);
var G__48966 = expr__48961;
return (pred__48960.cljs$core$IFn$_invoke$arity$2 ? pred__48960.cljs$core$IFn$_invoke$arity$2(G__48965,G__48966) : pred__48960.call(null,G__48965,G__48966));
})())){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__48924,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__48967 = new cljs.core.Keyword(null,"sym","sym",-1444860305);
var G__48968 = expr__48961;
return (pred__48960.cljs$core$IFn$_invoke$arity$2 ? pred__48960.cljs$core$IFn$_invoke$arity$2(G__48967,G__48968) : pred__48960.call(null,G__48967,G__48968));
})())){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__48924,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__48969 = new cljs.core.Keyword(null,"children","children",-940561982);
var G__48970 = expr__48961;
return (pred__48960.cljs$core$IFn$_invoke$arity$2 ? pred__48960.cljs$core$IFn$_invoke$arity$2(G__48969,G__48970) : pred__48960.call(null,G__48969,G__48970));
})())){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__48924,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__48924),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__48924){
var self__ = this;
var this__4438__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__48924,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__48928){
var extmap__4478__auto__ = (function (){var G__48976 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__48928,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__48928)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__48976);
} else {
return G__48976;
}
})();
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__48928),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__48928),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__48928),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__48928),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var G__48992 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__48992;
continue;
}
break;
...
var G__48993 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__48993;
continue;
}
break;
...
var G__48994 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__48994;
continue;
}
break;
...
var G__48995 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__48995;
continue;
}
break;
