...
if(cljs.core.truth_(((cljs.core.not(hidden_QMARK_))?(function (){var G__73788 = (function (){var G__73789 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
return (parser.cljs$core$IFn$_invoke$arity$1 ? parser.cljs$core$IFn$_invoke$arity$1(G__73789) : parser.call(null,G__73789));
})();
return (tag_set.cljs$core$IFn$_invoke$arity$1 ? tag_set.cljs$core$IFn$_invoke$arity$1(G__73788) : tag_set.call(null,G__73788));
})():false))){
...
instaparse.print.char_range__GT_str = (function instaparse$print$char_range__GT_str(p__73791){
var map__73792 = p__73791;
var map__73792__$1 = (((((!((map__73792 == null))))?(((((map__73792.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__73792.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__73792):map__73792);
var lo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73792__$1,new cljs.core.Keyword(null,"lo","lo",-931799889));
var hi = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73792__$1,new cljs.core.Keyword(null,"hi","hi",-1821422114));
...
(instaparse.print.combinators__GT_str.cljs$core$IFn$_invoke$arity$2 = (function (p__73796,hidden_QMARK_){
var map__73797 = p__73796;
var map__73797__$1 = (((((!((map__73797 == null))))?(((((map__73797.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__73797.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__73797):map__73797);
var p = map__73797__$1;
var parser = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73797__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310));
var parser1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73797__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422));
var parser2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73797__$1,new cljs.core.Keyword(null,"parser2","parser2",1013754688));
var parsers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73797__$1,new cljs.core.Keyword(null,"parsers","parsers",-804353827));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73797__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
...
var G__73802 = tag;
var G__73802__$1 = (((G__73802 instanceof cljs.core.Keyword))?G__73802.fqn:null);
switch (G__73802__$1) {
case "epsilon":
return "\u03B5";
...
var _STAR_print_newline_STAR__orig_val__73803_73829 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__73804_73830 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__73805_73831 = true;
var _STAR_print_fn_STAR__temp_val__73806_73832 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__73805_73831);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__73806_73832);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__73804_73830);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__73803_73829);
}
...
case "string-ci":
var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__73807_73833 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__73808_73834 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__73809_73835 = true;
var _STAR_print_fn_STAR__temp_val__73810_73836 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__73809_73835);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__73810_73836);

try{cljs.core.pr.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string","string",-1989541586).cljs$core$IFn$_invoke$arity$1(p)], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__73808_73834);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__73807_73833);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__73802__$1)].join('')));
 ...
 */
instaparse.print.Parser__GT_str = (function instaparse$print$Parser__GT_str(p__73811){
var map__73812 = p__73811;
var map__73812__$1 = (((((!((map__73812 == null))))?(((((map__73812.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__73812.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__73812):map__73812);
var grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73812__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73812__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.cons(instaparse.print.rule__GT_str(start,(grammar.cljs$core$IFn$_invoke$arity$1 ? grammar.cljs$core$IFn$_invoke$arity$1(start) : grammar.call(null,start))),(function (){var iter__4582__auto__ = (function instaparse$print$Parser__GT_str_$_iter__73814(s__73815){
return (new cljs.core.LazySeq(null,(function (){
var s__73815__$1 = s__73815;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__73815__$1);
if(temp__5735__auto__){
var s__73815__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__73815__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__73815__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__73817 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__73816 = (0);
while(true){
if((i__73816 < size__4581__auto__)){
var vec__73818 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__73816);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73818,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73818,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
cljs.core.chunk_append(b__73817,instaparse.print.rule__GT_str(non_terminal,parser));

var G__73837 = (i__73816 + (1));
i__73816 = G__73837;
continue;
} else {
var G__73838 = (i__73816 + (1));
i__73816 = G__73838;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__73817),instaparse$print$Parser__GT_str_$_iter__73814(cljs.core.chunk_rest(s__73815__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__73817),null);
}
} else {
var vec__73821 = cljs.core.first(s__73815__$2);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73821,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73821,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
return cljs.core.cons(instaparse.print.rule__GT_str(non_terminal,parser),instaparse$print$Parser__GT_str_$_iter__73814(cljs.core.rest(s__73815__$2)));
} else {
var G__73840 = cljs.core.rest(s__73815__$2);
s__73815__$1 = G__73840;
continue;
}
}
} else {
