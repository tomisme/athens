...
return [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(string,(0),(function (){var G__50707 = per_side_budget;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50704__$1)].join('')));
...
var G__50778 = clojure.string.replace(s,match,trunc_prefix);
var G__50779 = limit;
var G__50780 = match;
var G__50781 = trunc_prefix;
s = G__50778;
limit = G__50779;
match = G__50780;
trunc_prefix = G__50781;
continue;
}
}
break;
...
var prefix = (function (){var G__50712 = ((kw_QMARK_)?":":"");
if(cljs.core.truth_(the_ns)){
return [G__50712,"\u2026/"].join('');
} else {
return G__50712;
}
})();
...
var vec__50714 = day8.re_frame_10x.utils.pretty_print_condensed.edges(coll);
var left = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50714,(0),null);
var right = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50714,(1),null);
...
var or__4185__auto__ = (function (){var G__50723 = form.name;
if((G__50723 == null)){
return null;
} else {
return clojure.string.replace(G__50723,/(^.*\$)(.*)/,"$2");
}
})();
...
var G__50725 = obj;
var G__50726 = writer;
var G__50727 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(opts,new cljs.core.Keyword(null,"fallback-impl","fallback-impl",-1501286995),day8.re_frame_10x.utils.pretty_print_condensed.pr_writer_impl);
return (alt_impl.cljs$core$IFn$_invoke$arity$3 ? alt_impl.cljs$core$IFn$_invoke$arity$3(G__50725,G__50726,G__50727) : alt_impl.call(null,G__50725,G__50726,G__50727));
} else {
...
var seq__50728 = cljs.core.seq(cljs.core.next(objs));
var chunk__50729 = null;
var count__50730 = (0);
var i__50731 = (0);
while(true){
if((i__50731 < count__50730)){
var obj = chunk__50729.cljs$core$IIndexed$_nth$arity$2(null,i__50731);
cljs.core._write(writer," ");

day8.re_frame_10x.utils.pretty_print_condensed.pr_writer(obj,writer,opts);


var G__50797 = seq__50728;
var G__50798 = chunk__50729;
var G__50799 = count__50730;
var G__50800 = (i__50731 + (1));
seq__50728 = G__50797;
chunk__50729 = G__50798;
count__50730 = G__50799;
i__50731 = G__50800;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__50728);
if(temp__5735__auto__){
var seq__50728__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__50728__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__50728__$1);
var G__50801 = cljs.core.chunk_rest(seq__50728__$1);
var G__50802 = c__4609__auto__;
var G__50803 = cljs.core.count(c__4609__auto__);
var G__50804 = (0);
seq__50728 = G__50801;
chunk__50729 = G__50802;
count__50730 = G__50803;
i__50731 = G__50804;
continue;
} else {
var obj = cljs.core.first(seq__50728__$1);
cljs.core._write(writer," ");

day8.re_frame_10x.utils.pretty_print_condensed.pr_writer(obj,writer,opts);


var G__50805 = cljs.core.next(seq__50728__$1);
var G__50806 = null;
var G__50807 = (0);
var G__50808 = (0);
seq__50728 = G__50805;
chunk__50729 = G__50806;
count__50730 = G__50807;
i__50731 = G__50808;
continue;
}
} else {
...
var len__4789__auto___50819 = arguments.length;
var i__4790__auto___50820 = (0);
while(true){
if((i__4790__auto___50820 < len__4789__auto___50819)){
args__4795__auto__.push((arguments[i__4790__auto___50820]));

var G__50821 = (i__4790__auto___50820 + (1));
i__4790__auto___50820 = G__50821;
continue;
} else {
}
break;
...
/** @this {Function} */
(day8.re_frame_10x.utils.pretty_print_condensed.pr_str_truncated.cljs$lang$applyTo = (function (seq50754){
var G__50755 = cljs.core.first(seq50754);
var seq50754__$1 = cljs.core.next(seq50754);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50755,seq50754__$1);
}));
