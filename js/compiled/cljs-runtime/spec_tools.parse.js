...
var fexpr__70657 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__70657.cljs$core$IFn$_invoke$arity$1 ? fexpr__70657.cljs$core$IFn$_invoke$arity$1(type) : fexpr__70657.call(null,type));
});
...
var G__70685 = cljs.spec.alpha.form(cljs.spec.alpha.get_spec(x));
x = G__70685;
continue;
} else {
if((x instanceof cljs.core.Symbol)){
var G__70658 = spec_tools.impl.normalize_symbol(x);
var G__70659 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__70658,G__70659) : spec_tools.parse.parse_form.call(null,G__70658,G__70659));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__70660 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__70661 = x;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__70660,G__70661) : spec_tools.parse.parse_form.call(null,G__70660,G__70661));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__70686 = cljs.spec.alpha.form(x);
x = G__70686;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__70662 = (spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1 ? spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x) : spec_tools.form.resolve_form.call(null,x));
var G__70663 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__70662,G__70663) : spec_tools.parse.parse_form.call(null,G__70662,G__70663));
} else {
...
var G__70664 = parse_data;
var G__70664__$1 = (((G__70664 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__70664));
var G__70664__$2 = (((G__70664__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__70664__$1));
var G__70664__$3 = (((G__70664__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__70664__$2));
var G__70664__$4 = (((G__70664__$3 == null))?null:cljs.core.seq(G__70664__$3));
if((G__70664__$4 == null)){
return null;
} else {
return cljs.core.set(G__70664__$4);
}
}
});
...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__70666 = cljs.core.get_global_hierarchy;
return (fexpr__70666.cljs$core$IFn$_invoke$arity$0 ? fexpr__70666.cljs$core$IFn$_invoke$arity$0() : fexpr__70666.call(null));
})());
...
var map__70670 = spec_tools.impl.parse_keys(form);
var map__70670__$1 = (((((!((map__70670 == null))))?(((((map__70670.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__70670.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__70670):map__70670);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70670__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70670__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70670__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70670__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70670__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__70672 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__70672__$1 = (cljs.core.truth_((function (){var or__4185__auto__ = req;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__70672,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__70672);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__70672__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__70672__$1;
}
}));
...
var map__70673 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__70673__$1 = (((((!((map__70673 == null))))?(((((map__70673.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__70673.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__70673):map__70673);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70673__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__70675 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
...
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70675__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__70677){
var vec__70678 = p__70677;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70678,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70678,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70678,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__70681){
var vec__70682 = p__70681;
var seq__70683 = cljs.core.seq(vec__70682);
var first__70684 = cljs.core.first(seq__70683);
var seq__70683__$1 = cljs.core.next(seq__70683);
var ___$1 = first__70684;
var values = seq__70683__$1;
