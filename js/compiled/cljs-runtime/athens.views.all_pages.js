...
var c__4580__auto__ = cljs.core.chunk_first(s__52802__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__52804 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__52803 = (0);
while(true){
if((i__52803 < size__4581__auto__)){
var map__52806 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__52803);
...
cljs.core.chunk_append(b__52804,cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$3(athens.views.all_pages.table_style,new cljs.core.Keyword(null,"td-title","td-title",-2048420439),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__52803,map__52806,map__52806__$1,uid,title,modified,created,children,c__4580__auto__,size__4581__auto__,b__52804,s__52802__$2,temp__5735__auto__,page_eids,pages){
return (function (p1__52792_SHARP_){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$2(uid,p1__52792_SHARP_);
});})(i__52803,map__52806,map__52806__$1,uid,title,modified,created,children,c__4580__auto__,size__4581__auto__,b__52804,s__52802__$2,temp__5735__auto__,page_eids,pages))
], null)),title], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$2(athens.views.all_pages.table_style,new cljs.core.Keyword(null,"body-preview","body-preview",-543779304)),clojure.string.join.cljs$core$IFn$_invoke$arity$1(" "),cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (i__52803,map__52806,map__52806__$1,uid,title,modified,created,children,c__4580__auto__,size__4581__auto__,b__52804,s__52802__$2,temp__5735__auto__,page_eids,pages){
return (function (p1__52793_SHARP_){
return ["\u2022 ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(p1__52793_SHARP_))].join('');
});})(i__52803,map__52806,map__52806__$1,uid,title,modified,created,children,c__4580__auto__,size__4581__auto__,b__52804,s__52802__$2,temp__5735__auto__,page_eids,pages))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__52804),athens$views$all_pages$table_$_iter__52801(cljs.core.chunk_rest(s__52802__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__52804),null);
}
} else {
var map__52808 = cljs.core.first(s__52802__$2);
...
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52808__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52808__$1,new cljs.core.Keyword("node","title","node/title",628940777));
var modified = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52808__$1,new cljs.core.Keyword("edit","time","edit/time",1384867476));
var created = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52808__$1,new cljs.core.Keyword("create","time","create/time",-1563077754));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52808__$1,new cljs.core.Keyword("block","children","block/children",-1040716209));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$3(athens.views.all_pages.table_style,new cljs.core.Keyword(null,"td-title","td-title",-2048420439),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__52808,map__52808__$1,uid,title,modified,created,children,s__52802__$2,temp__5735__auto__,page_eids,pages){
return (function (p1__52792_SHARP_){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$2(uid,p1__52792_SHARP_);
});})(map__52808,map__52808__$1,uid,title,modified,created,children,s__52802__$2,temp__5735__auto__,page_eids,pages))
], null)),title], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$2(athens.views.all_pages.table_style,new cljs.core.Keyword(null,"body-preview","body-preview",-543779304)),clojure.string.join.cljs$core$IFn$_invoke$arity$1(" "),cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (map__52808,map__52808__$1,uid,title,modified,created,children,s__52802__$2,temp__5735__auto__,page_eids,pages){
return (function (p1__52793_SHARP_){
return ["\u2022 ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(p1__52793_SHARP_))].join('');
});})(map__52808,map__52808__$1,uid,title,modified,created,children,s__52802__$2,temp__5735__auto__,page_eids,pages))
,children)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$2(athens.views.all_pages.table_style,new cljs.core.Keyword(null,"td-date","td-date",-1089366042)),athens.views.all_pages.date_string(modified)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$2(athens.views.all_pages.table_style,new cljs.core.Keyword(null,"td-date","td-date",-1089366042)),athens.views.all_pages.date_string(created)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)),athens$views$all_pages$table_$_iter__52801(cljs.core.rest(s__52802__$2)));
}
} else {
return null;
}
