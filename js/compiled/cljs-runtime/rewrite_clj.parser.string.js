...
if((c === "\n")){
var G__49814 = escape_QMARK_;
var G__49815 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__49814;
lines = G__49815;
continue;
} else {
buf.append(c);

var G__49816 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__49817 = lines;
escape_QMARK_ = G__49816;
lines = G__49817;
continue;
...
var G__49810 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__49810) : rewrite_clj.node.string_node.call(null,G__49810));
});
...
var G__49812 = cljs.core.re_pattern(regex);
var G__49813 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__49812,G__49813) : rewrite_clj.node.token_node.call(null,G__49812,G__49813));
});
