...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__50008,k,f){
var vec__50009 = p__50008;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50009,(0),null);
...
var G__50042 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__50042;
continue;
}
break;
...
var G__50043 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__50043;
continue;
} else {
return zloc__$1;
...
var G__50044 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__50044;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__50017){
var vec__50018 = p__50017;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50018,(0),null);
var map__50021 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50018,(1),null);
...
var path = map__50021__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50021__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__50018;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__50026){
var vec__50027 = p__50026;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50027,(0),null);
var map__50030 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50027,(1),null);
...
var path = map__50030__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50030__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__50027;
if(cljs.core.seq(r)){
...
var vec__50036 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50036,(0),null);
var map__50039 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50036,(1),null);
...
var path = map__50039__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50039__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50039__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50039__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50039__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
