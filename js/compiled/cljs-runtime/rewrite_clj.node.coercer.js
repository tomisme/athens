...
var G__49689_49725 = rewrite_clj.node.protocols.coerce;
var G__49690_49726 = "object";
var G__49691_49727 = (function (v){
return rewrite_clj.node.coercer.node_with_meta(rewrite_clj.node.token.token_node.cljs$core$IFn$_invoke$arity$1(v),v);
});
goog.object.set(G__49689_49725,G__49690_49726,G__49691_49727);
goog.object.set(rewrite_clj.node.protocols.NodeCoerceable,"number",true);

var G__49696_49729 = rewrite_clj.node.protocols.coerce;
var G__49697_49730 = "number";
var G__49698_49731 = (function (n){
return rewrite_clj.node.coercer.node_with_meta(rewrite_clj.node.token.token_node.cljs$core$IFn$_invoke$arity$1(n),n);
});
goog.object.set(G__49696_49729,G__49697_49730,G__49698_49731);
goog.object.set(rewrite_clj.node.protocols.NodeCoerceable,"string",true);

var G__49703_49733 = rewrite_clj.node.protocols.coerce;
var G__49704_49734 = "string";
var G__49705_49735 = (function (n){
return rewrite_clj.node.coercer.node_with_meta(rewrite_clj.node.stringz.string_node(n),n);
});
goog.object.set(G__49703_49733,G__49704_49734,G__49705_49735);
rewrite_clj.node.coercer.seq_node = (function rewrite_clj$node$coercer$seq_node(f,sq){
return rewrite_clj.node.coercer.node_with_meta((function (){var G__49709 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__49709) : f.call(null,G__49709));
})(),sq);
});
...
var comma_49738 = rewrite_clj.node.whitespace.whitespace_node(", ");
var space_49739 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.butlast(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__49710){
var vec__49711 = p__49710;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49711,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49711,(1),null);
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [rewrite_clj.node.protocols.coerce(k),space_49739,rewrite_clj.node.protocols.coerce(v),comma_49738], null);
