...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__43390_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__43390_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43389_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__43389_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__43391_SHARP_){
return (((p1__43391_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__43391_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__43400,mapping){
...
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43401__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43401__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43401__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__43398_SHARP_){
if((p1__43398_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__43398_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__43449 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__43450 = clojure.zip.next(loc);
loc = G__43450;
continue;
}
}
...
var len__4789__auto___43453 = arguments.length;
var i__4790__auto___43454 = (0);
while(true){
if((i__4790__auto___43454 < len__4789__auto___43453)){
args__4795__auto__.push((arguments[i__4790__auto___43454]));

var G__43455 = (i__4790__auto___43454 + (1));
i__4790__auto___43454 = G__43455;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__43407){
var vec__43408 = p__43407;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43408,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq43405){
var G__43406 = cljs.core.first(seq43405);
var seq43405__$1 = cljs.core.next(seq43405);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43406,seq43405__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__43411_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__43411_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__43413_43459 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__43414_43460 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__43415_43461 = true;
var _STAR_print_fn_STAR__temp_val__43416_43462 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__43415_43461);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__43416_43462);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__43414_43460);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__43413_43459);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__43412_SHARP_){
return debux.common.util.prepend_bars(p1__43412_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__43463 = cljs.core.next(opts__$1);
var G__43464 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__43463;
acc = G__43464;
continue;
} else {
if(typeof f === 'string'){
var G__43465 = cljs.core.next(opts__$1);
var G__43466 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__43465;
acc = G__43466;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__43467 = cljs.core.nnext(opts__$1);
var G__43468 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__43467;
acc = G__43468;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__43469 = cljs.core.next(opts__$1);
var G__43470 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__43469;
acc = G__43470;
continue;
} else {
...
var G__43471 = cljs.core.next(opts__$1);
var G__43472 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__43471;
acc = G__43472;
continue;
} else {
...
var G__43473 = cljs.core.nnext(opts__$1);
var G__43474 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__43473;
acc = G__43474;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__43475 = cljs.core.next(opts__$1);
var G__43476 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__43475;
acc = G__43476;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__43424){
var vec__43426 = p__43424;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43426,(0),null);
...
var G__43433 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__43432 = (function (){var fexpr__43434 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__43434.cljs$core$IFn$_invoke$arity$1 ? fexpr__43434.cljs$core$IFn$_invoke$arity$1(form) : fexpr__43434.call(null,form));
})();
return (fexpr__43432.cljs$core$IFn$_invoke$arity$1 ? fexpr__43432.cljs$core$IFn$_invoke$arity$1(G__43433) : fexpr__43432.call(null,G__43433));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__43439 = quoted_form;
var G__43440 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__43439,G__43440) : debux.common.util.remove_d.call(null,G__43439,G__43440));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__43441 = quoted_form;
var G__43442 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__43441,G__43442) : debux.common.util.remove_d.call(null,G__43441,G__43442));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__43443 = quoted_form;
var G__43444 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__43443,G__43444) : debux.common.util.remove_d.call(null,G__43443,G__43444));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
