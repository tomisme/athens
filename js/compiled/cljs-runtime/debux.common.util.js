...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__69281_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__69281_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__69280_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__69280_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__69282_SHARP_){
return (((p1__69282_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__69282_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__69302,mapping){
...
var state = map__69303__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69303__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69303__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69303__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__69300_SHARP_){
if((p1__69300_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__69300_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__69384 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__69385 = clojure.zip.next(loc);
loc = G__69385;
continue;
}
}
...
var len__4789__auto___69388 = arguments.length;
var i__4790__auto___69389 = (0);
while(true){
if((i__4790__auto___69389 < len__4789__auto___69388)){
args__4795__auto__.push((arguments[i__4790__auto___69389]));

var G__69390 = (i__4790__auto___69389 + (1));
i__4790__auto___69389 = G__69390;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__69322){
var vec__69323 = p__69322;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69323,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq69320){
var G__69321 = cljs.core.first(seq69320);
var seq69320__$1 = cljs.core.next(seq69320);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__69321,seq69320__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__69326_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__69326_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__69329_69391 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__69330_69392 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__69331_69393 = true;
var _STAR_print_fn_STAR__temp_val__69332_69394 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__69331_69393);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__69332_69394);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__69330_69392);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__69329_69391);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__69328_SHARP_){
return debux.common.util.prepend_bars(p1__69328_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__69395 = cljs.core.next(opts__$1);
var G__69396 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__69395;
acc = G__69396;
continue;
} else {
if(typeof f === 'string'){
var G__69397 = cljs.core.next(opts__$1);
var G__69398 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__69397;
acc = G__69398;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__69399 = cljs.core.nnext(opts__$1);
var G__69400 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__69399;
acc = G__69400;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__69401 = cljs.core.next(opts__$1);
var G__69402 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__69401;
acc = G__69402;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__69336 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__69336.cljs$core$IFn$_invoke$arity$1 ? fexpr__69336.cljs$core$IFn$_invoke$arity$1(f) : fexpr__69336.call(null,f));
})())){
var G__69403 = cljs.core.next(opts__$1);
var G__69404 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__69403;
acc = G__69404;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__69337 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__69337.cljs$core$IFn$_invoke$arity$1 ? fexpr__69337.cljs$core$IFn$_invoke$arity$1(f) : fexpr__69337.call(null,f));
})())){
var G__69405 = cljs.core.nnext(opts__$1);
var G__69406 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__69405;
acc = G__69406;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__69407 = cljs.core.next(opts__$1);
var G__69408 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__69407;
acc = G__69408;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__69338){
var vec__69339 = p__69338;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69339,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69339,(1),null);
...
var G__69353 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__69352 = (function (){var fexpr__69354 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__69354.cljs$core$IFn$_invoke$arity$1 ? fexpr__69354.cljs$core$IFn$_invoke$arity$1(form) : fexpr__69354.call(null,form));
})();
return (fexpr__69352.cljs$core$IFn$_invoke$arity$1 ? fexpr__69352.cljs$core$IFn$_invoke$arity$1(G__69353) : fexpr__69352.call(null,G__69353));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__69356 = quoted_form;
var G__69357 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__69356,G__69357) : debux.common.util.remove_d.call(null,G__69356,G__69357));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__69374 = quoted_form;
var G__69375 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__69374,G__69375) : debux.common.util.remove_d.call(null,G__69374,G__69375));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__69411__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__69376 = quoted_form;
var G__69377 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__69376,G__69377) : debux.common.util.remove_d.call(null,G__69376,G__69377));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__69411 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__69414__i = 0, G__69414__a = new Array(arguments.length -  0);
while (G__69414__i < G__69414__a.length) {G__69414__a[G__69414__i] = arguments[G__69414__i + 0]; ++G__69414__i;}
  arg = new cljs.core.IndexedSeq(G__69414__a,0,null);
} 
return G__69411__delegate.call(this,arg);};
G__69411.cljs$lang$maxFixedArity = 0;
G__69411.cljs$lang$applyTo = (function (arglist__69415){
var arg = cljs.core.seq(arglist__69415);
return G__69411__delegate(arg);
});
G__69411.cljs$core$IFn$_invoke$arity$variadic = G__69411__delegate;
return G__69411;
})()
;
});
...
var G__69417 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__69417;
continue;
} else {
...
var G__69419 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__69419;
continue;
} else {
var G__69420 = clojure.zip.next(loc);
loc = G__69420;
continue;
