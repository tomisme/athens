...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__43386_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__43386_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43385_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__43385_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__43387_SHARP_){
return (((p1__43387_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__43387_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__43391,mapping){
...
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43392__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43392__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43392__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__43389_SHARP_){
if((p1__43389_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__43389_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__43446 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__43447 = clojure.zip.next(loc);
loc = G__43447;
continue;
}
}
...
var len__4789__auto___43450 = arguments.length;
var i__4790__auto___43452 = (0);
while(true){
if((i__4790__auto___43452 < len__4789__auto___43450)){
args__4795__auto__.push((arguments[i__4790__auto___43452]));

var G__43454 = (i__4790__auto___43452 + (1));
i__4790__auto___43452 = G__43454;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__43406){
var vec__43407 = p__43406;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43407,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq43404){
var G__43405 = cljs.core.first(seq43404);
var seq43404__$1 = cljs.core.next(seq43404);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43405,seq43404__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__43410_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__43410_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__43412_43456 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__43413_43457 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__43414_43458 = true;
var _STAR_print_fn_STAR__temp_val__43415_43459 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__43414_43458);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__43415_43459);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__43413_43457);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__43412_43456);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__43411_SHARP_){
return debux.common.util.prepend_bars(p1__43411_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__43460 = cljs.core.next(opts__$1);
var G__43461 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__43460;
acc = G__43461;
continue;
} else {
if(typeof f === 'string'){
var G__43462 = cljs.core.next(opts__$1);
var G__43463 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__43462;
acc = G__43463;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__43464 = cljs.core.nnext(opts__$1);
var G__43465 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__43464;
acc = G__43465;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__43466 = cljs.core.next(opts__$1);
var G__43467 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__43466;
acc = G__43467;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__43419 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__43419.cljs$core$IFn$_invoke$arity$1 ? fexpr__43419.cljs$core$IFn$_invoke$arity$1(f) : fexpr__43419.call(null,f));
})())){
var G__43468 = cljs.core.next(opts__$1);
var G__43469 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__43468;
acc = G__43469;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__43420 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__43420.cljs$core$IFn$_invoke$arity$1 ? fexpr__43420.cljs$core$IFn$_invoke$arity$1(f) : fexpr__43420.call(null,f));
})())){
var G__43470 = cljs.core.nnext(opts__$1);
var G__43471 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__43470;
acc = G__43471;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__43472 = cljs.core.next(opts__$1);
var G__43473 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__43472;
acc = G__43473;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__43421){
...
var G__43427 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__43426 = (function (){var fexpr__43428 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__43428.cljs$core$IFn$_invoke$arity$1 ? fexpr__43428.cljs$core$IFn$_invoke$arity$1(form) : fexpr__43428.call(null,form));
})();
return (fexpr__43426.cljs$core$IFn$_invoke$arity$1 ? fexpr__43426.cljs$core$IFn$_invoke$arity$1(G__43427) : fexpr__43426.call(null,G__43427));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__43430 = quoted_form;
var G__43431 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__43430,G__43431) : debux.common.util.remove_d.call(null,G__43430,G__43431));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__43432 = quoted_form;
var G__43433 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__43432,G__43433) : debux.common.util.remove_d.call(null,G__43432,G__43433));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__43477__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__43434 = quoted_form;
var G__43435 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__43434,G__43435) : debux.common.util.remove_d.call(null,G__43434,G__43435));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__43478__i < G__43478__a.length) {G__43478__a[G__43478__i] = arguments[G__43478__i + 0]; ++G__43478__i;}
  arg = new cljs.core.IndexedSeq(G__43478__a,0,null);
} 
return G__43477__delegate.call(this,arg);};
G__43477.cljs$lang$maxFixedArity = 0;
G__43477.cljs$lang$applyTo = (function (arglist__43479){
var arg = cljs.core.seq(arglist__43479);
return G__43477__delegate(arg);
});
...
var G__43480 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__43480;
continue;
} else {
...
var G__43481 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__43481;
continue;
} else {
var G__43482 = clojure.zip.next(loc);
loc = G__43482;
continue;
