...
var G__43976 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__43976;
continue;
} else {
return ch;
...
var vec__43958 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43958,(0),null);
return (match === s);
});
...
var len__4789__auto___43982 = arguments.length;
var i__4790__auto___43983 = (0);
while(true){
if((i__4790__auto___43983 < len__4789__auto___43982)){
args__4795__auto__.push((arguments[i__4790__auto___43983]));

var G__43985 = (i__4790__auto___43983 + (1));
i__4790__auto___43983 = G__43985;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq43964){
var G__43965 = cljs.core.first(seq43964);
var seq43964__$1 = cljs.core.next(seq43964);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43965,seq43964__$1);
}));
