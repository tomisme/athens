...
var len__4789__auto___56005 = arguments.length;
var i__4790__auto___56006 = (0);
while(true){
if((i__4790__auto___56006 < len__4789__auto___56005)){
args__4795__auto__.push((arguments[i__4790__auto___56006]));

var G__56007 = (i__4790__auto___56006 + (1));
i__4790__auto___56006 = G__56007;
continue;
} else {
}
break;
...
/** @this {Function} */
(instaparse.combinators_source.alt.cljs$lang$applyTo = (function (seq55948){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq55948));
}));
...
var G__56013 = (i__4790__auto___56010 + (1));
i__4790__auto___56010 = G__56013;
continue;
} else {
}
break;
...
/** @this {Function} */
(instaparse.combinators_source.ord.cljs$lang$applyTo = (function (seq55950){
var G__55951 = cljs.core.first(seq55950);
var seq55950__$1 = cljs.core.next(seq55950);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55951,seq55950__$1);
}));
...
/** @this {Function} */
(instaparse.combinators_source.cat.cljs$lang$applyTo = (function (seq55953){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq55953));
}));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(parser__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310),(function (){var G__55956 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser__$1);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(parser__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422),(function (){var G__55957 = new cljs.core.Keyword(null,"parser1","parser1",-439601422).cljs$core$IFn$_invoke$arity$1(parser__$1);
...
})(),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"parser2","parser2",1013754688),(function (){var G__55958 = new cljs.core.Keyword(null,"parser2","parser2",1013754688).cljs$core$IFn$_invoke$arity$1(parser__$1);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$unhide_all_content_$_iter__55959(s__55960){
return (new cljs.core.LazySeq(null,(function (){
var s__55960__$1 = s__55960;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__55960__$1);
if(temp__5735__auto__){
var s__55960__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__55960__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__55960__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__55962 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__55961 = (0);
while(true){
if((i__55961 < size__4581__auto__)){
var vec__55963 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__55961);
...
cljs.core.chunk_append(b__55962,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,instaparse.combinators_source.unhide_content(v)], null));

var G__56046 = (i__55961 + (1));
i__55961 = G__56046;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55962),instaparse$combinators_source$unhide_all_content_$_iter__55959(cljs.core.chunk_rest(s__55960__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55962),null);
}
} else {
var vec__55966 = cljs.core.first(s__55960__$2);
...
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,instaparse.combinators_source.unhide_content(v)], null),instaparse$combinators_source$unhide_all_content_$_iter__55959(cljs.core.rest(s__55960__$2)));
}
} else {
return null;
}
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$unhide_tags_$_iter__55969(s__55970){
return (new cljs.core.LazySeq(null,(function (){
var s__55970__$1 = s__55970;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__55970__$1);
if(temp__5735__auto__){
var s__55970__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__55970__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__55970__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__55972 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__55971 = (0);
while(true){
if((i__55971 < size__4581__auto__)){
var vec__55973 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__55971);
...
cljs.core.chunk_append(b__55972,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null));

var G__56072 = (i__55971 + (1));
i__55971 = G__56072;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55972),instaparse$combinators_source$unhide_tags_$_iter__55969(cljs.core.chunk_rest(s__55970__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55972),null);
}
} else {
var vec__55976 = cljs.core.first(s__55970__$2);
...
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null),instaparse$combinators_source$unhide_tags_$_iter__55969(cljs.core.rest(s__55970__$2)));
}
} else {
return null;
}
...
if(cljs.core.truth_(temp__5733__auto__)){
var reduction = temp__5733__auto__;
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$unhide_all_$_iter__55979(s__55980){
return (new cljs.core.LazySeq(null,(function (){
var s__55980__$1 = s__55980;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__55980__$1);
if(temp__5735__auto__){
var s__55980__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__55980__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__55980__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__55982 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__55981 = (0);
while(true){
if((i__55981 < size__4581__auto__)){
var vec__55983 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__55981);
...
cljs.core.chunk_append(b__55982,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(instaparse.combinators_source.unhide_content(v),new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null));

var G__56082 = (i__55981 + (1));
i__55981 = G__56082;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55982),instaparse$combinators_source$unhide_all_$_iter__55979(cljs.core.chunk_rest(s__55980__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55982),null);
}
} else {
var vec__55986 = cljs.core.first(s__55980__$2);
...
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(instaparse.combinators_source.unhide_content(v),new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null),instaparse$combinators_source$unhide_all_$_iter__55979(cljs.core.rest(s__55980__$2)));
}
} else {
return null;
}
...
var G__55990 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "alt":
case "cat":
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(parser,new cljs.core.Keyword(null,"parsers","parsers",-804353827),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55989_SHARP_){
return (instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2 ? instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2(p1__55989_SHARP_,ws_parser) : instaparse.combinators_source.auto_whitespace_parser.call(null,p1__55989_SHARP_,ws_parser));
}),new cljs.core.Keyword(null,"parsers","parsers",-804353827).cljs$core$IFn$_invoke$arity$1(parser)));

break;
case "ord":
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(parser,new cljs.core.Keyword(null,"parser1","parser1",-439601422),(function (){var G__55991 = new cljs.core.Keyword(null,"parser1","parser1",-439601422).cljs$core$IFn$_invoke$arity$1(parser);
var G__55992 = ws_parser;
return (instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2 ? instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2(G__55991,G__55992) : instaparse.combinators_source.auto_whitespace_parser.call(null,G__55991,G__55992));
})(),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"parser2","parser2",1013754688),(function (){var G__55993 = new cljs.core.Keyword(null,"parser2","parser2",1013754688).cljs$core$IFn$_invoke$arity$1(parser);
var G__55994 = ws_parser;
return (instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2 ? instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2(G__55993,G__55994) : instaparse.combinators_source.auto_whitespace_parser.call(null,G__55993,G__55994));
})()], 0));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__55990__$1)].join('')));
...
var modified_grammar = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$auto_whitespace_$_iter__55995(s__55996){
return (new cljs.core.LazySeq(null,(function (){
...
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55999,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55999,(1),null);
cljs.core.chunk_append(b__55998,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [nt,instaparse.combinators_source.auto_whitespace_parser(parser,ws_parser)], null));

var G__56094 = (i__55997 + (1));
i__55997 = G__56094;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55998),instaparse$combinators_source$auto_whitespace_$_iter__55995(cljs.core.chunk_rest(s__55996__$2)));
} else {
...
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [nt,instaparse.combinators_source.auto_whitespace_parser(parser,ws_parser)], null),instaparse$combinators_source$auto_whitespace_$_iter__55995(cljs.core.rest(s__55996__$2)));
}
} else {
return null;
}
