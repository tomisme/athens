...
var G__46712 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__46713 = n;
var G__46714 = cljs.core.nnext(bs);
var G__46715 = true;
ret = G__46712;
n = G__46713;
bs = G__46714;
seen_rest_QMARK_ = G__46715;
continue;
} else {
...
});})(G__46706,gmap,defaults,pvec,bents))
;
return fexpr__46705(G__46706);
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__46681_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__46681_SHARP_);
}
})(),cljs.core.name(p1__46681_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__46684_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__46684_SHARP_);
}
})(),cljs.core.name(p1__46684_SHARP_));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__46686_SHARP_,p2__46687_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__46686_SHARP_,p2__46687_SHARP_,(function (){var fexpr__46707 = cljs.core.val(entry);
return (fexpr__46707.cljs$core$IFn$_invoke$arity$1 ? fexpr__46707.cljs$core$IFn$_invoke$arity$1(p2__46687_SHARP_) : fexpr__46707.call(null,p2__46687_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__46708 = cljs.core.key(entry);
return (fexpr__46708.cljs$core$IFn$_invoke$arity$1 ? fexpr__46708.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__46708.call(null,bes));
})());
...
var G__46720 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__46721 = cljs.core.next(bes);
ret = G__46720;
bes = G__46721;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__46695_SHARP_){
return (cljs.core.first(p1__46695_SHARP_) instanceof cljs.core.Keyword);
}),bents));
