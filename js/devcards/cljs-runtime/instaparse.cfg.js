...
var G__47823 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__47823)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__47823)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__47823)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__47823)].join('')));
...
var G__47955 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__47956 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__47955;
v = G__47956;
continue;
} else {
var G__47958 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__47959 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__47958;
v = G__47959;
continue;
}
...
break;
case "\"":
var G__47961 = cljs.core.next(sq);
var G__47962 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__47961;
v = G__47962;
continue;
...
break;
default:
var G__47963 = cljs.core.next(sq);
var G__47964 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__47963;
v = G__47964;
continue;
...
while(true){
var G__47837 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__47837__$1 = (((G__47837 instanceof cljs.core.Keyword))?G__47837.fqn:null);
switch (G__47837__$1) {
case "rule":
var vec__47848 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47848,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47848,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__47851 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__47851) : instaparse.cfg.content.call(null,G__47851));
...
break;
case "paren":
var G__47978 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__47978;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__47855 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__47855) : instaparse.cfg.build_rule.call(null,G__47855));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__47856 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__47856) : instaparse.cfg.build_rule.call(null,G__47856));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__47857 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__47857) : instaparse.cfg.build_rule.call(null,G__47857));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__47858 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__47858) : instaparse.cfg.build_rule.call(null,G__47858));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__47859 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__47859) : instaparse.cfg.build_rule.call(null,G__47859));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__47860 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__47860) : instaparse.cfg.build_rule.call(null,G__47860));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__47837__$1)].join('')));
...
while(true){
var G__47867 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "neg":
case "rep":
var G__47986 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__47986;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__47867__$1)].join('')));
...
var valid_nts_47987 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__47875_47988 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__47876_47989 = null;
var count__47877_47990 = (0);
var i__47878_47991 = (0);
while(true){
if((i__47878_47991 < count__47877_47990)){
var nt_47995 = chunk__47876_47989.cljs$core$IIndexed$_nth$arity$2(null,i__47878_47991);
if(cljs.core.truth_((valid_nts_47987.cljs$core$IFn$_invoke$arity$1 ? valid_nts_47987.cljs$core$IFn$_invoke$arity$1(nt_47995) : valid_nts_47987.call(null,nt_47995)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_47995),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__47996 = seq__47875_47988;
var G__47997 = chunk__47876_47989;
var G__47998 = count__47877_47990;
var G__47999 = (i__47878_47991 + (1));
seq__47875_47988 = G__47996;
chunk__47876_47989 = G__47997;
count__47877_47990 = G__47998;
i__47878_47991 = G__47999;
continue;
} else {
var temp__5735__auto___48001 = cljs.core.seq(seq__47875_47988);
if(temp__5735__auto___48001){
var seq__47875_48002__$1 = temp__5735__auto___48001;
if(cljs.core.chunked_seq_QMARK_(seq__47875_48002__$1)){
var c__4609__auto___48003 = cljs.core.chunk_first(seq__47875_48002__$1);
var G__48004 = cljs.core.chunk_rest(seq__47875_48002__$1);
var G__48005 = c__4609__auto___48003;
var G__48006 = cljs.core.count(c__4609__auto___48003);
var G__48007 = (0);
seq__47875_47988 = G__48004;
chunk__47876_47989 = G__48005;
count__47877_47990 = G__48006;
i__47878_47991 = G__48007;
continue;
} else {
var nt_48008 = cljs.core.first(seq__47875_48002__$1);
if(cljs.core.truth_((valid_nts_47987.cljs$core$IFn$_invoke$arity$1 ? valid_nts_47987.cljs$core$IFn$_invoke$arity$1(nt_48008) : valid_nts_47987.call(null,nt_48008)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_48008),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__48009 = cljs.core.next(seq__47875_48002__$1);
var G__48010 = null;
var G__48011 = (0);
var G__48012 = (0);
seq__47875_47988 = G__48009;
chunk__47876_47989 = G__48010;
count__47877_47990 = G__48011;
i__47878_47991 = G__48012;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__47894_48013 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__47895_48014 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__47896_48015 = true;
var _STAR_print_fn_STAR__temp_val__47897_48016 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__47896_48015);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__47897_48016);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__47895_48014);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__47894_48013);
}
...
var len__4789__auto___48021 = arguments.length;
var i__4790__auto___48022 = (0);
while(true){
if((i__4790__auto___48022 < len__4789__auto___48021)){
args__4795__auto__.push((arguments[i__4790__auto___48022]));

var G__48025 = (i__4790__auto___48022 + (1));
i__4790__auto___48022 = G__48025;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__47915){
...
var _STAR_case_insensitive_literals_STAR__orig_val__47921 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__47922 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__47922);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__47923_48027 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__47924_48028 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__47925_48029 = true;
var _STAR_print_fn_STAR__temp_val__47926_48030 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__47925_48029);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__47926_48030);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__47924_48028);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__47923_48027);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__47921);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq47903){
var G__47904 = cljs.core.first(seq47903);
var seq47903__$1 = cljs.core.next(seq47903);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47904,seq47903__$1);
}));
