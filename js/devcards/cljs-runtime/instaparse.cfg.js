...
var G__56975 = cljs.tools.reader.reader_types.string_push_back_reader.cljs$core$IFn$_invoke$arity$1(s);
var G__56976 = null;
var G__56977 = null;
var G__56978 = null;
return (read_string_STAR__57025.cljs$core$IFn$_invoke$arity$4 ? read_string_STAR__57025.cljs$core$IFn$_invoke$arity$4(G__56975,G__56976,G__56977,G__56978) : read_string_STAR__57025.call(null,G__56975,G__56976,G__56977,G__56978));
});
/**
...
while(true){
var G__56979 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__56979__$1 = (((G__56979 instanceof cljs.core.Keyword))?G__56979.fqn:null);
switch (G__56979__$1) {
case "rule":
var vec__56980 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56980,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56980,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__56983 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__56983) : instaparse.cfg.content.call(null,G__56983));
...
break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__56984 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__56985 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "star":
return instaparse.combinators_source.star((function (){var G__56986 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__56987 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "look":
return instaparse.combinators_source.look((function (){var G__56988 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
case "neg":
case "rep":
var G__57030 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__57030;
continue;
...
var valid_nts_57031 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__56996_57032 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__56997_57033 = null;
var count__56998_57034 = (0);
var i__56999_57035 = (0);
while(true){
if((i__56999_57035 < count__56998_57034)){
var nt_57036 = chunk__56997_57033.cljs$core$IIndexed$_nth$arity$2(null,i__56999_57035);
if(cljs.core.truth_((valid_nts_57031.cljs$core$IFn$_invoke$arity$1 ? valid_nts_57031.cljs$core$IFn$_invoke$arity$1(nt_57036) : valid_nts_57031.call(null,nt_57036)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_57036),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__57037 = seq__56996_57032;
var G__57038 = chunk__56997_57033;
var G__57039 = count__56998_57034;
var G__57040 = (i__56999_57035 + (1));
seq__56996_57032 = G__57037;
chunk__56997_57033 = G__57038;
count__56998_57034 = G__57039;
i__56999_57035 = G__57040;
continue;
} else {
var temp__5735__auto___57041 = cljs.core.seq(seq__56996_57032);
if(temp__5735__auto___57041){
var seq__56996_57042__$1 = temp__5735__auto___57041;
if(cljs.core.chunked_seq_QMARK_(seq__56996_57042__$1)){
var c__4609__auto___57043 = cljs.core.chunk_first(seq__56996_57042__$1);
var G__57044 = cljs.core.chunk_rest(seq__56996_57042__$1);
var G__57045 = c__4609__auto___57043;
var G__57046 = cljs.core.count(c__4609__auto___57043);
var G__57047 = (0);
seq__56996_57032 = G__57044;
chunk__56997_57033 = G__57045;
count__56998_57034 = G__57046;
i__56999_57035 = G__57047;
continue;
} else {
var nt_57048 = cljs.core.first(seq__56996_57042__$1);
if(cljs.core.truth_((valid_nts_57031.cljs$core$IFn$_invoke$arity$1 ? valid_nts_57031.cljs$core$IFn$_invoke$arity$1(nt_57048) : valid_nts_57031.call(null,nt_57048)))){
} else {
...
var G__57049 = cljs.core.next(seq__56996_57042__$1);
var G__57050 = null;
var G__57051 = (0);
var G__57052 = (0);
seq__56996_57032 = G__57049;
chunk__56997_57033 = G__57050;
count__56998_57034 = G__57051;
i__56999_57035 = G__57052;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__57000_57053 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57001_57054 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57002_57055 = true;
var _STAR_print_fn_STAR__temp_val__57003_57056 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57002_57055);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57003_57056);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57001_57054);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57000_57053);
}
...
var len__4789__auto___57057 = arguments.length;
var i__4790__auto___57058 = (0);
while(true){
if((i__4790__auto___57058 < len__4789__auto___57057)){
args__4795__auto__.push((arguments[i__4790__auto___57058]));

var G__57059 = (i__4790__auto___57058 + (1));
i__4790__auto___57058 = G__57059;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__57006){
...
var opts = map__57007__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__57009 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__57010 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__57010);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__57011_57060 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57012_57061 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57013_57062 = true;
var _STAR_print_fn_STAR__temp_val__57014_57063 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57013_57062);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57014_57063);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57012_57061);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57011_57060);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__57009);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq57004){
var G__57005 = cljs.core.first(seq57004);
var seq57004__$1 = cljs.core.next(seq57004);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57005,seq57004__$1);
}));
