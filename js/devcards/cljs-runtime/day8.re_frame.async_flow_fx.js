 ...
 */
day8.re_frame.async_flow_fx.dissoc_in = (function day8$re_frame$async_flow_fx$dissoc_in(m,p__60111){
var vec__60112 = p__60111;
var seq__60113 = cljs.core.seq(vec__60112);
var first__60114 = cljs.core.first(seq__60113);
var seq__60113__$1 = cljs.core.next(seq__60113);
var k = first__60114;
var ks = seq__60113__$1;
var keys = vec__60112;
if(ks){
...
var G__60116 = new cljs.core.Keyword(null,"events","events",1792552201).cljs$core$IFn$_invoke$arity$1(task);
var G__60117 = now_seen_events;
var fexpr__60115 = new cljs.core.Keyword(null,"when","when",-576417306).cljs$core$IFn$_invoke$arity$1(task);
return (fexpr__60115.cljs$core$IFn$_invoke$arity$2 ? fexpr__60115.cljs$core$IFn$_invoke$arity$2(G__60116,G__60117) : fexpr__60115.call(null,G__60116,G__60117));
...
var G__60118 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__60119 = "async-flow: got bad value for :when - ";
var G__60120 = when_kw;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__60118,G__60119,G__60120) : re_frame.core.console.call(null,G__60118,G__60119,G__60120));
}
});
/**
...
return cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (index,p__60121){
var map__60122 = p__60121;
var map__60122__$1 = (((((!((map__60122 == null))))?(((((map__60122.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__60122.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__60122):map__60122);
var rule = map__60122__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60122__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var when = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60122__$1,new cljs.core.Keyword(null,"when","when",-576417306));
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60122__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60122__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60122__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60122__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var halt_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60122__$1,new cljs.core.Keyword(null,"halt?","halt?",-1110658247));
...
var G__60124 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__60125 = "async-flow: rule can only specify one of :dispatch, :dispatch-n and :dispatch-fn. Got more than one: ";
var G__60126 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__60124,G__60125,G__60126) : re_frame.core.console.call(null,G__60124,G__60125,G__60126));
} else {
var G__60127 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__4185__auto__ = id;
...
var G__60127__$1 = (cljs.core.truth_(dispatch_fn)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__60127,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614),dispatch_fn):G__60127);
if(cljs.core.not(dispatch_fn)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__60127__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236),(cljs.core.truth_(dispatch_n)?dispatch_n:(cljs.core.truth_(dispatch)?(new cljs.core.List(null,dispatch,null,(1),null)):cljs.core.List.EMPTY
)));
} else {
return G__60127__$1;
}
...
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60128__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60128__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
...
var G__60130 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__60131 = "async-flow: dispatch-fn must return a seq of events ";
var G__60132 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__60130,G__60131,G__60132) : re_frame.core.console.call(null,G__60130,G__60131,G__60132));
}
} else {
 ...
 */
day8.re_frame.async_flow_fx.make_flow_event_handler = (function day8$re_frame$async_flow_fx$make_flow_event_handler(p__60133){
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60134__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var db_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60134__$1,new cljs.core.Keyword(null,"db-path","db-path",-68094099));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60134__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var first_dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60134__$1,new cljs.core.Keyword(null,"first-dispatch","first-dispatch",128561923));
...
return (function day8$re_frame$async_flow_fx$make_flow_event_handler_$_async_flow_event_handler(p__60136,p__60137){
var map__60138 = p__60136;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60138__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__60139 = p__60137;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60139,(0),null);
var event_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60139,(1),null);
var event_v = vec__60139;
var pred__60143 = cljs.core._EQ_;
var expr__60144 = event_type;
if(cljs.core.truth_((function (){var G__60146 = new cljs.core.Keyword(null,"setup","setup",1987730512);
var G__60147 = expr__60144;
return (pred__60143.cljs$core$IFn$_invoke$arity$2 ? pred__60143.cljs$core$IFn$_invoke$arity$2(G__60146,G__60147) : pred__60143.call(null,G__60146,G__60147));
})())){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),(function (){var G__60148 = db;
var G__60149 = cljs.core.PersistentHashSet.EMPTY;
var G__60150 = cljs.core.PersistentHashSet.EMPTY;
return (set_state.cljs$core$IFn$_invoke$arity$3 ? set_state.cljs$core$IFn$_invoke$arity$3(G__60148,G__60149,G__60150) : set_state.call(null,G__60148,G__60149,G__60150));
...
var vec__60151 = event_v;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60151,(0),null);
var forwarded_event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60151,(1),null);
var map__60154 = (get_state.cljs$core$IFn$_invoke$arity$1 ? get_state.cljs$core$IFn$_invoke$arity$1(db) : get_state.call(null,db));
...
var seen_events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60154__$1,new cljs.core.Keyword(null,"seen-events","seen-events",1607648392));
var rules_fired = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60154__$1,new cljs.core.Keyword(null,"rules-fired","rules-fired",-1669838140));
...
var vec__60156 = day8.re_frame.async_flow_fx.ensure_has_id(flow);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60156,(0),null);
var flow_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60156,(1),null);
...
var G__60159 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,new cljs.core.Keyword(null,"setup","setup",1987730512)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__60159) : re_frame.core.dispatch.call(null,G__60159));
});
var G__60160_60162 = new cljs.core.Keyword(null,"async-flow","async-flow",1464712702);
var G__60161_60163 = day8.re_frame.async_flow_fx.flow__GT_handler;
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__60160_60162,G__60161_60163) : re_frame.core.reg_fx.call(null,G__60160_60162,G__60161_60163));
