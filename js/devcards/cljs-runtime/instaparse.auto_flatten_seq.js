...
var G__46736 = n__$1;
var G__46737 = y;
var G__46738 = cljs.core.imul(z,z);
n = G__46736;
y = G__46737;
z = G__46738;
continue;
...
var G__46739 = n__$1;
var G__46740 = cljs.core.imul(z,y);
var G__46741 = cljs.core.imul(z,z);
n = G__46739;
y = G__46740;
z = G__46741;
continue;
...
var G__46752 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(v__$1,(0));
var G__46753 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(index__$1,(0));
v__$1 = G__46752;
index__$1 = G__46753;
continue;
} else {
...
if((cljs.core.peek(index) < ((function (){var G__46655 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__46655) : instaparse.auto_flatten_seq.true_count.call(null,G__46655));
})() - (1)))){
...
var G__46759 = v;
var G__46760 = cljs.core.pop(index);
v = G__46759;
index = G__46760;
continue;
...
while(true){
if((!((coll__$1 == null)))){
var G__46851 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__46852 = cljs.core.next(coll__$1);
unmixed_hash = G__46851;
coll__$1 = G__46852;
continue;
} else {
return unmixed_hash;
...
var G__46853 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__46854 = cljs.core.next(v);
acc = G__46853;
v = G__46854;
continue;
} else {
var G__46855 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__46856 = cljs.core.next(v);
acc = G__46855;
v = G__46856;
continue;
}
...
var self__ = this;
var self__ = this;
var G__46698 = (arguments.length - (1));
switch (G__46698) {
case (1):
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args46686){
var self__ = this;
var self____$1 = this;
