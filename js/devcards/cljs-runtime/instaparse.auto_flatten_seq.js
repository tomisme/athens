...
if((cljs.core.peek(index) < ((function (){var G__55807 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__55807) : instaparse.auto_flatten_seq.true_count.call(null,G__55807));
})() - (1)))){
...
var G__55876 = v;
var G__55877 = cljs.core.pop(index);
v = G__55876;
index = G__55877;
continue;
