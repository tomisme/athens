...
var G__42977 = devtools.prefs.pref(v);
v = G__42977;
continue;
} else {
return v;
...
}catch (e42888){var _e__40097__auto__ = e42888;
return false;
}})();
...
}catch (e42893){var _e__40097__auto__ = e42893;
return false;
}})();
...
}catch (e42900){var _e__40097__auto__ = e42900;
return false;
}}
}
});
...
var vec__42927 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42927,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42927,(1),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__42936_SHARP_);
}),template);
});
