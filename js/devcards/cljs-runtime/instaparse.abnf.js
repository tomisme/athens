...
var vec__57451 = nums;
var lo = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57451,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57451,(1),null);
var hi = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57451,(2),null);
return instaparse.combinators_source.unicode_char.cljs$core$IFn$_invoke$arity$2(lo,hi);
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(instaparse.combinators_source.cat,(function (){var iter__4582__auto__ = (function instaparse$abnf$iter__57454(s__57455){
return (new cljs.core.LazySeq(null,(function (){
var s__57455__$1 = s__57455;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__57455__$1);
if(temp__5735__auto__){
var s__57455__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__57455__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__57455__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__57457 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__57456 = (0);
while(true){
if((i__57456 < size__4581__auto__)){
var n = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__57456);
cljs.core.chunk_append(b__57457,instaparse.combinators_source.unicode_char.cljs$core$IFn$_invoke$arity$1(n));

var G__57518 = (i__57456 + (1));
i__57456 = G__57518;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__57457),instaparse$abnf$iter__57454(cljs.core.chunk_rest(s__57455__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__57457),null);
}
} else {
var n = cljs.core.first(s__57455__$2);
return cljs.core.cons(instaparse.combinators_source.unicode_char.cljs$core$IFn$_invoke$arity$1(n),instaparse$abnf$iter__57454(cljs.core.rest(s__57455__$2)));
}
} else {
return null;
}
...
/** @this {Function} */
(instaparse.abnf.get_char_combinator.cljs$lang$applyTo = (function (seq57450){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq57450));
}));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$abnf$project_$_iter__57458(s__57459){
return (new cljs.core.LazySeq(null,(function (){
...
var k = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__57460);
if(cljs.core.contains_QMARK_(m,k)){
cljs.core.chunk_append(b__57461,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,(m.cljs$core$IFn$_invoke$arity$1 ? m.cljs$core$IFn$_invoke$arity$1(k) : m.call(null,k))], null));

var G__57525 = (i__57460 + (1));
i__57460 = G__57525;
continue;
} else {
var G__57526 = (i__57460 + (1));
i__57460 = G__57526;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__57461),instaparse$abnf$project_$_iter__57458(cljs.core.chunk_rest(s__57459__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__57461),null);
}
} else {
var k = cljs.core.first(s__57459__$2);
if(cljs.core.contains_QMARK_(m,k)){
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,(m.cljs$core$IFn$_invoke$arity$1 ? m.cljs$core$IFn$_invoke$arity$1(k) : m.call(null,k))], null),instaparse$abnf$project_$_iter__57458(cljs.core.rest(s__57459__$2)));
} else {
var G__57527 = cljs.core.rest(s__57459__$2);
s__57459__$1 = G__57527;
continue;
}
}
} else {
...
while (G__57534__i < G__57534__a.length) {G__57534__a[G__57534__i] = arguments[G__57534__i + 0]; ++G__57534__i;}
  cs = new cljs.core.IndexedSeq(G__57534__a,0,null);
} 
...
var cs = cljs.core.seq(arglist__57535);
...
var G__57538__delegate = function (rest__57463_SHARP_){
if(cljs.core.truth_(instaparse.abnf._STAR_case_insensitive_STAR_)){
return instaparse.combinators_source.nt(cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(clojure.string.upper_case(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,rest__57463_SHARP_))));
} else {
return instaparse.combinators_source.nt(cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,rest__57463_SHARP_)));
}
};
var G__57538 = function (var_args){
var rest__57463_SHARP_ = null;
if (arguments.length > 0) {
...
while (G__57541__i < G__57541__a.length) {G__57541__a[G__57541__i] = arguments[G__57541__i + 0]; ++G__57541__i;}
  rest__57463_SHARP_ = new cljs.core.IndexedSeq(G__57541__a,0,null);
} 
return G__57538__delegate.call(this,rest__57463_SHARP_);};
G__57538.cljs$lang$maxFixedArity = 0;
G__57538.cljs$lang$applyTo = (function (arglist__57542){
var rest__57463_SHARP_ = cljs.core.seq(arglist__57542);
return G__57538__delegate(rest__57463_SHARP_);
});
G__57538.cljs$core$IFn$_invoke$arity$variadic = G__57538__delegate;
return G__57538;
})()
,(function() { 
var G__57543__delegate = function (rest__57464_SHARP_){
var G__57467 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,rest__57464_SHARP_);
return (instaparse.abnf.parse_int.cljs$core$IFn$_invoke$arity$1 ? instaparse.abnf.parse_int.cljs$core$IFn$_invoke$arity$1(G__57467) : instaparse.abnf.parse_int.call(null,G__57467));
};
var G__57543 = function (var_args){
var rest__57464_SHARP_ = null;
if (arguments.length > 0) {
...
while (G__57544__i < G__57544__a.length) {G__57544__a[G__57544__i] = arguments[G__57544__i + 0]; ++G__57544__i;}
  rest__57464_SHARP_ = new cljs.core.IndexedSeq(G__57544__a,0,null);
} 
return G__57543__delegate.call(this,rest__57464_SHARP_);};
G__57543.cljs$lang$maxFixedArity = 0;
G__57543.cljs$lang$applyTo = (function (arglist__57545){
var rest__57464_SHARP_ = cljs.core.seq(arglist__57545);
return G__57543__delegate(rest__57464_SHARP_);
});
...
G__57550.cljs$lang$applyTo = (function (arglist__57556){
...
var G__57557 = null;
var G__57557__1 = (function (element){
return element;
});
var G__57557__2 = (function (repeat,element){
...
G__57557 = function(repeat,element){
switch(arguments.length){
case 1:
return G__57557__1.call(this,repeat);
case 2:
return G__57557__2.call(this,repeat,element);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__57557.cljs$core$IFn$_invoke$arity$1 = G__57557__1;
G__57557.cljs$core$IFn$_invoke$arity$2 = G__57557__2;
return G__57557;
})()
,(function() { 
var G__57558__delegate = function (rest__57462_SHARP_){
if(cljs.core.truth_(instaparse.abnf._STAR_case_insensitive_STAR_)){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(clojure.string.upper_case(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,rest__57462_SHARP_)));
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,rest__57462_SHARP_));
}
};
var G__57558 = function (var_args){
var rest__57462_SHARP_ = null;
if (arguments.length > 0) {
...
while (G__57559__i < G__57559__a.length) {G__57559__a[G__57559__i] = arguments[G__57559__i + 0]; ++G__57559__i;}
  rest__57462_SHARP_ = new cljs.core.IndexedSeq(G__57559__a,0,null);
} 
return G__57558__delegate.call(this,rest__57462_SHARP_);};
G__57558.cljs$lang$maxFixedArity = 0;
G__57558.cljs$lang$applyTo = (function (arglist__57560){
var rest__57462_SHARP_ = cljs.core.seq(arglist__57560);
return G__57558__delegate(rest__57462_SHARP_);
});
...
var G__57470 = cljs.core.count(items);
switch (G__57470) {
case (1):
...
while (G__57564__i < G__57564__a.length) {G__57564__a[G__57564__i] = arguments[G__57564__i + 0]; ++G__57564__i;}
  items = new cljs.core.IndexedSeq(G__57564__a,0,null);
} 
...
var items = cljs.core.seq(arglist__57565);
...
return (instaparse.abnf.parse_int.cljs$core$IFn$_invoke$arity$1 ? instaparse.abnf.parse_int.cljs$core$IFn$_invoke$arity$1(G__57471) : instaparse.abnf.parse_int.call(null,G__57471));
};
...
var G__57572 = (i__4790__auto___57571 + (1));
i__4790__auto___57571 = G__57572;
continue;
} else {
}
break;
...
(instaparse.abnf.abnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__57474){
...
var _STAR_case_insensitive_literals_STAR__orig_val__57482 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__57483 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__57483);
...
var _STAR_print_newline_STAR__orig_val__57485_57574 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57486_57575 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57487_57576 = true;
var _STAR_print_fn_STAR__temp_val__57488_57577 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57487_57576);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57488_57577);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([tree], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57486_57575);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57485_57574);
}
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__57482);
}}));

(instaparse.abnf.abnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.abnf.abnf.cljs$lang$applyTo = (function (seq57472){
var G__57473 = cljs.core.first(seq57472);
var seq57472__$1 = cljs.core.next(seq57472);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57473,seq57472__$1);
}));
...
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__57493_57581 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57494_57582 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57495_57583 = true;
var _STAR_print_fn_STAR__temp_val__57496_57584 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57495_57583);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57496_57584);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rule_tree], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57494_57582);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57493_57581);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
