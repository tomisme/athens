...
if((x instanceof cljs.core.Keyword)){
var G__47371 = spec;
var G__47372 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__47371,G__47372) : f.call(null,G__47371,G__47372));
} else {
if(typeof x === 'string'){
...
}catch (e47376){if((e47376 instanceof Error)){
var ___$1 = e47376;
return x;
} else {
throw e47376;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__47380,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47381__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__47383,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47384__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__47386,x){
...
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47387__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
