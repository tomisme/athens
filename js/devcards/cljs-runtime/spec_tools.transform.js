...
if((x instanceof cljs.core.Keyword)){
var G__49973 = spec;
var G__49974 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__49973,G__49974) : f.call(null,G__49973,G__49974));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__49975 = spec;
var G__49976 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__49975,G__49976) : f.call(null,G__49975,G__49976));
} else {
return x;
...
}catch (e49977){if((e49977 instanceof Error)){
var ___$1 = e49977;
return x;
} else {
throw e49977;
...
}catch (e49979){if((e49979 instanceof Error)){
var ___$1 = e49979;
return x;
} else {
throw e49979;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__49982,x){
var map__49983 = p__49982;
var map__49983__$1 = (((((!((map__49983 == null))))?(((((map__49983.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__49983.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__49983):map__49983);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49983__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__49985,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49986__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__49988,x){
...
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49989__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
