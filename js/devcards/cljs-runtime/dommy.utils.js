 ...
 */
dommy.utils.dissoc_in = (function dommy$utils$dissoc_in(m,p__34605){
...
return [(function (){var G__34617 = cljs.core.namespace(s);
if((G__34617 == null)){
return null;
} else {
return [G__34617,"/"].join('');
}
