...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51396_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__51396_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51395_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__51395_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51397_SHARP_){
return (((p1__51397_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__51397_SHARP_) == null)));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51402_SHARP_){
if((p1__51402_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__51402_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__51471 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__51472 = clojure.zip.next(loc);
loc = G__51472;
continue;
}
}
...
var len__4789__auto___51480 = arguments.length;
var i__4790__auto___51481 = (0);
while(true){
if((i__4790__auto___51481 < len__4789__auto___51480)){
args__4795__auto__.push((arguments[i__4790__auto___51481]));

var G__51482 = (i__4790__auto___51481 + (1));
i__4790__auto___51481 = G__51482;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__51425){
var vec__51426 = p__51425;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51426,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq51411){
var G__51412 = cljs.core.first(seq51411);
var seq51411__$1 = cljs.core.next(seq51411);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51412,seq51411__$1);
}));
...
var _STAR_print_newline_STAR__orig_val__51433_51483 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__51434_51484 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__51435_51485 = true;
var _STAR_print_fn_STAR__temp_val__51436_51486 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__51435_51485);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__51436_51486);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__51434_51484);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__51433_51483);
}
...
var G__51488 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__51487;
acc = G__51488;
continue;
} else {
...
var G__51490 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__51489;
acc = G__51490;
continue;
} else {
...
var G__51492 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__51491;
acc = G__51492;
continue;
} else {
...
var G__51494 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__51493;
acc = G__51494;
continue;
} else {
...
var G__51495 = cljs.core.next(opts__$1);
var G__51496 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__51495;
acc = G__51496;
continue;
} else {
...
var G__51497 = cljs.core.nnext(opts__$1);
var G__51498 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__51497;
acc = G__51498;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__51499 = cljs.core.next(opts__$1);
var G__51500 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__51499;
acc = G__51500;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__51443){
var vec__51444 = p__51443;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51444,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51444,(1),null);
...
var G__51450 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__51449 = (function (){var fexpr__51451 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__51451.cljs$core$IFn$_invoke$arity$1 ? fexpr__51451.cljs$core$IFn$_invoke$arity$1(form) : fexpr__51451.call(null,form));
})();
...
while (G__51503__i < G__51503__a.length) {G__51503__a[G__51503__i] = arguments[G__51503__i + 0]; ++G__51503__i;}
  arg = new cljs.core.IndexedSeq(G__51503__a,0,null);
} 
return G__51501__delegate.call(this,arg);};
G__51501.cljs$lang$maxFixedArity = 0;
G__51501.cljs$lang$applyTo = (function (arglist__51504){
var arg = cljs.core.seq(arglist__51504);
...
var G__51506 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__51506;
continue;
} else {
...
var G__51507 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__51507;
continue;
} else {
var G__51508 = clojure.zip.next(loc);
loc = G__51508;
continue;
