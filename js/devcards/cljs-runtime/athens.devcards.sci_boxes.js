...
return devcards.core.card_base(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"name","name",1843675177),"sci-examples",new cljs.core.Keyword(null,"documentation","documentation",1889593999),null,new cljs.core.Keyword(null,"main-obj","main-obj",-1544409742),(function (){var iter__4582__auto__ = (function athens$devcards$sci_boxes$iter__61594(s__61595){
return (new cljs.core.LazySeq(null,(function (){
var s__61595__$1 = s__61595;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__61595__$1);
if(temp__5735__auto__){
var s__61595__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__61595__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__61595__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__61597 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__61596 = (0);
while(true){
if((i__61596 < size__4581__auto__)){
var vec__61598 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__61596);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__61597),athens$devcards$sci_boxes$iter__61594(cljs.core.chunk_rest(s__61595__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__61597),null);
}
} else {
var vec__61601 = cljs.core.first(s__61595__$2);
...
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61605,(0),null);
var box = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61605,(1),null);
...
athens.devcards.sci_boxes.sci_node_QMARK_ = (function athens$devcards$sci_boxes$sci_node_QMARK_(p__61608){
...
athens.devcards.sci_boxes.eval_box = (function athens$devcards$sci_boxes$eval_box(p__61611,parent){
...
}catch (e61614){if((e61614 instanceof Error)){
var e = e61614;
...
athens.devcards.sci_boxes.add_child = (function athens$devcards$sci_boxes$add_child(p__61617,idx,id){
...
var box = map__61618__$1;
var children_ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61618__$1,new cljs.core.Keyword(null,"children-ids","children-ids",-293558198));
var new_idx = (idx + (1));
...
athens.devcards.sci_boxes.add_sibling = (function athens$devcards$sci_boxes$add_sibling(p__61620,id){
...
var next_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61621__$1,new cljs.core.Keyword(null,"next-id","next-id",-224240762));
...
athens.devcards.sci_boxes.delete_box = (function athens$devcards$sci_boxes$delete_box(p__61623,id){
...
var map__61626 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(athens.devcards.sci_boxes.box_state_STAR_),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"boxes","boxes",-420813822),id], null));
...
var G__61628 = k;
var G__61628__$1 = (((G__61628 instanceof cljs.core.Keyword))?G__61628.fqn:null);
switch (G__61628__$1) {
case "return":
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(athens.devcards.sci_boxes.box_state_STAR_,(function (p1__61629_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$5(p1__61629_SHARP_,new cljs.core.Keyword(null,"boxes","boxes",-420813822),athens.devcards.sci_boxes.update_box_content,id,value),new cljs.core.Keyword(null,"boxes","boxes",-420813822),athens.devcards.sci_boxes.eval_all_boxes);
}));
});
...
var hiccup = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61630__$1,new cljs.core.Keyword(null,"hiccup","hiccup",1218876238));
...
var vec__61632 = cljs.core.deref(err_STAR_);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61632,(0),null);
var info = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61632,(1),null);
...
var map__61637 = cljs.core.deref(athens.devcards.sci_boxes.box_state_STAR_);
...
var map__61638 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(boxes,id);
...
var str_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61638__$1,new cljs.core.Keyword(null,"str-content","str-content",297549190));
...
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61638__$1,new cljs.core.Keyword(null,"result","result",1415092211));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"display","display",242065432),"flex"], null)], null),id,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"textarea","textarea",-650375824),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),"1rem",new cljs.core.Keyword(null,"width","width",-384071477),"30rem"], null),new cljs.core.Keyword(null,"value","value",305978217),str_content,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__61635_SHARP_){
return athens.devcards.sci_boxes.handle_box_change_BANG_(p1__61635_SHARP_,id);
}),new cljs.core.Keyword(null,"on-key-down","on-key-down",-1374733765),(function (p1__61636_SHARP_){
return athens.devcards.sci_boxes.handle_box_key_down_BANG_(p1__61636_SHARP_,id);
})], null)], null),((athens.devcards.sci_boxes.sci_node_QMARK_(box))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.sci_result_wrapper,result], null):null)], null),((cljs.core.seq(children_ids))?cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-left","margin-left",2015598377),"1rem"], null)], null)], null),(function (){var iter__4582__auto__ = (function athens$devcards$sci_boxes$box_component_$_iter__61641(s__61642){
return (new cljs.core.LazySeq(null,(function (){
var s__61642__$1 = s__61642;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__61642__$1);
if(temp__5735__auto__){
var s__61642__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__61642__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__61642__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__61644 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__61643 = (0);
while(true){
if((i__61643 < size__4581__auto__)){
var id__$1 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__61643);
cljs.core.chunk_append(b__61644,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.box_component,id__$1], null));

var G__61653 = (i__61643 + (1));
i__61643 = G__61653;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__61644),athens$devcards$sci_boxes$box_component_$_iter__61641(cljs.core.chunk_rest(s__61642__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__61644),null);
}
} else {
var id__$1 = cljs.core.first(s__61642__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.box_component,id__$1], null),athens$devcards$sci_boxes$box_component_$_iter__61641(cljs.core.rest(s__61642__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.sci_boxes !== 'undefined') && (typeof athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61645 !== 'undefined')){
} else {
...
*/
athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61645 = (function (meta61646){
this.meta61646 = meta61646;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61645.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61647,meta61646__$1){
var self__ = this;
var _61647__$1 = this;
return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61645(meta61646__$1));
}));

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61645.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61647){
var self__ = this;
var _61647__$1 = this;
return self__.meta61646;
}));

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61645.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61645.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42228__auto__,devcard_opts__42229__auto__){
var self__ = this;
...
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61645.getBasis = (function (){
...
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61645.cljs$lang$type = true);

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61645.cljs$lang$ctorStr = "athens.devcards.sci-boxes/t_athens$devcards$sci_boxes61645");

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61645.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.sci-boxes/t_athens$devcards$sci_boxes61645");
}));

/**
 * Positional factory function for athens.devcards.sci-boxes/t_athens$devcards$sci_boxes61645.
 */
athens.devcards.sci_boxes.__GT_t_athens$devcards$sci_boxes61645 = (function athens$devcards$sci_boxes$__GT_t_athens$devcards$sci_boxes61645(meta61646){
return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61645(meta61646));
});

}

return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61645(null));
})()
