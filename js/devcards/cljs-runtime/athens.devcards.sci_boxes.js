...
return devcards.core.card_base(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"name","name",1843675177),"sci-examples",new cljs.core.Keyword(null,"documentation","documentation",1889593999),null,new cljs.core.Keyword(null,"main-obj","main-obj",-1544409742),(function (){var iter__4582__auto__ = (function athens$devcards$sci_boxes$iter__61592(s__61593){
...
var vec__61596 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__61594);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61596,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61596,(1),null);
cljs.core.chunk_append(b__61595,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),s,new cljs.core.Keyword(null,"result","result",1415092211),sci.core.eval_string.cljs$core$IFn$_invoke$arity$2(s,opts)], null),(cljs.core.truth_(opts)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"opts","opts",155075701),opts], null):null)], 0)));

var G__61646 = (i__61594 + (1));
i__61594 = G__61646;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__61595),athens$devcards$sci_boxes$iter__61592(cljs.core.chunk_rest(s__61593__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__61595),null);
}
} else {
var vec__61599 = cljs.core.first(s__61593__$2);
...
return cljs.core.some((function (p__61602){
var vec__61603 = p__61602;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61603,(0),null);
var box = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61603,(1),null);
...
athens.devcards.sci_boxes.sci_node_QMARK_ = (function athens$devcards$sci_boxes$sci_node_QMARK_(p__61606){
...
var str_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61607__$1,new cljs.core.Keyword(null,"str-content","str-content",297549190));
return clojure.string.starts_with_QMARK_(str_content,":sci");
});
athens.devcards.sci_boxes.eval_box = (function athens$devcards$sci_boxes$eval_box(p__61609,parent){
...
athens.devcards.sci_boxes.add_child = (function athens$devcards$sci_boxes$add_child(p__61615,idx,id){
...
var children_ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61616__$1,new cljs.core.Keyword(null,"children-ids","children-ids",-293558198));
var new_idx = (idx + (1));
...
athens.devcards.sci_boxes.add_sibling = (function athens$devcards$sci_boxes$add_sibling(p__61618,id){
...
var state = map__61619__$1;
var next_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61619__$1,new cljs.core.Keyword(null,"next-id","next-id",-224240762));
var boxes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61619__$1,new cljs.core.Keyword(null,"boxes","boxes",-420813822));
...
athens.devcards.sci_boxes.delete_box = (function athens$devcards$sci_boxes$delete_box(p__61621,id){
...
var map__61624 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(athens.devcards.sci_boxes.box_state_STAR_),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"boxes","boxes",-420813822),id], null));
...
var str_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61624__$1,new cljs.core.Keyword(null,"str-content","str-content",297549190));
...
var G__61626 = k;
var G__61626__$1 = (((G__61626 instanceof cljs.core.Keyword))?G__61626.fqn:null);
switch (G__61626__$1) {
case "return":
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(athens.devcards.sci_boxes.box_state_STAR_,(function (p1__61627_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$5(p1__61627_SHARP_,new cljs.core.Keyword(null,"boxes","boxes",-420813822),athens.devcards.sci_boxes.update_box_content,id,value),new cljs.core.Keyword(null,"boxes","boxes",-420813822),athens.devcards.sci_boxes.eval_all_boxes);
}));
});
athens.devcards.sci_boxes.sci_result_component = (function athens$devcards$sci_boxes$sci_result_component(result){
if(cljs.core.truth_(result)){
var map__61628 = result;
...
var hiccup = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61628__$1,new cljs.core.Keyword(null,"hiccup","hiccup",1218876238));
...
var vec__61630 = cljs.core.deref(err_STAR_);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61630,(0),null);
var info = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61630,(1),null);
...
var map__61635 = cljs.core.deref(athens.devcards.sci_boxes.box_state_STAR_);
...
var map__61636 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(boxes,id);
...
var str_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61636__$1,new cljs.core.Keyword(null,"str-content","str-content",297549190));
...
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61636__$1,new cljs.core.Keyword(null,"result","result",1415092211));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"display","display",242065432),"flex"], null)], null),id,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"textarea","textarea",-650375824),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),"1rem",new cljs.core.Keyword(null,"width","width",-384071477),"30rem"], null),new cljs.core.Keyword(null,"value","value",305978217),str_content,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__61633_SHARP_){
return athens.devcards.sci_boxes.handle_box_change_BANG_(p1__61633_SHARP_,id);
}),new cljs.core.Keyword(null,"on-key-down","on-key-down",-1374733765),(function (p1__61634_SHARP_){
return athens.devcards.sci_boxes.handle_box_key_down_BANG_(p1__61634_SHARP_,id);
})], null)], null),((athens.devcards.sci_boxes.sci_node_QMARK_(box))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.sci_result_wrapper,result], null):null)], null),((cljs.core.seq(children_ids))?cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-left","margin-left",2015598377),"1rem"], null)], null)], null),(function (){var iter__4582__auto__ = (function athens$devcards$sci_boxes$box_component_$_iter__61639(s__61640){
return (new cljs.core.LazySeq(null,(function (){
var s__61640__$1 = s__61640;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__61640__$1);
if(temp__5735__auto__){
var s__61640__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__61640__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__61640__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__61642 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__61641 = (0);
while(true){
if((i__61641 < size__4581__auto__)){
var id__$1 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__61641);
cljs.core.chunk_append(b__61642,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.box_component,id__$1], null));

var G__61651 = (i__61641 + (1));
i__61641 = G__61651;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__61642),athens$devcards$sci_boxes$box_component_$_iter__61639(cljs.core.chunk_rest(s__61640__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__61642),null);
}
} else {
var id__$1 = cljs.core.first(s__61640__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.box_component,id__$1], null),athens$devcards$sci_boxes$box_component_$_iter__61639(cljs.core.rest(s__61640__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.sci_boxes !== 'undefined') && (typeof athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61643 !== 'undefined')){
} else {
...
*/
athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61643 = (function (meta61644){
this.meta61644 = meta61644;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61643.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61645,meta61644__$1){
var self__ = this;
var _61645__$1 = this;
return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61643(meta61644__$1));
}));

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61643.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61645){
var self__ = this;
var _61645__$1 = this;
return self__.meta61644;
}));

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61643.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61643.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42228__auto__,devcard_opts__42229__auto__){
var self__ = this;
...
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61643.getBasis = (function (){
...
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61643.cljs$lang$type = true);

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61643.cljs$lang$ctorStr = "athens.devcards.sci-boxes/t_athens$devcards$sci_boxes61643");

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61643.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.sci-boxes/t_athens$devcards$sci_boxes61643");
}));

/**
 * Positional factory function for athens.devcards.sci-boxes/t_athens$devcards$sci_boxes61643.
 */
athens.devcards.sci_boxes.__GT_t_athens$devcards$sci_boxes61643 = (function athens$devcards$sci_boxes$__GT_t_athens$devcards$sci_boxes61643(meta61644){
return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61643(meta61644));
});

}

return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61643(null));
})()
