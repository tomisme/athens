...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44852_SHARP_){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__44862){
var vec__44878 = p__44862;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44878,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44878,(1),null);
...
}),cljs.core.PersistentArrayMap.EMPTY,p1__44852_SHARP_);
}),hms);
}
});
/**
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44902_SHARP_){
return cljs.core.cons(new cljs.core.Keyword("db","add","db/add",235286841),p1__44902_SHARP_);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44900_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.edn.read_string,p1__44900_SHARP_);
...
return athens.db.sort_block_children(cljs.core.deref((function (){var G__44932 = athens.db.dsdb;
var G__44933 = new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","id","db/id",-1388397098),new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword("block","string","block/string",-2066596447),new cljs.core.Keyword("block","open","block/open",-1875254829),new cljs.core.Keyword("block","order","block/order",-1429282437),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","children","block/children",-1040716209),new cljs.core.Symbol(null,"...","...",-1926939749,null)], null)], null);
var G__44934 = id;
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__44932,G__44933,G__44934) : posh.reagent.pull.call(null,G__44932,G__44933,G__44934));
})()));
});
athens.db.get_node_document = (function athens$db$get_node_document(id){
return athens.db.sort_block_children(cljs.core.deref((function (){var G__44939 = athens.db.dsdb;
var G__44940 = new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","id","db/id",-1388397098),new cljs.core.Keyword("node","title","node/title",628940777),new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword("block","string","block/string",-2066596447),new cljs.core.Keyword("block","open","block/open",-1875254829),new cljs.core.Keyword("block","order","block/order",-1429282437),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","children","block/children",-1040716209),new cljs.core.Symbol(null,"...","...",-1926939749,null)], null)], null);
var G__44941 = id;
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__44939,G__44940,G__44941) : posh.reagent.pull.call(null,G__44939,G__44940,G__44941));
})()));
});
/**
...
var G__45219 = cljs.core.first(new cljs.core.Keyword("block","_children","block/_children",1128070632).cljs$core$IFn$_invoke$arity$1(b));
var G__45220 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(b,new cljs.core.Keyword("block","_children","block/_children",1128070632)));
b = G__45219;
res = G__45220;
continue;
}
...
return athens.db.shape_parent_query(cljs.core.deref((function (){var G__44979 = athens.db.dsdb;
var G__44980 = new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","id","db/id",-1388397098),new cljs.core.Keyword("node","title","node/title",628940777),new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword("block","string","block/string",-2066596447),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","_children","block/_children",1128070632),new cljs.core.Symbol(null,"...","...",-1926939749,null)], null)], null);
var G__44981 = id;
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__44979,G__44980,G__44981) : posh.reagent.pull.call(null,G__44979,G__44980,G__44981));
})()));
});
athens.db.get_block = (function athens$db$get_block(id){
return cljs.core.deref((function (){var G__44987 = athens.db.dsdb;
var G__44988 = new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","id","db/id",-1388397098),new cljs.core.Keyword("node","title","node/title",628940777),new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword("block","order","block/order",-1429282437),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","children","block/children",-1040716209),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword("block","order","block/order",-1429282437)], null)], null)], null);
var G__44989 = id;
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__44987,G__44988,G__44989) : posh.reagent.pull.call(null,G__44987,G__44988,G__44989));
})());
});
athens.db.get_parent = (function athens$db$get_parent(id){
return athens.db.get_block(new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(cljs.core.first(new cljs.core.Keyword("block","_children","block/_children",1128070632).cljs$core$IFn$_invoke$arity$1((function (){var G__44998 = cljs.core.deref(athens.db.dsdb);
var G__44999 = id;
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__44998,G__44999) : datascript.core.entity.call(null,G__44998,G__44999));
})()))));
});
...
var G__45229 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(acc,x);
var G__45230 = cljs.core.next(xs__$1);
acc = G__45229;
xs__$1 = G__45230;
continue;
...
return cljs.core.last(cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__45035_SHARP_){
return cljs.core.not((pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(p1__45035_SHARP_) : pred.call(null,p1__45035_SHARP_)));
}),xs));
});
athens.db.find_next = (function athens$db$find_next(xs,pred){
return cljs.core.fnext(cljs.core.drop_while.cljs$core$IFn$_invoke$arity$2((function (p1__45044_SHARP_){
return cljs.core.not((pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(p1__45044_SHARP_) : pred.call(null,p1__45044_SHARP_)));
}),xs));
});
...
var db_before = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45055__$1,new cljs.core.Keyword(null,"db-before","db-before",-553691536));
var db_after = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45055__$1,new cljs.core.Keyword(null,"db-after","db-after",-571884666));
...
return athens.db.trim_head(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(athens.db.drop_tail(h,(function (p1__45052_SHARP_){
return (p1__45052_SHARP_ === db_before);
})),db_after),(10));
}));
} else {
return null;
