...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__50375){
var vec__50376 = p__50375;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50376,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50376,(1),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__50379_SHARP_){
return (((p1__50379_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__50379_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__50380,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__50380;
}
});
...
var G__50416 = (i__4790__auto___50414 + (1));
i__4790__auto___50414 = G__50416;
continue;
} else {
}
break;
...
var G__50382 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50382,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__50382;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq50381){
...
var vec__50393 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__50400 = cljs.core.ffirst(matches);
var fexpr__50399 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__50399.cljs$core$IFn$_invoke$arity$1 ? fexpr__50399.cljs$core$IFn$_invoke$arity$1(G__50400) : fexpr__50399.call(null,G__50400));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50393,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50393,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__50383_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__50383_SHARP_))){
return p1__50383_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__50384_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__50384_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__50402){
...
var tag = first__50405;
var content = seq__50404__$1;
...
var vec__50406 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50406,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50406,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50406,(2),null);
