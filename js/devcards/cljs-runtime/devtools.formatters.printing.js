...
var i__4790__auto___43336 = (0);
while(true){
if((i__4790__auto___43336 < len__4789__auto___43333)){
args__4795__auto__.push((arguments[i__4790__auto___43336]));

var G__43337 = (i__4790__auto___43336 + (1));
i__4790__auto___43336 = G__43337;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq43152){
var G__43153 = cljs.core.first(seq43152);
var seq43152__$1 = cljs.core.next(seq43152);
var G__43154 = cljs.core.first(seq43152__$1);
var seq43152__$2 = cljs.core.next(seq43152__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43153,G__43154,seq43152__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__43223_SHARP_){
return (!((cljs.core.meta(p1__43223_SHARP_) == null)));
})))){
...
}catch (e43262){var _e__40097__auto__ = e43262;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e43268){var _e__40097__auto__ = e43268;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__43280 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__43281 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__43281);

try{var map__43283 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43283__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__43280);
}});
...
var temp__5733__auto___43472 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___43472)){
var managed_print_level_43473 = temp__5733__auto___43472;
var _STAR_print_level_STAR__orig_val__43310_43474 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__43311_43475 = managed_print_level_43473;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__43311_43475);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__43293_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__43293_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__43310_43474);
}} else {
job_fn();
}
