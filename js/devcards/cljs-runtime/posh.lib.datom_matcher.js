...
var G__29048 = clojure.set.union.cljs$core$IFn$_invoke$arity$2(entids,((cljs.core.set_QMARK_(cljs.core.ffirst(patterns)))?cljs.core.ffirst(patterns):cljs.core.set(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.ffirst(patterns)], null))));
var G__29049 = rest_datom;
var G__29050 = cljs.core.rest(patterns);
var G__29051 = new_patterns;
var G__29052 = leftover_patterns;
entids = G__29048;
rest_datom = G__29049;
patterns = G__29050;
new_patterns = G__29051;
leftover_patterns = G__29052;
continue;
} else {
var G__29056 = entids;
...
var G__29066 = cljs.core.cons(cljs.core.first(leftover_patterns),new_patterns);
var G__29067 = cljs.core.rest(leftover_patterns);
