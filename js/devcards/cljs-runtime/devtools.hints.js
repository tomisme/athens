...
var temp__5733__auto___20921 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20921)){
var seen_errors_20922 = temp__5733__auto___20921;
if(cljs.core.truth_(seen_errors_20922.has(self))){
} else {
seen_errors_20922.add(self);

var temp__5735__auto___20923 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20923)){
var sense_20924 = temp__5735__auto___20923;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20924)].join(''));
} else {
}
}
} else {
