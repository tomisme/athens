...
var G__40186 = cljs.core.PersistentArrayMap.EMPTY;
var G__40187 = native_stack_trace;
var G__40188 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__40189 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__40186,G__40187,G__40188,G__40189) : cljs.stacktrace.parse_stacktrace.call(null,G__40186,G__40187,G__40188,G__40189));
});
...
var map__40191 = top_item;
var map__40191__$1 = (((((!((map__40191 == null))))?(((((map__40191.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40191.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__40191):map__40191);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40191__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40191__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40191__$1,new cljs.core.Keyword(null,"column","column",2078222095));
...
var temp__5733__auto___40209 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___40209)){
var seen_errors_40210 = temp__5733__auto___40209;
if(cljs.core.truth_(seen_errors_40210.has(self))){
} else {
seen_errors_40210.add(self);

var temp__5735__auto___40211 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___40211)){
var sense_40212 = temp__5735__auto___40211;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_40212)].join(''));
} else {
}
}
} else {
