...
shadow.remote.runtime.cljs.browser.abort_BANG_ = (function shadow$remote$runtime$cljs$browser$abort_BANG_(p__38675,action,ex){
...
var callback = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38676__$1,new cljs.core.Keyword(null,"callback","callback",-705136228));
...
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__38678) : callback.call(null,G__38678));
});
shadow.remote.runtime.cljs.browser.interpret_action = (function shadow$remote$runtime$cljs$browser$interpret_action(p__38679,p__38680){
var map__38681 = p__38679;
...
var state = map__38681__$1;
var runtime = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38681__$1,new cljs.core.Keyword(null,"runtime","runtime",-1331573996));
var map__38682 = p__38680;
...
var action = map__38682__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38682__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__38685 = type;
var G__38685__$1 = (((G__38685 instanceof cljs.core.Keyword))?G__38685.fqn:null);
switch (G__38685__$1) {
case "repl/invoke":
var map__38686 = action;
var map__38686__$1 = (((((!((map__38686 == null))))?(((((map__38686.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__38686.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__38686):map__38686);
var js = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38686__$1,new cljs.core.Keyword(null,"js","js",1768080579));
try{var res = runtime.eval_js(js);
var G__38689 = cljs.core.update.cljs$core$IFn$_invoke$arity$4(state,new cljs.core.Keyword(null,"eval-results","eval-results",553789722),cljs.core.conj,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),res,new cljs.core.Keyword(null,"action","action",-811238024),action], null));
return (shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1 ? shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1(G__38689) : shadow.remote.runtime.cljs.browser.interpret_actions.call(null,G__38689));
}catch (e38688){var ex = e38688;
...
shadow.remote.runtime.cljs.browser.interpret_actions = (function shadow$remote$runtime$cljs$browser$interpret_actions(p__38700){
...
var state = map__38701__$1;
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38701__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
if(cljs.core.empty_QMARK_(actions)){
var fexpr__38703 = new cljs.core.Keyword(null,"callback","callback",-705136228).cljs$core$IFn$_invoke$arity$1(state);
return (fexpr__38703.cljs$core$IFn$_invoke$arity$1 ? fexpr__38703.cljs$core$IFn$_invoke$arity$1(state) : fexpr__38703.call(null,state));
} else {
var map__38708 = cljs.core.first(actions);
...
var action = map__38708__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38708__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var self__ = this;
var this$ = this;
var G__38715 = [shadow.cljs.devtools.client.env.get_url_base(),"/worker/compile/",shadow.cljs.devtools.client.env.build_id,"/",shadow.cljs.devtools.client.env.proc_id,"/browser"].join('');
var G__38716 = (function (res){
var req = this;
var map__38720 = shadow.remote.runtime.cljs.browser.transit_read(req.getResponseText());
...
var G__38722 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"failed","failed",-1397425762),true,new cljs.core.Keyword(null,"result","result",1415092211),result], null);
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__38722) : callback.call(null,G__38722));
} else {
...
var G__38717 = "POST";
var G__38718 = shadow.remote.runtime.cljs.browser.transit_str(msg);
var G__38719 = ({"content-type": "application/transit+json; charset=utf-8"});
return goog.net.XhrIo.send(G__38715,G__38716,G__38717,G__38718,G__38719);
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k38711,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k38711,else__4442__auto__);
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__38710){
var self__ = this;
var G__38710__$1 = this;
return (new cljs.core.RecordIter((0),G__38710__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ws","ws",86841443),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this38712,other38713){
var self__ = this;
var this38712__$1 = this;
return (((!((other38713 == null)))) && ((this38712__$1.constructor === other38713.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38712__$1.ws,other38713.ws)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38712__$1.state_ref,other38713.state_ref)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38712__$1.__extmap,other38713.__extmap)));
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__38710){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__38729 = cljs.core.keyword_identical_QMARK_;
var expr__38730 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__38732 = new cljs.core.Keyword(null,"ws","ws",86841443);
...
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(G__38710,self__.state_ref,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__38734 = new cljs.core.Keyword(null,"state-ref","state-ref",2127874952);
...
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,G__38710,self__.__meta,self__.__extmap,null));
} else {
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__38710),null));
}
}
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__38710){
var self__ = this;
var this__4438__auto____$1 = this;
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,G__38710,self__.__extmap,self__.__hash));
}));
 ...
 */
shadow.remote.runtime.cljs.browser.map__GT_BrowserRuntime = (function shadow$remote$runtime$cljs$browser$map__GT_BrowserRuntime(G__38714){
var extmap__4478__auto__ = (function (){var G__38736 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__38714,new cljs.core.Keyword(null,"ws","ws",86841443),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], 0));
if(cljs.core.record_QMARK_(G__38714)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__38736);
} else {
return G__38736;
}
})();
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(new cljs.core.Keyword(null,"ws","ws",86841443).cljs$core$IFn$_invoke$arity$1(G__38714),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952).cljs$core$IFn$_invoke$arity$1(G__38714),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var runtime = (function (){var G__38737 = (new shadow.remote.runtime.cljs.browser.BrowserRuntime(socket,state_ref,null,null,null));
shadow.remote.runtime.shared.add_defaults(G__38737);
...
var map__38738 = temp__5737__auto__;
...
var stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38738__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
