...
var G__46716 = new cljs.core.Keyword(null,"reduction-type","reduction-type",-488293450).cljs$core$IFn$_invoke$arity$1(f);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$reduction$iter__46742(s__46743){
return (new cljs.core.LazySeq(null,(function (){
var s__46743__$1 = s__46743;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__46743__$1);
if(temp__5735__auto__){
var s__46743__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__46743__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__46743__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__46745 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__46744 = (0);
while(true){
if((i__46744 < size__4581__auto__)){
var vec__46746 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__46744);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46746,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46746,(1),null);
cljs.core.chunk_append(b__46745,(cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)));

var G__46798 = (i__46744 + (1));
i__46744 = G__46798;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__46745),instaparse$reduction$iter__46742(cljs.core.chunk_rest(s__46743__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__46745),null);
}
} else {
var vec__46749 = cljs.core.first(s__46743__$2);
...
return cljs.core.cons((cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)),instaparse$reduction$iter__46742(cljs.core.rest(s__46743__$2)));
}
} else {
return null;
}
