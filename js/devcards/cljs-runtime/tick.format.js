...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__50871 = goog.object.get(JSJodaLocale,"Locale");
if((G__50871 == null)){
return null;
} else {
return goog.object.get(G__50871,"US");
}
}catch (e50870){if((e50870 instanceof Error)){
var e = e50870;
return null;
} else {
throw e50870;
