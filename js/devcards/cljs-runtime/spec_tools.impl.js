...
var vec__47305 = cljs.core.rest(expr);
var seq__47306 = cljs.core.seq(vec__47305);
var first__47307 = cljs.core.first(seq__47306);
var seq__47306__$1 = cljs.core.next(seq__47306);
var vec__47308 = first__47307;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47308,(0),null);
var form = seq__47306__$1;
...
var G__47311 = x;
var G__47311__$1 = (((G__47311 == null))?null:spec_tools.impl.polish(G__47311));
var G__47311__$2 = (((G__47311__$1 == null))?null:cljs.core.name(G__47311__$1));
if((G__47311__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__47311__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__47312 = x;
var G__47312__$1 = (((G__47312 == null))?null:cljs.core.name(G__47312));
if((G__47312__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__47312__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__47313){
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__47316){
...
var data = map__47317__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47317__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47317__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__47319 = data;
var G__47319__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47319,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__47319);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47319__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__47319__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__47323 = form;
var G__47323__$1 = (((G__47323 == null))?null:cljs.core.rest(G__47323));
if((G__47323__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__47323__$1);
}
})();
var G__47324 = m;
var G__47324__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47324,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__47320_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__47320_SHARP_)));
})):G__47324);
var G__47324__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47324__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__47321_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__47321_SHARP_)));
})):G__47324__$1);
var G__47324__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47324__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__47322_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__47322_SHARP_));
})):G__47324__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__47324__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__47325 = (function (){var G__47326 = form;
var G__47326__$1 = (((G__47326 == null))?null:cljs.core.rest(G__47326));
if((G__47326__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__47326__$1);
}
})();
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47325__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47325__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47325__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47325__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__47328 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__47328) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__47329 = form;
var G__47329__$1 = (((G__47329 == null))?null:cljs.core.seq(G__47329));
var G__47329__$2 = (((G__47329__$1 == null))?null:cljs.core.first(G__47329__$1));
if((G__47329__$2 == null)){
return null;
} else {
var fexpr__47330 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__47330.cljs$core$IFn$_invoke$arity$1 ? fexpr__47330.cljs$core$IFn$_invoke$arity$1(G__47329__$2) : fexpr__47330.call(null,G__47329__$2));
}
})():null));
});
/**
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq47331){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq47331));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__47332){
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__47338){
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47339__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47339__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47339__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47339__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__47336_SHARP_){
return cljs.core.map_QMARK_(p1__47336_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__47337_SHARP_){
return cljs.core.contains_QMARK_(p1__47337_SHARP_,x);
});
}),req_keys));
