...
var o42514 = temp__5733__auto__;
var temp__5733__auto____$1 = (o42514["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o42515 = temp__5733__auto____$1;
return (o42515["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__40049__auto__ = f;
return (o__40049__auto__["toString"]).call(o__40049__auto__);
} else {
return "";
}
}catch (e42516){var _ = e42516;
return "";
}});
...
try{var o__40049__auto___42832 = t;
(o__40049__auto___42832["cljs$lang$ctorPrWriter"]).call(o__40049__auto___42832,t,writer);
}catch (e42525){var __42833 = e42525;
}
...
var char_code = (function (){var o__40049__auto__ = (new String(char$));
return (o__40049__auto__["charCodeAt"]).call(o__40049__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__40049__auto__ = String;
return (o__40049__auto__["fromCharCode"]).call(o__40049__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__42532 = num_code;
switch (G__42532) {
case (1):
return (185);
...
var o__40049__auto__ = String;
return (o__40049__auto__["fromCharCode"]).call(o__40049__auto__,superscript_code);
});
/**
...
}catch (e42549){var _e__40097__auto__ = e42549;
return false;
}})())){
...
var vec__42553 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42553,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o42600 = temp__5733__auto__;
var temp__5733__auto____$1 = (o42600["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o42601 = temp__5733__auto____$1;
return (o42601["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__42637){
var vec__42638 = p__42637;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42638,(0),null);
...
var G__42843 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__42844 = cljs.core.butlast(remaining_tokens);
name_tokens = G__42843;
remaining_tokens = G__42844;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq42635){
...
var vec__42654 = cljs.core.split_with((function (p1__42653_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__42653_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42654,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42654,(1),null);
...
var vec__42667 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42667,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42667,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__42886 = cljs.core.rest(remaining_tokens);
var G__42887 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__42886;
name_tokens = G__42887;
continue;
} else {
...
var vec__42674 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42674,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42674,(1),null);
var vec__42677 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42677,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42677,(1),null);
var vec__42681 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42681,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42681,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42681,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42681,(3),null);
...
var vec__42690 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42690,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42690,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42690,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42690,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42690,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42690,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__42695 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42695,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42695,(1),null);
var vec__42698 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42698,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42698,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__42705 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__42705) : devtools.munging.parse_fn_info_deep.call(null,G__42705));
})()));
}
} else {
return fn_info;
...
var G__42922 = (arity + (1));
var G__42923 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__42719){
var vec__42720 = p__42719;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42720,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42720,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42726_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__42726_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42727_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__42727_SHARP_);
}),sorted_infos);
...
var args__4795__auto__ = [];
var len__4789__auto___42942 = arguments.length;
var i__4790__auto___42947 = (0);
while(true){
if((i__4790__auto___42947 < len__4789__auto___42942)){
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__42730){
var vec__42731 = p__42730;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42731,(0),null);
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42746__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42746__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42746__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42746__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__42747 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42747,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42747,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42747,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42747,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42747,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42747,(5),null);
...
var o__40049__auto__ = f;
return (o__40049__auto__["getBasis"]).call(o__40049__auto__);
});
/**
...
}catch (e42758){var _e__40097__auto__ = e42758;
...
var G__42986 = (obj[cljs.core.first(path)]);
var G__42987 = cljs.core.rest(path);
obj = G__42986;
path = G__42987;
continue;
} else {
...
var _STAR_ = (function (accum,p__42800){
var vec__42801 = p__42800;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42801,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42801,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__42812){
var vec__42813 = p__42812;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42813,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42813,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42813,(2),null);
...
var post_process = (function (p__42827){
var vec__42828 = p__42827;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42828,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42828,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42821_SHARP_){
return (obj[cljs.core.first(p1__42821_SHARP_)]);
}),sorted_matches);
