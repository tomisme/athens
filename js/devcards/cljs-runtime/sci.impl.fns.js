...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__46802,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var _m = map__46803__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46803__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46803__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46803__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46803__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__46837 = cljs.core.next(args__$1);
var G__46838 = cljs.core.next(params__$1);
var G__46839 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__46837;
params__$1 = G__46838;
ret = G__46839;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__46805 = ctx__$1;
var G__46806 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__46805,G__46806) : interpret.call(null,G__46805,G__46806));
...
var vec__46807 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46807,(0),null);
var vec__46810 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46807,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46810,(0),null);
var G__46840 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__46840;
continue;
} else {
var G__46841 = recur_val;
args = G__46841;
continue;
}
} else {
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__46843){
var args = cljs.core.seq(arglist__46843);
...
var map__46814 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46814__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46814__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__46829){
...
var f = map__46830__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46830__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46830__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__46849__delegate = function (args){
...
while (G__46851__i < G__46851__a.length) {G__46851__a[G__46851__i] = arguments[G__46851__i + 0]; ++G__46851__i;}
  args = new cljs.core.IndexedSeq(G__46851__a,0,null);
} 
return G__46849__delegate.call(this,args);};
G__46849.cljs$lang$maxFixedArity = 0;
G__46849.cljs$lang$applyTo = (function (arglist__46852){
var args = cljs.core.seq(arglist__46852);
return G__46849__delegate(args);
});
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46816_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__46816_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__46853__delegate = function (args){
...
while (G__46854__i < G__46854__a.length) {G__46854__a[G__46854__i] = arguments[G__46854__i + 0]; ++G__46854__i;}
  args = new cljs.core.IndexedSeq(G__46854__a,0,null);
} 
return G__46853__delegate.call(this,args);};
G__46853.cljs$lang$maxFixedArity = 0;
G__46853.cljs$lang$applyTo = (function (arglist__46855){
var args = cljs.core.seq(arglist__46855);
return G__46853__delegate(args);
});
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__46817_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__46817_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
