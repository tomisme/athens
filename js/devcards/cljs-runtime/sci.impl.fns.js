...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__58557,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58558__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58558__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58558__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__58588 = cljs.core.next(args__$1);
var G__58589 = cljs.core.next(params__$1);
var G__58590 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__58588;
params__$1 = G__58589;
ret = G__58590;
continue;
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__58575){
...
var f = map__58576__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58576__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58576__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__58603__delegate = function (args){
...
return G__58603__delegate.call(this,args);};
...
return G__58603__delegate(args);
});
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58573_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__58573_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
...
var args = null;
if (arguments.length > 0) {
var G__58607__i = 0, G__58607__a = new Array(arguments.length -  0);
while (G__58607__i < G__58607__a.length) {G__58607__a[G__58607__i] = arguments[G__58607__i + 0]; ++G__58607__i;}
  args = new cljs.core.IndexedSeq(G__58607__a,0,null);
} 
return G__58606__delegate.call(this,args);};
G__58606.cljs$lang$maxFixedArity = 0;
G__58606.cljs$lang$applyTo = (function (arglist__58608){
var args = cljs.core.seq(arglist__58608);
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__58574_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58574_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
