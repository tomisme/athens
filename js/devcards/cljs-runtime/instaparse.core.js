...
if(cljs.core.truth_((function (){var fexpr__48617 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__48617.cljs$core$IFn$_invoke$arity$1 ? fexpr__48617.cljs$core$IFn$_invoke$arity$1(type) : fexpr__48617.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__48621 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__48621.cljs$core$IFn$_invoke$arity$1 ? fexpr__48621.cljs$core$IFn$_invoke$arity$1(type) : fexpr__48621.call(null,type));
})())){
} else {
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__48622)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__48622)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__48622)){
...
var len__4789__auto___48807 = arguments.length;
var i__4790__auto___48808 = (0);
while(true){
if((i__4790__auto___48808 < len__4789__auto___48807)){
args__4795__auto__.push((arguments[i__4790__auto___48808]));

var G__48809 = (i__4790__auto___48808 + (1));
i__4790__auto___48808 = G__48809;
continue;
} else {
}
break;
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__48627){
var map__48630 = p__48627;
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__48639 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__48639) : instaparse.reduction.node_builders.call(null,G__48639));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq48623){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48624,G__48625,seq48623__$2);
}));
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__48654){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__48661 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__48661) : instaparse.reduction.node_builders.call(null,G__48661));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq48649){
...
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48650,G__48651,seq48649__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k48687,else__4442__auto__){
var self__ = this;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__48713){
var vec__48714 = p__48713;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48714,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48714,(1),null);
...
var h__4297__auto____$1 = (function (){var fexpr__48735 = (function (coll__4436__auto__){
return (-360509877 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__48735(this__4435__auto____$1);
})();
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this48688,other48689){
var self__ = this;
var this48688__$1 = this;
return (((!((other48689 == null)))) && ((this48688__$1.constructor === other48689.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48688__$1.grammar,other48689.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48688__$1.start_production,other48689.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48688__$1.output_format,other48689.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48688__$1.__extmap,other48689.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__48686){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__48745 = cljs.core.keyword_identical_QMARK_;
var expr__48746 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__48748 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
var G__48749 = expr__48746;
return (pred__48745.cljs$core$IFn$_invoke$arity$2 ? pred__48745.cljs$core$IFn$_invoke$arity$2(G__48748,G__48749) : pred__48745.call(null,G__48748,G__48749));
})())){
return (new instaparse.core.Parser(G__48686,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__48750 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
var G__48751 = expr__48746;
return (pred__48745.cljs$core$IFn$_invoke$arity$2 ? pred__48745.cljs$core$IFn$_invoke$arity$2(G__48750,G__48751) : pred__48745.call(null,G__48750,G__48751));
})())){
return (new instaparse.core.Parser(self__.grammar,G__48686,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__48752 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
var G__48753 = expr__48746;
return (pred__48745.cljs$core$IFn$_invoke$arity$2 ? pred__48745.cljs$core$IFn$_invoke$arity$2(G__48752,G__48753) : pred__48745.call(null,G__48752,G__48753));
})())){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__48686,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__48686),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__48686){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__48686,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__48755 = (arguments.length - (1));
switch (G__48755) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args48696){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args48696)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__48691){
var extmap__4478__auto__ = (function (){var G__48777 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__48691,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__48691)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__48777);
} else {
return G__48777;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__48691),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__48691),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__48691),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var args__4795__auto__ = [];
var len__4789__auto___48918 = arguments.length;
var i__4790__auto___48919 = (0);
while(true){
if((i__4790__auto___48919 < len__4789__auto___48918)){
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__48784){
...
var _STAR_case_insensitive_literals_STAR__orig_val__48792 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__48793 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__48793);

try{var G__48794 = input_format;
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__48792);
}});
...
var map__48795 = temp__5733__auto__;
...
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48795__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48795__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq48781){
var G__48782 = cljs.core.first(seq48781);
var seq48781__$1 = cljs.core.next(seq48781);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48782,seq48781__$1);
}));
