...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.filters !== 'undefined') && (typeof athens.devcards.filters.t_athens$devcards$filters61051 !== 'undefined')){
} else {
...
*/
athens.devcards.filters.t_athens$devcards$filters61051 = (function (meta61052){
this.meta61052 = meta61052;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.filters.t_athens$devcards$filters61051.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61053,meta61052__$1){
var self__ = this;
var _61053__$1 = this;
return (new athens.devcards.filters.t_athens$devcards$filters61051(meta61052__$1));
}));

(athens.devcards.filters.t_athens$devcards$filters61051.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61053){
var self__ = this;
var _61053__$1 = this;
return self__.meta61052;
}));

(athens.devcards.filters.t_athens$devcards$filters61051.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.filters.t_athens$devcards$filters61051.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42212__auto__,devcard_opts__42213__auto__){
var self__ = this;
...
(athens.devcards.filters.t_athens$devcards$filters61051.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta61052","meta61052",1846503009,null)], null);
}));

(athens.devcards.filters.t_athens$devcards$filters61051.cljs$lang$type = true);

(athens.devcards.filters.t_athens$devcards$filters61051.cljs$lang$ctorStr = "athens.devcards.filters/t_athens$devcards$filters61051");

(athens.devcards.filters.t_athens$devcards$filters61051.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.filters/t_athens$devcards$filters61051");
}));

/**
 * Positional factory function for athens.devcards.filters/t_athens$devcards$filters61051.
 */
athens.devcards.filters.__GT_t_athens$devcards$filters61051 = (function athens$devcards$filters$__GT_t_athens$devcards$filters61051(meta61052){
return (new athens.devcards.filters.t_athens$devcards$filters61051(meta61052));
});

}

return (new athens.devcards.filters.t_athens$devcards$filters61051(null));
})()
