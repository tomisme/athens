...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.filters !== 'undefined') && (typeof athens.devcards.filters.t_athens$devcards$filters61516 !== 'undefined')){
} else {
...
*/
athens.devcards.filters.t_athens$devcards$filters61516 = (function (meta61517){
this.meta61517 = meta61517;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.filters.t_athens$devcards$filters61516.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61518,meta61517__$1){
var self__ = this;
var _61518__$1 = this;
return (new athens.devcards.filters.t_athens$devcards$filters61516(meta61517__$1));
}));

(athens.devcards.filters.t_athens$devcards$filters61516.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61518){
var self__ = this;
var _61518__$1 = this;
return self__.meta61517;
}));

(athens.devcards.filters.t_athens$devcards$filters61516.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.filters.t_athens$devcards$filters61516.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42228__auto__,devcard_opts__42229__auto__){
var self__ = this;
...
(athens.devcards.filters.t_athens$devcards$filters61516.getBasis = (function (){
...
(athens.devcards.filters.t_athens$devcards$filters61516.cljs$lang$type = true);

(athens.devcards.filters.t_athens$devcards$filters61516.cljs$lang$ctorStr = "athens.devcards.filters/t_athens$devcards$filters61516");

(athens.devcards.filters.t_athens$devcards$filters61516.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.filters/t_athens$devcards$filters61516");
}));

/**
 * Positional factory function for athens.devcards.filters/t_athens$devcards$filters61516.
 */
athens.devcards.filters.__GT_t_athens$devcards$filters61516 = (function athens$devcards$filters$__GT_t_athens$devcards$filters61516(meta61517){
return (new athens.devcards.filters.t_athens$devcards$filters61516(meta61517));
});

}

return (new athens.devcards.filters.t_athens$devcards$filters61516(null));
})()
