...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.filters !== 'undefined') && (typeof athens.devcards.filters.t_athens$devcards$filters55562 !== 'undefined')){
} else {
...
*/
athens.devcards.filters.t_athens$devcards$filters55562 = (function (meta55563){
this.meta55563 = meta55563;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.filters.t_athens$devcards$filters55562.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55564,meta55563__$1){
var self__ = this;
var _55564__$1 = this;
return (new athens.devcards.filters.t_athens$devcards$filters55562(meta55563__$1));
}));

(athens.devcards.filters.t_athens$devcards$filters55562.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55564){
var self__ = this;
var _55564__$1 = this;
return self__.meta55563;
}));

(athens.devcards.filters.t_athens$devcards$filters55562.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.filters.t_athens$devcards$filters55562.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__47289__auto__,devcard_opts__47290__auto__){
var self__ = this;
...
(athens.devcards.filters.t_athens$devcards$filters55562.getBasis = (function (){
...
(athens.devcards.filters.t_athens$devcards$filters55562.cljs$lang$type = true);

(athens.devcards.filters.t_athens$devcards$filters55562.cljs$lang$ctorStr = "athens.devcards.filters/t_athens$devcards$filters55562");

(athens.devcards.filters.t_athens$devcards$filters55562.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.filters/t_athens$devcards$filters55562");
}));

/**
 * Positional factory function for athens.devcards.filters/t_athens$devcards$filters55562.
 */
athens.devcards.filters.__GT_t_athens$devcards$filters55562 = (function athens$devcards$filters$__GT_t_athens$devcards$filters55562(meta55563){
return (new athens.devcards.filters.t_athens$devcards$filters55562(meta55563));
});

}

return (new athens.devcards.filters.t_athens$devcards$filters55562(null));
})()
