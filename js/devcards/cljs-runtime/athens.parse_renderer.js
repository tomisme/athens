...
var G__55589 = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"block","block",664686210),(function() { 
var G__55619__delegate = function (contents){
...
var G__55619 = function (var_args){
var contents = null;
if (arguments.length > 0) {
var G__55620__i = 0, G__55620__a = new Array(arguments.length -  0);
while (G__55620__i < G__55620__a.length) {G__55620__a[G__55620__i] = arguments[G__55620__i + 0]; ++G__55620__i;}
  contents = new cljs.core.IndexedSeq(G__55620__a,0,null);
} 
return G__55619__delegate.call(this,contents);};
G__55619.cljs$lang$maxFixedArity = 0;
G__55619.cljs$lang$applyTo = (function (arglist__55621){
var contents = cljs.core.seq(arglist__55621);
return G__55619__delegate(contents);
});
G__55619.cljs$core$IFn$_invoke$arity$variadic = G__55619__delegate;
return G__55619;
})()
,new cljs.core.Keyword(null,"page-link","page-link",-169621200),(function (title){
var node = (function (){var G__55591 = athens.db.dsdb;
var G__55592 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__55593 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),title], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__55591,G__55592,G__55593) : posh.reagent.pull.call(null,G__55591,G__55592,G__55593));
})();
...
var block = (function (){var G__55594 = athens.db.dsdb;
var G__55595 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__55596 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__55594,G__55595,G__55596) : posh.reagent.pull.call(null,G__55594,G__55595,G__55596));
})();
...
})], null),(function (){var G__55597 = new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(block));
return (athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1 ? athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1(G__55597) : athens.parse_renderer.parse_and_render.call(null,G__55597));
})()], null)], null);
}),new cljs.core.Keyword(null,"hashtag","hashtag",-529028899),(function (tag_name){
var node = (function (){var G__55601 = athens.db.dsdb;
var G__55602 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__55603 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),tag_name], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__55601,G__55602,G__55603) : posh.reagent.pull.call(null,G__55601,G__55602,G__55603));
})();
...
}),new cljs.core.Keyword(null,"url-image","url-image",535142411),(function (p__55608){
var map__55610 = p__55608;
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55610__$1,new cljs.core.Keyword(null,"url","url",276297046));
var alt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55610__$1,new cljs.core.Keyword(null,"alt","alt",-3214426));
...
}),new cljs.core.Keyword(null,"url-link","url-link",1615670141),(function (p__55616,text){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55617__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
var G__55590 = tree;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__55589,G__55590) : instaparse.core.transform.call(null,G__55589,G__55590));
});
/**
