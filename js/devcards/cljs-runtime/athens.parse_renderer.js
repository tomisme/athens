...
var G__59851__delegate = function (contents){
...
while (G__59852__i < G__59852__a.length) {G__59852__a[G__59852__i] = arguments[G__59852__i + 0]; ++G__59852__i;}
  contents = new cljs.core.IndexedSeq(G__59852__a,0,null);
} 
return G__59851__delegate.call(this,contents);};
G__59851.cljs$lang$maxFixedArity = 0;
G__59851.cljs$lang$applyTo = (function (arglist__59853){
var contents = cljs.core.seq(arglist__59853);
return G__59851__delegate(contents);
});
...
var block = (function (){var G__59839 = athens.db.dsdb;
...
var string = new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(block));
if(cljs.core.truth_(athens.sci.sci_block_QMARK_(cljs.core.deref(block)))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("athens","sci-modifier","athens/sci-modifier",1795365638),string], null);
} else {
...
})], null),(athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1 ? athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1(string) : athens.parse_renderer.parse_and_render.call(null,string))], null)], null);
}
}),new cljs.core.Keyword(null,"hashtag","hashtag",-529028899),(function (tag_name){
var node = (function (){var G__59842 = athens.db.dsdb;
var G__59843 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__59844 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),tag_name], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__59842,G__59843,G__59844) : posh.reagent.pull.call(null,G__59842,G__59843,G__59844));
})();
...
}),new cljs.core.Keyword(null,"url-image","url-image",535142411),(function (p__59845){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59846__$1,new cljs.core.Keyword(null,"url","url",276297046));
var alt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59846__$1,new cljs.core.Keyword(null,"alt","alt",-3214426));
...
}),new cljs.core.Keyword(null,"url-link","url-link",1615670141),(function (p__59848,text){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59849__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
return cljs.core.vec(athens.parse_renderer.transform(result));
}
});
