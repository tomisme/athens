...
var G__57920 = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"block","block",664686210),(function() { 
var G__57938__delegate = function (contents){
...
while (G__57939__i < G__57939__a.length) {G__57939__a[G__57939__i] = arguments[G__57939__i + 0]; ++G__57939__i;}
  contents = new cljs.core.IndexedSeq(G__57939__a,0,null);
} 
return G__57938__delegate.call(this,contents);};
G__57938.cljs$lang$maxFixedArity = 0;
G__57938.cljs$lang$applyTo = (function (arglist__57940){
var contents = cljs.core.seq(arglist__57940);
return G__57938__delegate(contents);
});
...
var node = (function (){var G__57922 = athens.db.dsdb;
var G__57923 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__57924 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),title], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__57922,G__57923,G__57924) : posh.reagent.pull.call(null,G__57922,G__57923,G__57924));
})();
...
var block = (function (){var G__57925 = athens.db.dsdb;
...
var G__57927 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null);
...
})], null),(function (){var G__57928 = new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(block));
return (athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1 ? athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1(G__57928) : athens.parse_renderer.parse_and_render.call(null,G__57928));
})()], null)], null);
...
var G__57931 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),tag_name], null);
...
}),new cljs.core.Keyword(null,"url-image","url-image",535142411),(function (p__57932){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57933__$1,new cljs.core.Keyword(null,"url","url",276297046));
var alt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57933__$1,new cljs.core.Keyword(null,"alt","alt",-3214426));
...
}),new cljs.core.Keyword(null,"url-link","url-link",1615670141),(function (p__57935,text){
...
var G__57921 = tree;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__57920,G__57921) : instaparse.core.transform.call(null,G__57920,G__57921));
});
/**
