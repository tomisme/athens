...
var G__38716_38790 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__38716_38790) : style_created_handler.call(null,G__38716_38790));
...
var G__38793 = seq__38718;
var G__38794 = chunk__38719;
var G__38795 = count__38720;
var G__38796 = (i__38721 + (1));
seq__38718 = G__38793;
...
var G__38800 = cljs.core.chunk_rest(seq__38718__$1);
var G__38801 = c__4609__auto__;
var G__38802 = cljs.core.count(c__4609__auto__);
var G__38803 = (0);
seq__38718 = G__38800;
chunk__38719 = G__38801;
count__38720 = G__38802;
i__38721 = G__38803;
continue;
} else {
var sub_style = cljs.core.first(seq__38718__$1);
var G__38731_38804 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__38732_38805 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__38731_38804,G__38732_38805) : stylefy.impl.styles.create_style_BANG_.call(null,G__38731_38804,G__38732_38805));


var G__38806 = cljs.core.next(seq__38718__$1);
var G__38807 = null;
var G__38808 = (0);
var G__38809 = (0);
seq__38718 = G__38806;
chunk__38719 = G__38807;
count__38720 = G__38808;
i__38721 = G__38809;
continue;
}
} else {
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__38737_SHARP_){
return ((typeof p1__38737_SHARP_ === 'string') || ((p1__38737_SHARP_ instanceof cljs.core.Keyword)) || ((p1__38737_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__38737#] (or (string? p1__38737#) (keyword? p1__38737#) (nil? p1__38737#))) class)))"].join('')));
}
});
/**
...
(stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2 = (function (styles,p__38778){
...
var options = map__38779__$1;
var request_dom_update_after_done_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38779__$1,new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510));
var styles_38820__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__38783_38821 = cljs.core.seq(styles_38820__$1);
var chunk__38784_38822 = null;
var count__38785_38823 = (0);
var i__38786_38824 = (0);
while(true){
if((i__38786_38824 < count__38785_38823)){
var style_38826 = chunk__38784_38822.cljs$core$IIndexed$_nth$arity$2(null,i__38786_38824);
stylefy.impl.styles.use_style_BANG_(style_38826,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___38827 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_38826));
if(cljs.core.truth_(temp__5735__auto___38827)){
var sub_styles_38828 = temp__5735__auto___38827;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_38828,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__38831 = seq__38783_38821;
var G__38832 = chunk__38784_38822;
var G__38833 = count__38785_38823;
var G__38834 = (i__38786_38824 + (1));
seq__38783_38821 = G__38831;
chunk__38784_38822 = G__38832;
count__38785_38823 = G__38833;
i__38786_38824 = G__38834;
continue;
} else {
var temp__5735__auto___38835 = cljs.core.seq(seq__38783_38821);
if(temp__5735__auto___38835){
var seq__38783_38836__$1 = temp__5735__auto___38835;
if(cljs.core.chunked_seq_QMARK_(seq__38783_38836__$1)){
var c__4609__auto___38837 = cljs.core.chunk_first(seq__38783_38836__$1);
var G__38838 = cljs.core.chunk_rest(seq__38783_38836__$1);
var G__38839 = c__4609__auto___38837;
var G__38840 = cljs.core.count(c__4609__auto___38837);
var G__38841 = (0);
seq__38783_38821 = G__38838;
chunk__38784_38822 = G__38839;
count__38785_38823 = G__38840;
i__38786_38824 = G__38841;
continue;
} else {
var style_38842 = cljs.core.first(seq__38783_38836__$1);
stylefy.impl.styles.use_style_BANG_(style_38842,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___38844__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_38842));
if(cljs.core.truth_(temp__5735__auto___38844__$1)){
var sub_styles_38846 = temp__5735__auto___38844__$1;
...
var G__38847 = cljs.core.next(seq__38783_38836__$1);
var G__38848 = null;
var G__38849 = (0);
var G__38850 = (0);
seq__38783_38821 = G__38847;
chunk__38784_38822 = G__38848;
count__38785_38823 = G__38849;
i__38786_38824 = G__38850;
continue;
}
} else {
}
