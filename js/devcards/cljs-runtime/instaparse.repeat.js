...
var vec__57368 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57368,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57368,(1),null);
...
var G__57435 = cljs.core.next(parses__$1);
parses__$1 = G__57435;
continue;
}
...
var G__57382 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57383 = G__57382;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57383,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57383,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57383,(2),null);
var selection = vec__57383;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57382__$1 = G__57382;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57389 = G__57382__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57389,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57389,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57389,(2),null);
var selection__$1 = vec__57389;
...
var G__57437 = cljs.core.long$(end__$1);
var G__57438 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57439 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57437;
parses__$1 = G__57438;
G__57382__$1 = G__57439;
continue;
...
var G__57397 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57398 = G__57397;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57398,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57398,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57398,(2),null);
var selection = vec__57398;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57397__$1 = G__57397;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57404 = G__57397__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57404,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57404,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57404,(2),null);
var selection__$1 = vec__57404;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__57441 = cljs.core.long$(end__$1);
var G__57442 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57443 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57441;
parses__$1 = G__57442;
G__57397__$1 = G__57443;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__57412 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57413 = G__57412;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57413,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57413,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57413,(2),null);
var selection = vec__57413;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57412__$1 = G__57412;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57419 = G__57412__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57419,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57419,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57419,(2),null);
var selection__$1 = vec__57419;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
if(cljs.core.truth_((function (){var fexpr__57424 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57424.cljs$core$IFn$_invoke$arity$1 ? fexpr__57424.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__57424.call(null,output_format));
})())){
} else {
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__57433 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__57432 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__57432.cljs$core$IFn$_invoke$arity$1 ? fexpr__57432.cljs$core$IFn$_invoke$arity$1(G__57433) : fexpr__57432.call(null,G__57433));
})();
