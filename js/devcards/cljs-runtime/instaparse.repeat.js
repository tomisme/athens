...
var vec__47838 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47838,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47838,(1),null);
...
var vec__47841 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47841,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47841,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__47852 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47852,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47852,(1),null);
...
var G__47966 = cljs.core.next(parses__$1);
parses__$1 = G__47966;
continue;
}
...
var G__47868 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__47869 = G__47868;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47869,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47869,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47869,(2),null);
var selection = vec__47869;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__47868__$1 = G__47868;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__47879 = G__47868__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47879,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47879,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47879,(2),null);
var selection__$1 = vec__47879;
...
var G__47972 = cljs.core.long$(end__$1);
var G__47973 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__47974 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__47972;
parses__$1 = G__47973;
G__47868__$1 = G__47974;
continue;
...
var G__47887 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__47888 = G__47887;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47888,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47888,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47888,(2),null);
var selection = vec__47888;
var index__$2 = index__$1;
var parses__$1 = parses;
...
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__47898 = G__47887__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47898,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47898,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47898,(2),null);
var selection__$1 = vec__47898;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__47981 = cljs.core.long$(end__$1);
var G__47982 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__47983 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__47981;
parses__$1 = G__47982;
G__47887__$1 = G__47983;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__47908 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__47909 = G__47908;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47909,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47909,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47909,(2),null);
var selection = vec__47909;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__47908__$1 = G__47908;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__47918 = G__47908__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47918,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47918,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47918,(2),null);
var selection__$1 = vec__47918;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__47992 = cljs.core.long$(end__$1);
var G__47993 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__47994 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__47992;
parses__$1 = G__47993;
G__47908__$1 = G__47994;
continue;
...
if(cljs.core.truth_((function (){var fexpr__47929 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__47929.cljs$core$IFn$_invoke$arity$1 ? fexpr__47929.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__47929.call(null,output_format));
})())){
} else {
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__47946 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__47945 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__47945.cljs$core$IFn$_invoke$arity$1 ? fexpr__47945.cljs$core$IFn$_invoke$arity$1(G__47946) : fexpr__47945.call(null,G__47946));
})();
