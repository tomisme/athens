...
var G__50413_50439 = new cljs.core.Keyword(null,"current-route","current-route",2067529448);
var G__50414_50440 = (function (db){
return new cljs.core.Keyword(null,"current-route","current-route",2067529448).cljs$core$IFn$_invoke$arity$1(db);
});
(re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2(G__50413_50439,G__50414_50440) : re_frame.core.reg_sub.call(null,G__50413_50439,G__50414_50440));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigate","navigate",657596805),(function (_,p__50415){
...
var ___$1 = first__50418;
var route = seq__50417__$1;
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"navigate!","navigate!",79998348),route], null);
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigated","navigated",540897836),(function (p__50420,p__50421){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50422__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__50423 = p__50421;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50423,(0),null);
var new_match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50423,(1),null);
...
var node = (function (){var G__50427 = athens.db.dsdb;
var G__50428 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__50429 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"path-params","path-params",-48130597).cljs$core$IFn$_invoke$arity$1(new_match))], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__50427,G__50428,G__50429) : posh.reagent.pull.call(null,G__50427,G__50428,G__50429));
})();
...
var G__50430_50441 = new cljs.core.Keyword(null,"navigate!","navigate!",79998348);
var G__50431_50442 = ((day8.re_frame.tracing.is_trace_enabled_QMARK_())?(function (route){
...
var result__46520__auto__ = cljs.core.apply.cljs$core$IFn$_invoke$arity$2((function (){var opts__46519__auto____$1 = _PLUS_debux_dbg_opts_PLUS_;
var result__46520__auto__ = reitit.frontend.easy.push_state;
...
})(),(function (){var opts__46519__auto____$1 = _PLUS_debux_dbg_opts_PLUS_;
var result__46520__auto__ = route;
...
return result__46520__auto__;
}catch (e50432){var e = e50432;
throw e;
}}):(function (route){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(reitit.frontend.easy.push_state,route);
}));
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__50430_50441,G__50431_50442) : re_frame.core.reg_fx.call(null,G__50430_50441,G__50431_50442));
...
var G__50433 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigated","navigated",540897836),new_match], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__50433) : re_frame.core.dispatch.call(null,G__50433));
} else {
return null;
}
});
athens.router.navigate = (function athens$router$navigate(page){
var G__50434 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),page], null);
...
var G__50438 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("right-sidebar","open-item","right-sidebar/open-item",-1234515614),uid], null);
