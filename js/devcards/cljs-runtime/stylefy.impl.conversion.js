...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__47782_SHARP_){
return handle_mode(p1__47782_SHARP_,cljs.core.get.cljs$core$IFn$_invoke$arity$2(modes,p1__47782_SHARP_));
}),cljs.core.keys(modes));
} else {
if(cljs.core.vector_QMARK_(modes)){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__47783_SHARP_){
return handle_mode(cljs.core.first(p1__47783_SHARP_),cljs.core.second(p1__47783_SHARP_));
}),modes);
} else {
return null;
}
 ...
 */
stylefy.impl.conversion.convert_base_style_into_class = (function stylefy$impl$conversion$convert_base_style_into_class(p__47794,options){
var map__47795 = p__47794;
...
var style = map__47795__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47795__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47795__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47795__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
 ...
 */
stylefy.impl.conversion.convert_media_queries = (function stylefy$impl$conversion$convert_media_queries(p__47816,options){
var map__47819 = p__47816;
var map__47819__$1 = (((((!((map__47819 == null))))?(((((map__47819.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__47819.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__47819):map__47819);
var style = map__47819__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47819__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47819__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47819__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
 ...
 */
stylefy.impl.conversion.convert_supports_rules = (function stylefy$impl$conversion$convert_supports_rules(p__47826,options){
var map__47827 = p__47826;
var map__47827__$1 = (((((!((map__47827 == null))))?(((((map__47827.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__47827.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__47827):map__47827);
var style = map__47827__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47827__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47827__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47827__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
 ...
 */
stylefy.impl.conversion.convert_manual_styles = (function stylefy$impl$conversion$convert_manual_styles(p__47836,options){
var map__47837 = p__47836;
var map__47837__$1 = (((((!((map__47837 == null))))?(((((map__47837.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__47837.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__47837):map__47837);
var style = map__47837__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47837__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47837__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47837__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
...
var manual_selector_and_css_props = clojure.walk.walk((function (p1__47834_SHARP_){
if(cljs.core.map_QMARK_(p1__47834_SHARP_)){
return stylefy.impl.utils.remove_special_keywords(p1__47834_SHARP_);
} else {
return p1__47834_SHARP_;
}
...
(stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$2 = (function (p__47847,options){
var map__47849 = p__47847;
...
var style = map__47849__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47849__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47849__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
